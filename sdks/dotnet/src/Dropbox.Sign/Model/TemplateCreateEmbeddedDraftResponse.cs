...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateCreateEmbeddedDraftResponse : IEquatable<TemplateCreateEmbeddedDraftResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public static TemplateCreateEmbeddedDraftResponse Init(string jsonData)
        {
            ...
            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateCreateEmbeddedDraftResponse");
            }
