...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentFieldGroup : IEquatable<TemplateResponseDocumentFieldGroup>, IValidatableObject
    {
        ...
        public static TemplateResponseDocumentFieldGroup Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentFieldGroup>(jsonData);
