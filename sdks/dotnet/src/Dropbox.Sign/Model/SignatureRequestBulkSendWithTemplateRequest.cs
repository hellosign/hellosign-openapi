...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestBulkSendWithTemplateRequest
        : IEquatable<SignatureRequestBulkSendWithTemplateRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (templateIds == null)
            {
                throw new ArgumentNullException(
                    "templateIds is a required property for SignatureRequestBulkSendWithTemplateRequest and cannot be null"
                );
            }
        ...
        {
            var obj = JsonConvert.DeserializeObject<SignatureRequestBulkSendWithTemplateRequest>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestBulkSendWithTemplateRequest"
                );
            }
