...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TeamInvitesResponse : IEquatable<TeamInvitesResponse>, IValidatableObject
    {
        ...
        public TeamInvitesResponse(
            List<TeamInviteResponse> teamInvites = default(List<TeamInviteResponse>),
        ...
        public static TeamInvitesResponse Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TeamInvitesResponse>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TeamInvitesResponse"
                );
            }
