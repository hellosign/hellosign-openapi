...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SubSigningOptions : IOpenApiTyped, IEquatable<SubSigningOptions>, IValidatableObject
    {
        ...
        public static SubSigningOptions Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<SubSigningOptions>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of SubSigningOptions");
            }
