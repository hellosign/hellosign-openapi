...
namespace Dropbox.Sign.Model
{
    ...
    public partial class AccountGetResponse : IEquatable<AccountGetResponse>, IValidatableObject
    {
        /// <summary>
        ...
        public static AccountGetResponse Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<AccountGetResponse>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of AccountGetResponse");
            }
