...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestEditEmbeddedRequest
        : IOpenApiTyped,
            IEquatable<SignatureRequestEditEmbeddedRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        public SignatureRequestEditEmbeddedRequest(
            ...
            List<SubSignatureRequestGroupedSigners> groupedSigners =
                default(List<SubSignatureRequestGroupedSigners>),
        ...
        )
        {
            ...
            if (clientId == null)
            {
                throw new ArgumentNullException(
                    "clientId is a required property for SignatureRequestEditEmbeddedRequest and cannot be null"
                );
            }
        ...
        public static SignatureRequestEditEmbeddedRequest Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestEditEmbeddedRequest"
                );
            }
