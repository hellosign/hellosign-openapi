...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TeamInfoResponse : IEquatable<TeamInfoResponse>, IValidatableObject
    {
        ...
        /// <param name="numMembers">_t__TeamGeneral::NUM_MEMBERS.</param>
        /// <param name="numSubTeams">_t__TeamGeneral::NUM_SUB_TEAMS.</param>
        ...
        public static TeamInfoResponse Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TeamInfoResponse>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TeamInfoResponse");
            }
        ...
        /// </summary>
        /// <value>_t__TeamGeneral::NUM_MEMBERS</value>
        ...
        /// </summary>
        /// <value>_t__TeamGeneral::NUM_SUB_TEAMS</value>
