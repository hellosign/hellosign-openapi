...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentStaticFieldBase : IOpenApiTyped, IEquatable<TemplateResponseDocumentStaticFieldBase>, IValidatableObject
    {
        ...
        protected TemplateResponseDocumentStaticFieldBase() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldBase" /> class.
        /// </summary>
        ...
        public TemplateResponseDocumentStaticFieldBase(string apiId = default(string), string name = default(string), string type = default(string), string signer = "me_now", int x = default(int), int y = default(int), int width = default(int), int height = default(int), bool required = default(bool), string group = default(string), int fontSize = default(int))
        {
        ...
        public static TemplateResponseDocumentStaticFieldBase Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticFieldBase>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentStaticFieldBase");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentStaticFieldBase);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentStaticFieldBase instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentStaticFieldBase to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentStaticFieldBase input)
        {
            if (input == null)
            {
                return false;
