...
namespace Dropbox.Sign.Model
{
    ...
    public partial class BulkSendJobGetResponse
        : IEquatable<BulkSendJobGetResponse>,
            IValidatableObject
    {
        /// <summary>
        ...
        public BulkSendJobGetResponse(
            ...
            List<BulkSendJobGetResponseSignatureRequests> signatureRequests =
                default(List<BulkSendJobGetResponseSignatureRequests>),
        ...
        public static BulkSendJobGetResponse Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of BulkSendJobGetResponse"
                );
            }
