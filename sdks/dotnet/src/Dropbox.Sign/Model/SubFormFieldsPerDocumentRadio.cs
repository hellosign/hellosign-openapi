...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentRadio : SubFormFieldsPerDocumentBase, IOpenApiTyped, IEquatable<SubFormFieldsPerDocumentRadio>, IValidatableObject
    {
        ...
        /// <param name="signer">Signer index identified by the offset in the signers parameter (0-based indexing), indicating which signer should fill out the field. (required).</param>
