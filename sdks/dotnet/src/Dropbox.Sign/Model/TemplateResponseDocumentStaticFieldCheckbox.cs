...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentStaticFieldCheckbox")]
    ...
    public partial class TemplateResponseDocumentStaticFieldCheckbox : TemplateResponseDocumentStaticFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentStaticFieldCheckbox>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldCheckbox" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateResponseDocumentStaticFieldCheckbox() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldCheckbox" /> class.
        /// </summary>
        /// <param name="type">The type of this static field. See [field types](/api/reference/constants/#field-types).  * Text Field uses &#x60;TemplateResponseDocumentStaticFieldText&#x60; * Dropdown Field uses &#x60;TemplateResponseDocumentStaticFieldDropdown&#x60; * Hyperlink Field uses &#x60;TemplateResponseDocumentStaticFieldHyperlink&#x60; * Checkbox Field uses &#x60;TemplateResponseDocumentStaticFieldCheckbox&#x60; * Radio Field uses &#x60;TemplateResponseDocumentStaticFieldRadio&#x60; * Signature Field uses &#x60;TemplateResponseDocumentStaticFieldSignature&#x60; * Date Signed Field uses &#x60;TemplateResponseDocumentStaticFieldDateSigned&#x60; * Initials Field uses &#x60;TemplateResponseDocumentStaticFieldInitials&#x60; (required) (default to &quot;checkbox&quot;).</param>
        ...
        public TemplateResponseDocumentStaticFieldCheckbox(string type = "checkbox", string apiId = default(string), string name = default(string), string signer = "me_now", int x = default(int), int y = default(int), int width = default(int), int height = default(int), bool required = default(bool), string group = default(string), int fontSize = default(int))
        {
            this.ApiId = apiId;
            this.Name = name;
            this.Signer = signer;
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for TemplateResponseDocumentStaticFieldCheckbox and cannot be null");
            }
            this.Type = type;
        }
        ...
        public static TemplateResponseDocumentStaticFieldCheckbox Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticFieldCheckbox>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentStaticFieldCheckbox");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentStaticFieldCheckbox);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentStaticFieldCheckbox instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentStaticFieldCheckbox to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentStaticFieldCheckbox input)
        {
            if (input == null)
            {
                return false;
