...
namespace Dropbox.Sign.Model
{
    ...
    public partial class ApiAppResponseWhiteLabelingOptions
        : IEquatable<ApiAppResponseWhiteLabelingOptions>,
            IValidatableObject
    {
        /// <summary>
        ...
        public ApiAppResponseWhiteLabelingOptions(
            string headerBackgroundColor = default(string),
            string legalVersion = default(string),
            string linkColor = default(string),
            string pageBackgroundColor = default(string),
            string primaryButtonColor = default(string),
            string primaryButtonColorHover = default(string),
            string primaryButtonTextColor = default(string),
            string primaryButtonTextColorHover = default(string),
            string secondaryButtonColor = default(string),
            string secondaryButtonColorHover = default(string),
            string secondaryButtonTextColor = default(string),
            string secondaryButtonTextColorHover = default(string),
            string textColor1 = default(string),
            string textColor2 = default(string)
        )
        {
        ...
        public static ApiAppResponseWhiteLabelingOptions Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of ApiAppResponseWhiteLabelingOptions"
                );
            }
        ...
        public bool Equals(ApiAppResponseWhiteLabelingOptions input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (this.LegalVersion != null && this.LegalVersion.Equals(input.LegalVersion))
                )
                && (
                    this.LinkColor == input.LinkColor
                    || (this.LinkColor != null && this.LinkColor.Equals(input.LinkColor))
                )
                && (
                ...
                && (
                    ...
                    || (
                        ...
                        && this.PrimaryButtonTextColorHover.Equals(
                            input.PrimaryButtonTextColorHover
                        )
                    )
                )
                && (
                ...
                && (
                    ...
                    || (
                        ...
                        && this.SecondaryButtonTextColorHover.Equals(
                            input.SecondaryButtonTextColorHover
                        )
                    )
                )
                && (
                    this.TextColor1 == input.TextColor1
                    || (this.TextColor1 != null && this.TextColor1.Equals(input.TextColor1))
                )
                && (
                    this.TextColor2 == input.TextColor2
                    || (this.TextColor2 != null && this.TextColor2.Equals(input.TextColor2))
                );
        }
