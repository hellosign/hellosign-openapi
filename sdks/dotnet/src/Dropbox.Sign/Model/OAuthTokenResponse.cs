...
namespace Dropbox.Sign.Model
{
    ...
    public partial class OAuthTokenResponse : IEquatable<OAuthTokenResponse>, IValidatableObject
    {
        ...
        public static OAuthTokenResponse Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<OAuthTokenResponse>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of OAuthTokenResponse");
            }
        ...
        public bool Equals(OAuthTokenResponse input)
        {
            ...
            return (
                ...
                && (
                    ...
                    || (this.TokenType != null && this.TokenType.Equals(input.TokenType))
                )
                && (
                    this.RefreshToken == input.RefreshToken
                    || (this.RefreshToken != null && this.RefreshToken.Equals(input.RefreshToken))
                )
                && (this.ExpiresIn == input.ExpiresIn || this.ExpiresIn.Equals(input.ExpiresIn))
                && (
