...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentFormField
        : IOpenApiTyped,
            IEquatable<TemplateResponseDocumentFormField>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static TemplateResponseDocumentFormField Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentFormField>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseDocumentFormField"
                );
            }
