...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentStaticField
        : IOpenApiTyped,
            IEquatable<TemplateResponseDocumentStaticField>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static TemplateResponseDocumentStaticField Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticField>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseDocumentStaticField"
                );
            }
