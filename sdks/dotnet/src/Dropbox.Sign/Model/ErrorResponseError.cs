...
namespace Dropbox.Sign.Model
{
    ...
    public partial class ErrorResponseError : IOpenApiTyped, IEquatable<ErrorResponseError>, IValidatableObject
    {
        ...
        public static ErrorResponseError Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<ErrorResponseError>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of ErrorResponseError");
            }
