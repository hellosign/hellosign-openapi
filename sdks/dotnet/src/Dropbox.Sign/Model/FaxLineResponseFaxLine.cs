...
namespace Dropbox.Sign.Model
{
    ...
    public partial class FaxLineResponseFaxLine : IEquatable<FaxLineResponseFaxLine>, IValidatableObject
    {
        ...
        public static FaxLineResponseFaxLine Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<FaxLineResponseFaxLine>(jsonData);
        ...
        {
            return this.Equals(input as FaxLineResponseFaxLine);
        }

        /// <summary>
        /// Returns true if FaxLineResponseFaxLine instances are equal
        /// </summary>
        /// <param name="input">Instance of FaxLineResponseFaxLine to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(FaxLineResponseFaxLine input)
        {
            if (input == null)
            {
                return false;
