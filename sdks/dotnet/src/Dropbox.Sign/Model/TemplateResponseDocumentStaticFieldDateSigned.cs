...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentStaticFieldDateSigned
        : TemplateResponseDocumentStaticFieldBase,
            IOpenApiTyped,
            IEquatable<TemplateResponseDocumentStaticFieldDateSigned>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException(
                    "type is a required property for TemplateResponseDocumentStaticFieldDateSigned and cannot be null"
                );
            }
            this.Type = type;
        }
        ...
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticFieldDateSigned>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseDocumentStaticFieldDateSigned"
                );
            }
