...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentStaticFieldDateSigned")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TemplateResponseDocumentStaticFieldDateSigned : TemplateResponseDocumentStaticFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentStaticFieldDateSigned>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldDateSigned" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateResponseDocumentStaticFieldDateSigned() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldDateSigned" /> class.
        /// </summary>
        /// <param name="type">_t__TemplateResponseDocumentStaticField::TYPE (required) (default to &quot;date_signed&quot;).</param>
        ...
        public TemplateResponseDocumentStaticFieldDateSigned(string type = @"date_signed", string apiId = default(string), string name = default(string), string signer = @"me_now", int x = default(int), int y = default(int), int width = default(int), int height = default(int), bool required = default(bool), string group = default(string))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for TemplateResponseDocumentStaticFieldDateSigned and cannot be null");
            }
            this.Type = type;
        }
        ...
        public static TemplateResponseDocumentStaticFieldDateSigned Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticFieldDateSigned>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentStaticFieldDateSigned");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentStaticFieldDateSigned);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentStaticFieldDateSigned instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentStaticFieldDateSigned to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentStaticFieldDateSigned input)
        {
            if (input == null)
            {
                return false;
