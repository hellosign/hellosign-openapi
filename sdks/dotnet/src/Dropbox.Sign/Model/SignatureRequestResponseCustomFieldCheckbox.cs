...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestResponseCustomFieldCheckbox : SignatureRequestResponseCustomFieldBase, IOpenApiTyped, IEquatable<SignatureRequestResponseCustomFieldCheckbox>, IValidatableObject
    {
        ...
        /// Initializes a new instance of the <see cref="SignatureRequestResponseCustomFieldCheckbox" /> class.
        /// </summary>
        /// <param name="type">_t__SignatureRequestResponseCustomField::TYPE (required) (default to &quot;checkbox&quot;).</param>
        /// <param name="value">_t__SignatureRequestResponseCustomField::VALUE_CHECKBOX.</param>
        ...
        public static SignatureRequestResponseCustomFieldCheckbox Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<SignatureRequestResponseCustomFieldCheckbox>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of SignatureRequestResponseCustomFieldCheckbox");
            }
        ...
        /// </summary>
        /// <value>_t__SignatureRequestResponseCustomField::VALUE_CHECKBOX</value>
