...
namespace Dropbox.Sign.Model
{
    ...
    public partial class AccountResponse : IEquatable<AccountResponse>, IValidatableObject
    {
        ...
        public AccountResponse(
            ...
            bool isPaidHs = default(bool),
            bool isPaidHf = default(bool),
            AccountResponseQuotas quotas = default(AccountResponseQuotas),
            string callbackUrl = default(string),
            string roleCode = default(string),
            string teamId = default(string),
            string locale = default(string),
            AccountResponseUsage usage = default(AccountResponseUsage)
        )
        {
        ...
        public bool Equals(AccountResponse input)
        {
            ...
            return (
                ...
                && (this.IsLocked == input.IsLocked || this.IsLocked.Equals(input.IsLocked))
                && (this.IsPaidHs == input.IsPaidHs || this.IsPaidHs.Equals(input.IsPaidHs))
                && (this.IsPaidHf == input.IsPaidHf || this.IsPaidHf.Equals(input.IsPaidHf))
                && (
                    this.Quotas == input.Quotas
                    || (this.Quotas != null && this.Quotas.Equals(input.Quotas))
                )
                && (
                ...
                && (
                    ...
                    || (this.RoleCode != null && this.RoleCode.Equals(input.RoleCode))
                )
                && (
                ...
                && (
                    ...
                    || (this.Usage != null && this.Usage.Equals(input.Usage))
                );
        }
