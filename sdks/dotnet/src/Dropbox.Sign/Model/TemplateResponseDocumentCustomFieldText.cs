...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentCustomFieldText
        : TemplateResponseDocumentCustomFieldBase,
            IOpenApiTyped,
            IEquatable<TemplateResponseDocumentCustomFieldText>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException(
                    "type is a required property for TemplateResponseDocumentCustomFieldText and cannot be null"
                );
            }
            this.Type = type;
        ...
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentCustomFieldText>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseDocumentCustomFieldText"
                );
            }
