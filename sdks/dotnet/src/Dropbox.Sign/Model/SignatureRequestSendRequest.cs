...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestSendRequest
        : IEquatable<SignatureRequestSendRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static SignatureRequestSendRequest Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestSendRequest"
                );
            }
