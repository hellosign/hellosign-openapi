...
namespace Dropbox.Sign.Model
{
    ...
    public partial class UnclaimedDraftCreateEmbeddedRequest
        : IEquatable<UnclaimedDraftCreateEmbeddedRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        public UnclaimedDraftCreateEmbeddedRequest(
            ...
            List<SubAttachment> attachments = default(List<SubAttachment>),
            ...
            bool forceSignerPage = false,
            bool forceSubjectMessage = false,
            List<SubFormFieldGroup> formFieldGroups = default(List<SubFormFieldGroup>),
            List<SubFormFieldRule> formFieldRules = default(List<SubFormFieldRule>),
            List<SubFormFieldsPerDocumentBase> formFieldsPerDocument =
                default(List<SubFormFieldsPerDocumentBase>),
            bool hideTextTags = false,
            ...
            bool showPreview = default(bool),
            bool showProgressStepper = true,
            List<SubUnclaimedDraftSigner> signers = default(List<SubUnclaimedDraftSigner>),
            ...
            bool testMode = false,
            TypeEnum? type = TypeEnum.RequestSignature,
            bool usePreexistingFields = false,
            bool useTextTags = false,
        ...
        )
        {
            ...
            if (clientId == null)
            {
                throw new ArgumentNullException(
                    "clientId is a required property for UnclaimedDraftCreateEmbeddedRequest and cannot be null"
                );
            }
            ...
            {
                throw new ArgumentNullException(
                    "requesterEmailAddress is a required property for UnclaimedDraftCreateEmbeddedRequest and cannot be null"
                );
            }
        ...
        public static UnclaimedDraftCreateEmbeddedRequest Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<UnclaimedDraftCreateEmbeddedRequest>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of UnclaimedDraftCreateEmbeddedRequest"
                );
            }
        ...
        )
        {
            ...
            {
                yield return new ValidationResult(
                    "Invalid value for Subject, length must be less than 200.",
                    new[] { "Subject" }
                );
            }
