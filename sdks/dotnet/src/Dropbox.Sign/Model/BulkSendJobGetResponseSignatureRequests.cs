...
namespace Dropbox.Sign.Model
{
    ...
    public partial class BulkSendJobGetResponseSignatureRequests
        : IEquatable<BulkSendJobGetResponseSignatureRequests>,
            IValidatableObject
    {
        /// <summary>
        ...
        public BulkSendJobGetResponseSignatureRequests(
            bool? testMode = false,
            string signatureRequestId = default(string),
            string requesterEmailAddress = default(string),
            string title = default(string),
            string originalTitle = default(string),
            string subject = default(string),
            string message = default(string),
            Object metadata = default(Object),
            int createdAt = default(int),
            int expiresAt = default(int),
            bool isComplete = default(bool),
            bool isDeclined = default(bool),
            bool hasError = default(bool),
            string filesUrl = default(string),
            string signingUrl = default(string),
            string detailsUrl = default(string),
            List<string> ccEmailAddresses = default(List<string>),
            string signingRedirectUrl = default(string),
            string finalCopyUri = default(string),
            List<string> templateIds = default(List<string>),
            List<SignatureRequestResponseCustomFieldBase> customFields =
                default(List<SignatureRequestResponseCustomFieldBase>),
            List<SignatureRequestResponseAttachment> attachments =
                default(List<SignatureRequestResponseAttachment>),
            List<SignatureRequestResponseDataBase> responseData =
                default(List<SignatureRequestResponseDataBase>),
            List<SignatureRequestResponseSignatures> signatures =
                default(List<SignatureRequestResponseSignatures>),
        ...
        {
            var obj = JsonConvert.DeserializeObject<BulkSendJobGetResponseSignatureRequests>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of BulkSendJobGetResponseSignatureRequests"
                );
            }
        ...
        public bool Equals(BulkSendJobGetResponseSignatureRequests input)
        {
            ...
            return (
                    ...
                    || (this.TestMode != null && this.TestMode.Equals(input.TestMode))
                )
                && (
                ...
                && (
                    ...
                    || (
                        this.OriginalTitle != null && this.OriginalTitle.Equals(input.OriginalTitle)
                    )
                )
                && (
                ...
                && (this.IsComplete == input.IsComplete || this.IsComplete.Equals(input.IsComplete))
                && (this.IsDeclined == input.IsDeclined || this.IsDeclined.Equals(input.IsDeclined))
                && (this.HasError == input.HasError || this.HasError.Equals(input.HasError))
                && (
                    this.FilesUrl == input.FilesUrl
                    || (this.FilesUrl != null && this.FilesUrl.Equals(input.FilesUrl))
                )
                && (
                    this.SigningUrl == input.SigningUrl
                    || (this.SigningUrl != null && this.SigningUrl.Equals(input.SigningUrl))
                )
                && (
                    this.DetailsUrl == input.DetailsUrl
                    || (this.DetailsUrl != null && this.DetailsUrl.Equals(input.DetailsUrl))
                )
                && (
