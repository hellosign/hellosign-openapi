...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestCreateEmbeddedRequest
        : IEquatable<SignatureRequestCreateEmbeddedRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (clientId == null)
            {
                throw new ArgumentNullException(
                    "clientId is a required property for SignatureRequestCreateEmbeddedRequest and cannot be null"
                );
            }
        ...
        {
            var obj = JsonConvert.DeserializeObject<SignatureRequestCreateEmbeddedRequest>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestCreateEmbeddedRequest"
                );
            }
