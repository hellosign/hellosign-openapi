...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestCreateEmbeddedRequest : IEquatable<SignatureRequestCreateEmbeddedRequest>, IValidatableObject
    {
        /// <summary>
