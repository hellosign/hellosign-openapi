...
namespace Dropbox.Sign.Model
{
    ...
    public partial class ApiAppCreateRequest : IEquatable<ApiAppCreateRequest>, IValidatableObject
    {
        ...
        )
        {
            ...
            if (domains == null)
            {
                throw new ArgumentNullException(
                    "domains is a required property for ApiAppCreateRequest and cannot be null"
                );
            }
            ...
            {
                throw new ArgumentNullException(
                    "name is a required property for ApiAppCreateRequest and cannot be null"
                );
            }
            this.Name = name;
        ...
        public static ApiAppCreateRequest Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<ApiAppCreateRequest>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of ApiAppCreateRequest"
                );
            }
