...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentFormFieldSignature")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TemplateResponseDocumentFormFieldSignature : TemplateResponseDocumentFormFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentFormFieldSignature>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentFormFieldSignature" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateResponseDocumentFormFieldSignature() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentFormFieldSignature" /> class.
        /// </summary>
        /// <param name="type">_t__TemplateResponseDocumentFormField::TYPE (required) (default to &quot;signature&quot;).</param>
        ...
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentFormFieldSignature>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentFormFieldSignature");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentFormFieldSignature);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentFormFieldSignature instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentFormFieldSignature to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentFormFieldSignature input)
        {
            if (input == null)
            {
                return false;
