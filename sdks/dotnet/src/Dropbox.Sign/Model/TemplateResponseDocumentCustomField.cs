...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseDocumentCustomField
        : IOpenApiTyped,
            IEquatable<TemplateResponseDocumentCustomField>,
            IValidatableObject
    {
        /// <summary>
        ...
        public TemplateResponseDocumentCustomField(
            ...
            Object namedFormFields = default(Object),
            string reusableFormId = default(string)
        )
        {
            this.Name = name;
            this.Type = type;
        ...
        public static TemplateResponseDocumentCustomField Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentCustomField>(jsonData);

            if (obj == null)
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseDocumentCustomField"
                );
            }
