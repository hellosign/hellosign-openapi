...
namespace Dropbox.Sign.Model
{
    ...
    public partial class EmbeddedSignUrlResponse
        : IEquatable<EmbeddedSignUrlResponse>,
            IValidatableObject
    {
        /// <summary>
        ...
        public EmbeddedSignUrlResponse(
            EmbeddedSignUrlResponseEmbedded embedded = default(EmbeddedSignUrlResponseEmbedded),
        ...
        public static EmbeddedSignUrlResponse Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of EmbeddedSignUrlResponse"
                );
            }
