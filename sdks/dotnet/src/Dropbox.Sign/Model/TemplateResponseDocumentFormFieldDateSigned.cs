...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentFormFieldDateSigned")]
    ...
    public partial class TemplateResponseDocumentFormFieldDateSigned : TemplateResponseDocumentFormFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentFormFieldDateSigned>, IValidatableObject
    {
        ...
        public static TemplateResponseDocumentFormFieldDateSigned Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentFormFieldDateSigned>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentFormFieldDateSigned");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentFormFieldDateSigned);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentFormFieldDateSigned instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentFormFieldDateSigned to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentFormFieldDateSigned input)
        {
            if (input == null)
            {
                return false;
