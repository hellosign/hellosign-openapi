...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentStaticFieldInitials")]
    ...
    public partial class TemplateResponseDocumentStaticFieldInitials : TemplateResponseDocumentStaticFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentStaticFieldInitials>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldInitials" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateResponseDocumentStaticFieldInitials() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentStaticFieldInitials" /> class.
        /// </summary>
        /// <param name="type">The type of this static field. See [field types](/api/reference/constants/#field-types).  * Text Field uses &#x60;TemplateResponseDocumentStaticFieldText&#x60; * Dropdown Field uses &#x60;TemplateResponseDocumentStaticFieldDropdown&#x60; * Hyperlink Field uses &#x60;TemplateResponseDocumentStaticFieldHyperlink&#x60; * Checkbox Field uses &#x60;TemplateResponseDocumentStaticFieldCheckbox&#x60; * Radio Field uses &#x60;TemplateResponseDocumentStaticFieldRadio&#x60; * Signature Field uses &#x60;TemplateResponseDocumentStaticFieldSignature&#x60; * Date Signed Field uses &#x60;TemplateResponseDocumentStaticFieldDateSigned&#x60; * Initials Field uses &#x60;TemplateResponseDocumentStaticFieldInitials&#x60; (required) (default to &quot;initials&quot;).</param>
        ...
        public TemplateResponseDocumentStaticFieldInitials(string type = "initials", string apiId = default(string), string name = default(string), string signer = "me_now", int x = default(int), int y = default(int), int width = default(int), int height = default(int), bool required = default(bool), string group = default(string), int fontSize = default(int))
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException("type is a required property for TemplateResponseDocumentStaticFieldInitials and cannot be null");
            }
            this.Type = type;
        }
        ...
        public static TemplateResponseDocumentStaticFieldInitials Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentStaticFieldInitials>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateResponseDocumentStaticFieldInitials");
            }
        ...
        {
            return this.Equals(input as TemplateResponseDocumentStaticFieldInitials);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentStaticFieldInitials instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentStaticFieldInitials to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentStaticFieldInitials input)
        {
            if (input == null)
            {
                return false;
