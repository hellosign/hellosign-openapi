...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateGetResponse : IEquatable<TemplateGetResponse>, IValidatableObject
    {
        ...
        public static TemplateGetResponse Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateGetResponse>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateGetResponse");
            }
