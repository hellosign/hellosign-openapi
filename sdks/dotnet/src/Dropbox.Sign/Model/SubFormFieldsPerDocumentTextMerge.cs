...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentTextMerge
        : SubFormFieldsPerDocumentBase,
            IOpenApiTyped,
            IEquatable<SubFormFieldsPerDocumentTextMerge>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (type == null)
            {
                throw new ArgumentNullException(
                    "type is a required property for SubFormFieldsPerDocumentTextMerge and cannot be null"
                );
            }
            this.Type = type;
        ...
        public static SubFormFieldsPerDocumentTextMerge Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SubFormFieldsPerDocumentTextMerge"
                );
            }
