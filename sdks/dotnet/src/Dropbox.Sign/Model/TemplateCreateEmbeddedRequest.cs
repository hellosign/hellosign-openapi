...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateCreateEmbeddedRequest")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TemplateCreateEmbeddedRequest : IOpenApiTyped, IEquatable<TemplateCreateEmbeddedRequest>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateCreateEmbeddedRequest" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateCreateEmbeddedRequest() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateCreateEmbeddedRequest" /> class.
        /// </summary>
        ...
        public static TemplateCreateEmbeddedRequest Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateCreateEmbeddedRequest>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TemplateCreateEmbeddedRequest");
            }
        ...
        {
            return this.Equals(input as TemplateCreateEmbeddedRequest);
        }

        /// <summary>
        /// Returns true if TemplateCreateEmbeddedRequest instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateCreateEmbeddedRequest to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateCreateEmbeddedRequest input)
        {
            if (input == null)
            {
                return false;
