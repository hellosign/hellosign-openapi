...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TemplateResponseCustomField
        : IOpenApiTyped,
            IEquatable<TemplateResponseCustomField>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static TemplateResponseCustomField Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of TemplateResponseCustomField"
                );
            }
