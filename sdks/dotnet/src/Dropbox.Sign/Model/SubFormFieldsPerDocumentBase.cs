...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentBase : IOpenApiTyped, IEquatable<SubFormFieldsPerDocumentBase>, IValidatableObject
    {
        ...
        /// <param name="signer">Signer index identified by the offset in the signers parameter (0-based indexing), indicating which signer should fill out the field.  **NOTE**: If type is &#x60;text-merge&#x60; or &#x60;checkbox-merge&#x60;, you must set this to &#x60;me_now&#x60; in order to use pre-filled data.   (required).</param>
        ...
        /// </summary>
        /// <value>Signer index identified by the offset in the signers parameter (0-based indexing), indicating which signer should fill out the field.  **NOTE**: If type is &#x60;text-merge&#x60; or &#x60;checkbox-merge&#x60;, you must set this to &#x60;me_now&#x60; in order to use pre-filled data.  </value>
