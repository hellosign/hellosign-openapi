...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SubFormFieldsPerDocumentBase
        : IEquatable<SubFormFieldsPerDocumentBase>,
            IValidatableObject
    {
        /// <summary>
        ...
        )
        {
            ...
            if (apiId == null)
            {
                throw new ArgumentNullException(
                    "apiId is a required property for SubFormFieldsPerDocumentBase and cannot be null"
                );
            }
            this.ApiId = apiId;
            this.Height = height;
            ...
            {
                throw new ArgumentNullException(
                    "signer is a required property for SubFormFieldsPerDocumentBase and cannot be null"
                );
            }
            ...
            {
                throw new ArgumentNullException(
                    "type is a required property for SubFormFieldsPerDocumentBase and cannot be null"
                );
            }
            this.Type = type;
            this.Width = width;
        ...
        public static SubFormFieldsPerDocumentBase Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SubFormFieldsPerDocumentBase"
                );
            }
        ...
        public bool Equals(SubFormFieldsPerDocumentBase input)
        {
            ...
            return (
                ...
                && (this.Page == input.Page || (this.Page != null && this.Page.Equals(input.Page)));
        }
