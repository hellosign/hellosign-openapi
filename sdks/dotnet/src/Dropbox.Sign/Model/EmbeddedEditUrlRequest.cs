...
namespace Dropbox.Sign.Model
{
    ...
    public partial class EmbeddedEditUrlRequest
        : IEquatable<EmbeddedEditUrlRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static EmbeddedEditUrlRequest Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of EmbeddedEditUrlRequest"
                );
            }
