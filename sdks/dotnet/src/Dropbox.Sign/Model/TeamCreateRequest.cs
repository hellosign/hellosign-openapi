...
namespace Dropbox.Sign.Model
{
    ...
    public partial class TeamCreateRequest : IEquatable<TeamCreateRequest>, IValidatableObject
    {
        ...
        public static TeamCreateRequest Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TeamCreateRequest>(jsonData);

            if (obj == null)
            {
                throw new Exception("Unable to deserialize JSON to instance of TeamCreateRequest");
            }
