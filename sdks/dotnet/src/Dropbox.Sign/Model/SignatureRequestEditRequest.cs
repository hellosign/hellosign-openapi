...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestEditRequest
        : IOpenApiTyped,
            IEquatable<SignatureRequestEditRequest>,
            IValidatableObject
    {
        /// <summary>
        ...
        public static SignatureRequestEditRequest Init(string jsonData)
        {
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestEditRequest"
                );
            }
