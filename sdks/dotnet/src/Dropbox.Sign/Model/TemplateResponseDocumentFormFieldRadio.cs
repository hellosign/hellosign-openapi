...
namespace Dropbox.Sign.Model
{
    ...
    /// </summary>
    [DataContract(Name = "TemplateResponseDocumentFormFieldRadio")]
    [JsonObject(ItemNullValueHandling = NullValueHandling.Ignore)]
    public partial class TemplateResponseDocumentFormFieldRadio : TemplateResponseDocumentFormFieldBase, IOpenApiTyped, IEquatable<TemplateResponseDocumentFormFieldRadio>, IValidatableObject
    {
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentFormFieldRadio" /> class.
        /// </summary>
        [JsonConstructorAttribute]
        protected TemplateResponseDocumentFormFieldRadio() { }
        /// <summary>
        /// Initializes a new instance of the <see cref="TemplateResponseDocumentFormFieldRadio" /> class.
        /// </summary>
        /// <param name="type">_t__TemplateResponseDocumentFormField::TYPE (required) (default to &quot;radio&quot;).</param>
        /// <param name="group">_t__TemplateResponseDocumentFormField::GROUP (required).</param>
        ...
        public static TemplateResponseDocumentFormFieldRadio Init(string jsonData)
        {
            var obj = JsonConvert.DeserializeObject<TemplateResponseDocumentFormFieldRadio>(jsonData);
        ...
        {
            return this.Equals(input as TemplateResponseDocumentFormFieldRadio);
        }

        /// <summary>
        /// Returns true if TemplateResponseDocumentFormFieldRadio instances are equal
        /// </summary>
        /// <param name="input">Instance of TemplateResponseDocumentFormFieldRadio to be compared</param>
        /// <returns>Boolean</returns>
        public bool Equals(TemplateResponseDocumentFormFieldRadio input)
        {
            if (input == null)
            {
                return false;
