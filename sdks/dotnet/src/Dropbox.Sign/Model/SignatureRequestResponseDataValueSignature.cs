...
namespace Dropbox.Sign.Model
{
    ...
    public partial class SignatureRequestResponseDataValueSignature
        : SignatureRequestResponseDataBase,
            IOpenApiTyped,
            IEquatable<SignatureRequestResponseDataValueSignature>,
            IValidatableObject
    {
        /// <summary>
        ...
        {
            var obj = JsonConvert.DeserializeObject<SignatureRequestResponseDataValueSignature>(
                jsonData
            );
            ...
            {
                throw new Exception(
                    "Unable to deserialize JSON to instance of SignatureRequestResponseDataValueSignature"
                );
            }
