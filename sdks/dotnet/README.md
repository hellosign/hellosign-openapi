...
The Dropbox Sign .NET SDK **beta/pre-release** can be installed using the NuGet package manager, under the package name **Dropbox.Sign** ([package details](https://www.nuget.org/packages/HelloSign/6.0.0-beta.2)).
