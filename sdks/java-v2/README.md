...
```groovy
  ...
  dependencies {
     implementation "com.dropbox.sign:dropbox-sign:2.6-dev"
  }
```
...
- `target/dropbox-sign-2.6-dev.jar`
- `target/lib/*.jar`
...
*TemplateApi* | [**templateEdit**](docs/TemplateApi.md#templateEdit) | **POST** /template/edit/{template_id} | Edit Template
