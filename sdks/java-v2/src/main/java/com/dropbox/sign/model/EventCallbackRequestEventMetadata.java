...
public class EventCallbackRequestEventMetadata {
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_RELATED_SIGNATURE_ID)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REPORTED_FOR_ACCOUNT_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REPORTED_FOR_APP_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return eventMessage
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_EVENT_MESSAGE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
