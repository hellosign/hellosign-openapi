...
public class TemplateResponseDocumentFormFieldText extends TemplateResponseDocumentFormFieldBase {
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_AVG_TEXT_LENGTH)
     ...
     * @return isMultiline
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_MULTILINE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ORIGINAL_FONT_SIZE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
