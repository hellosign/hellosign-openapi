...
@JsonSubTypes({
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldCheckbox.class,
            name = "checkbox"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldDateSigned.class,
            name = "date_signed"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldDropdown.class,
            name = "dropdown"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldHyperlink.class,
            name = "hyperlink"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldInitials.class,
            name = "initials"),
    @JsonSubTypes.Type(value = TemplateResponseDocumentStaticFieldRadio.class, name = "radio"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentStaticFieldSignature.class,
            name = "signature"),
...
public class TemplateResponseDocumentStaticFieldBase {
     ...
     */
    public static TemplateResponseDocumentStaticFieldBase init(String jsonData) throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, TemplateResponseDocumentStaticFieldBase.class);
    }

    public static TemplateResponseDocumentStaticFieldBase init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
     ...
     * @return signer
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return x
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_X)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public Integer getX() {
        return x;
    }
     ...
     * @return y
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_Y)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public Integer getY() {
        return y;
    }
     ...
     * @return width
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_WIDTH)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return height
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_HEIGHT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
