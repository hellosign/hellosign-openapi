...
public class TeamInfoResponse {
     ...
     * @return teamParent
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_TEAM_PARENT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return numMembers
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_MEMBERS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return numSubTeams
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_SUB_TEAMS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            ...
            if (teamParent != null) {
                ...
                if (teamParent.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "team_parent",
                            JSON.getDefault().getMapper().writeValueAsString(teamParent));
                }
            }
            if (name != null) {
            ...
            if (numMembers != null) {
                ...
                if (numMembers.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_members",
                            JSON.getDefault().getMapper().writeValueAsString(numMembers));
                }
            }
            if (numSubTeams != null) {
                ...
                if (numSubTeams.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_sub_teams",
                            JSON.getDefault().getMapper().writeValueAsString(numSubTeams));
                }
            }
        } catch (Exception e) {
