...
public class SignatureRequestResponseSignatures {
     ...
     */
    public static SignatureRequestResponseSignatures init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SignatureRequestResponseSignatures.class);
    }

    public static SignatureRequestResponseSignatures init(HashMap data) throws Exception {
     ...
     * @return signatureId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNATURE_ID)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_GROUP_GUID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_EMAIL_ADDRESS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return signerName
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_NAME)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return signerRole
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_ROLE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return order
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ORDER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return statusCode
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_STATUS_CODE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_DECLINE_REASON)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return signedAt
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNED_AT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return lastViewedAt
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_LAST_VIEWED_AT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_LAST_REMINDED_AT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return hasPin
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_HAS_PIN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return hasSmsAuth
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_HAS_SMS_AUTH)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_HAS_SMS_DELIVERY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SMS_PHONE_NUMBER)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return reassignedBy
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REASSIGNED_BY)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REASSIGNMENT_REASON)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REASSIGNED_FROM)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestResponseSignatures signatureRequestResponseSignatures =
                (SignatureRequestResponseSignatures) o;
        return Objects.equals(this.signatureId, signatureRequestResponseSignatures.signatureId)
                && Objects.equals(
                        this.signerGroupGuid, signatureRequestResponseSignatures.signerGroupGuid)
                && Objects.equals(
                        this.signerEmailAddress,
                        signatureRequestResponseSignatures.signerEmailAddress)
                ...
                && Objects.equals(
                        this.declineReason, signatureRequestResponseSignatures.declineReason)
                && Objects.equals(this.signedAt, signatureRequestResponseSignatures.signedAt)
                && Objects.equals(
                        this.lastViewedAt, signatureRequestResponseSignatures.lastViewedAt)
                && Objects.equals(
                        this.lastRemindedAt, signatureRequestResponseSignatures.lastRemindedAt)
                ...
                && Objects.equals(
                        this.hasSmsDelivery, signatureRequestResponseSignatures.hasSmsDelivery)
                && Objects.equals(
                        this.smsPhoneNumber, signatureRequestResponseSignatures.smsPhoneNumber)
                && Objects.equals(
                        this.reassignedBy, signatureRequestResponseSignatures.reassignedBy)
                && Objects.equals(
                        this.reassignmentReason,
                        signatureRequestResponseSignatures.reassignmentReason)
                && Objects.equals(
                        this.reassignedFrom, signatureRequestResponseSignatures.reassignedFrom)
    ...
    public String toString() {
        ...
        sb.append("    signerEmailAddress: ")
                .append(toIndentedString(signerEmailAddress))
                .append("\n");
        ...
        sb.append("    reassignmentReason: ")
                .append(toIndentedString(reassignmentReason))
                .append("\n");
        ...
        try {
            if (signatureId != null) {
                ...
                if (signatureId.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signature_id",
                            JSON.getDefault().getMapper().writeValueAsString(signatureId));
                }
            }
            if (signerGroupGuid != null) {
                ...
                if (signerGroupGuid.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signer_group_guid",
                            JSON.getDefault().getMapper().writeValueAsString(signerGroupGuid));
                }
            }
            if (signerEmailAddress != null) {
                ...
                if (signerEmailAddress.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(signerEmailAddress); i++) {
                        map.put(
                                "signer_email_address[" + i + "]",
                                getFromList(signerEmailAddress, i));
                    }
                } else {
                    map.put(
                            "signer_email_address",
                            JSON.getDefault().getMapper().writeValueAsString(signerEmailAddress));
                }
            }
            if (signerName != null) {
                ...
                if (signerName.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signer_name",
                            JSON.getDefault().getMapper().writeValueAsString(signerName));
                }
            }
            if (signerRole != null) {
                ...
                if (signerRole.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signer_role",
                            JSON.getDefault().getMapper().writeValueAsString(signerRole));
                }
            }
            if (order != null) {
            ...
            if (declineReason != null) {
                ...
                if (declineReason.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "decline_reason",
                            JSON.getDefault().getMapper().writeValueAsString(declineReason));
                }
            }
            if (signedAt != null) {
                ...
                if (signedAt.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signed_at",
                            JSON.getDefault().getMapper().writeValueAsString(signedAt));
                }
            }
            if (lastViewedAt != null) {
                ...
                if (lastViewedAt.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "last_viewed_at",
                            JSON.getDefault().getMapper().writeValueAsString(lastViewedAt));
                }
            }
            if (lastRemindedAt != null) {
                ...
                if (lastRemindedAt.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "last_reminded_at",
                            JSON.getDefault().getMapper().writeValueAsString(lastRemindedAt));
                }
            }
            if (hasPin != null) {
            ...
            if (hasSmsAuth != null) {
                ...
                if (hasSmsAuth.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "has_sms_auth",
                            JSON.getDefault().getMapper().writeValueAsString(hasSmsAuth));
                }
            }
            if (hasSmsDelivery != null) {
                ...
                if (hasSmsDelivery.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "has_sms_delivery",
                            JSON.getDefault().getMapper().writeValueAsString(hasSmsDelivery));
                }
            }
            if (smsPhoneNumber != null) {
                ...
                if (smsPhoneNumber.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "sms_phone_number",
                            JSON.getDefault().getMapper().writeValueAsString(smsPhoneNumber));
                }
            }
            if (reassignedBy != null) {
                ...
                if (reassignedBy.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "reassigned_by",
                            JSON.getDefault().getMapper().writeValueAsString(reassignedBy));
                }
            }
            if (reassignmentReason != null) {
                ...
                if (reassignmentReason.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(reassignmentReason); i++) {
                        map.put(
                                "reassignment_reason[" + i + "]",
                                getFromList(reassignmentReason, i));
                    }
                } else {
                    map.put(
                            "reassignment_reason",
                            JSON.getDefault().getMapper().writeValueAsString(reassignmentReason));
                }
            }
            if (reassignedFrom != null) {
                ...
                if (reassignedFrom.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "reassigned_from",
                            JSON.getDefault().getMapper().writeValueAsString(reassignedFrom));
                }
            }
            if (error != null) {
