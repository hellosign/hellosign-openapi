...
public class TemplateResponseSignerRole {
     ...
     */
    public static TemplateResponseSignerRole init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponseSignerRole.class);
    }

    public static TemplateResponseSignerRole init(HashMap data) throws Exception {
