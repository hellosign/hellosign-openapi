...
public class SignatureRequestEditRequest {
   ...
   */
  static public SignatureRequestEditRequest init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, SignatureRequestEditRequest.class);
  }

  static public SignatureRequestEditRequest init(HashMap data) throws Exception {
  ...
  public SignatureRequestEditRequest files(@jakarta.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestEditRequest fileUrls(@jakarta.annotation.Nullable List<String> fileUrls) {
  ...
  public SignatureRequestEditRequest signers(@jakarta.annotation.Nullable List<SubSignatureRequestSigner> signers) {
  ...
  public SignatureRequestEditRequest groupedSigners(@jakarta.annotation.Nullable List<SubSignatureRequestGroupedSigners> groupedSigners) {
    this.groupedSigners = groupedSigners;
    return this;
  }

  public SignatureRequestEditRequest addGroupedSignersItem(SubSignatureRequestGroupedSigners groupedSignersItem) {
  ...
  public SignatureRequestEditRequest allowDecline(@jakarta.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestEditRequest allowReassign(@jakarta.annotation.Nullable Boolean allowReassign) {
  ...
  public SignatureRequestEditRequest attachments(@jakarta.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public SignatureRequestEditRequest ccEmailAddresses(@jakarta.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public SignatureRequestEditRequest clientId(@jakarta.annotation.Nullable String clientId) {
  ...
  public SignatureRequestEditRequest customFields(@jakarta.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestEditRequest fieldOptions(@jakarta.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public SignatureRequestEditRequest formFieldGroups(@jakarta.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
    this.formFieldGroups = formFieldGroups;
    return this;
  }

  public SignatureRequestEditRequest addFormFieldGroupsItem(SubFormFieldGroup formFieldGroupsItem) {
  ...
  public SignatureRequestEditRequest formFieldRules(@jakarta.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  public SignatureRequestEditRequest formFieldsPerDocument(@jakarta.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
    this.formFieldsPerDocument = formFieldsPerDocument;
    return this;
  }

  public SignatureRequestEditRequest addFormFieldsPerDocumentItem(SubFormFieldsPerDocumentBase formFieldsPerDocumentItem) {
  ...
  public SignatureRequestEditRequest hideTextTags(@jakarta.annotation.Nullable Boolean hideTextTags) {
  ...
  public SignatureRequestEditRequest isEid(@jakarta.annotation.Nullable Boolean isEid) {
    this.isEid = isEid;
    return this;
  }
  ...
  public SignatureRequestEditRequest message(@jakarta.annotation.Nullable String message) {
  ...
  public SignatureRequestEditRequest metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestEditRequest signingOptions(@jakarta.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestEditRequest subject(@jakarta.annotation.Nullable String subject) {
  ...
  public SignatureRequestEditRequest testMode(@jakarta.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestEditRequest title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public SignatureRequestEditRequest useTextTags(@jakarta.annotation.Nullable Boolean useTextTags) {
  ...
  public SignatureRequestEditRequest signerExperience(@jakarta.annotation.Nullable SubSignerExperience signerExperience) {
  ...
  public boolean equals(Object o) {
    ...
    return Objects.equals(this.files, signatureRequestEditRequest.files) &&
        ...
        Objects.equals(this.formFieldsPerDocument, signatureRequestEditRequest.formFieldsPerDocument) &&
        ...
        Objects.equals(this.signingRedirectUrl, signatureRequestEditRequest.signingRedirectUrl) &&
        ...
        Objects.equals(this.signerExperience, signatureRequestEditRequest.signerExperience);
  }
