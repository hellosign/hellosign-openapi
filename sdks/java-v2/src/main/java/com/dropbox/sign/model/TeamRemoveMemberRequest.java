...
public class TeamRemoveMemberRequest {
    ...
    /**
     * **account_id** or **email_address** is required. If both are provided, the account id
     * prevails. Account id to remove from your Team.
     *
     * @return accountId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ACCOUNT_ID)
    ...
    /**
     * **account_id** or **email_address** is required. If both are provided, the account id
     * prevails. Email address of the Account to remove from your Team.
     *
     * @return emailAddress
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_EMAIL_ADDRESS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    /**
     * The email address of an Account on this Team to receive all documents, templates, and API
     * apps (if applicable) from the removed Account. If not provided, and on an Enterprise plan,
     * this data will remain with the removed Account. **NOTE:** Only available for Enterprise
     * plans.
     *
     * @return newOwnerEmailAddress
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NEW_OWNER_EMAIL_ADDRESS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return newTeamId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NEW_TEAM_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return newRole
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NEW_ROLE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.accountId, teamRemoveMemberRequest.accountId)
                ...
                && Objects.equals(
                        this.newOwnerEmailAddress, teamRemoveMemberRequest.newOwnerEmailAddress)
    ...
    public String toString() {
        ...
        sb.append("    newOwnerEmailAddress: ")
                .append(toIndentedString(newOwnerEmailAddress))
                .append("\n");
            ...
            if (newOwnerEmailAddress != null) {
                ...
                if (newOwnerEmailAddress.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(newOwnerEmailAddress); i++) {
                        map.put(
                                "new_owner_email_address[" + i + "]",
                                getFromList(newOwnerEmailAddress, i));
                    }
                } else {
                    map.put(
                            "new_owner_email_address",
                            JSON.getDefault().getMapper().writeValueAsString(newOwnerEmailAddress));
                }
            }
            if (newTeamId != null) {
                ...
                if (newTeamId.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "new_team_id",
                            JSON.getDefault().getMapper().writeValueAsString(newTeamId));
                }
            }
            if (newRole != null) {
