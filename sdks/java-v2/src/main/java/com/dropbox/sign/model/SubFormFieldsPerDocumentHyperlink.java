...
public class SubFormFieldsPerDocumentHyperlink extends SubFormFieldsPerDocumentBase {
     ...
     */
    public static SubFormFieldsPerDocumentHyperlink init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubFormFieldsPerDocumentHyperlink.class);
    }

    public static SubFormFieldsPerDocumentHyperlink init(HashMap data) throws Exception {
    ...
    public boolean equals(Object o) {
        ...
        SubFormFieldsPerDocumentHyperlink subFormFieldsPerDocumentHyperlink =
                (SubFormFieldsPerDocumentHyperlink) o;
        return Objects.equals(this.type, subFormFieldsPerDocumentHyperlink.type)
                ...
                && Objects.equals(this.fontFamily, subFormFieldsPerDocumentHyperlink.fontFamily)
                && Objects.equals(this.fontSize, subFormFieldsPerDocumentHyperlink.fontSize)
                && super.equals(o);
    }

    @Override
    public int hashCode() {
        return Objects.hash(type, content, contentUrl, fontFamily, fontSize, super.hashCode());
    }
        ...
        try {
            ...
            if (contentUrl != null) {
                ...
                if (contentUrl.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "content_url",
                            JSON.getDefault().getMapper().writeValueAsString(contentUrl));
                }
            }
            if (fontFamily != null) {
