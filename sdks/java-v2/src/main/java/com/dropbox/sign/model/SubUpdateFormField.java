 ...
 */
@JsonPropertyOrder({
  SubUpdateFormField.JSON_PROPERTY_API_ID,
  SubUpdateFormField.JSON_PROPERTY_NAME
})
...
public class SubUpdateFormField {
   ...
   */
  static public SubUpdateFormField init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, SubUpdateFormField.class);
  }

  static public SubUpdateFormField init(HashMap data) throws Exception {
  ...
  public SubUpdateFormField apiId(@jakarta.annotation.Nonnull String apiId) {
    this.apiId = apiId;
    return this;
  }
  ...
  public SubUpdateFormField name(@jakarta.annotation.Nullable String name) {
    this.name = name;
    return this;
  }
