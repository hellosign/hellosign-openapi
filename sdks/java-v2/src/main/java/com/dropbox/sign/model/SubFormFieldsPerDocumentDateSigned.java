...
public class SubFormFieldsPerDocumentDateSigned extends SubFormFieldsPerDocumentBase {
  ...
  public SubFormFieldsPerDocumentDateSigned type(@jakarta.annotation.Nonnull String type) {
    this.type = type;
    return this;
  }
  ...
  public SubFormFieldsPerDocumentDateSigned fontFamily(@jakarta.annotation.Nullable FontFamilyEnum fontFamily) {
  ...
  public SubFormFieldsPerDocumentDateSigned fontSize(@jakarta.annotation.Nullable Integer fontSize) {
