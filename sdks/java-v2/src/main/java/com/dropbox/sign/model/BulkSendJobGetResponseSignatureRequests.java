...
public class BulkSendJobGetResponseSignatureRequests {
     ...
     */
    public static BulkSendJobGetResponseSignatureRequests init(String jsonData) throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, BulkSendJobGetResponseSignatureRequests.class);
    }

    public static BulkSendJobGetResponseSignatureRequests init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNATURE_REQUEST_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REQUESTER_EMAIL_ADDRESS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ORIGINAL_TITLE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return isComplete
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_COMPLETE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return isDeclined
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_DECLINED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return hasError
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_HAS_ERROR)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return filesUrl
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_FILES_URL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return signingUrl
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNING_URL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return detailsUrl
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_DETAILS_URL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public BulkSendJobGetResponseSignatureRequests addCcEmailAddressesItem(
     ...
     * @return finalCopyUri
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_FINAL_COPY_URI)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return templateIds
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_TEMPLATE_IDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public BulkSendJobGetResponseSignatureRequests addCustomFieldsItem(
            SignatureRequestResponseCustomFieldBase customFieldsItem) {
    ...
    public BulkSendJobGetResponseSignatureRequests addAttachmentsItem(
            SignatureRequestResponseAttachment attachmentsItem) {
    ...
    public BulkSendJobGetResponseSignatureRequests addResponseDataItem(
            SignatureRequestResponseDataBase responseDataItem) {
     ...
     * @return responseData
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_RESPONSE_DATA)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public BulkSendJobGetResponseSignatureRequests addSignaturesItem(
            SignatureRequestResponseSignatures signaturesItem) {
     ...
     * @return signatures
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNATURES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_BULK_SEND_JOB_ID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        BulkSendJobGetResponseSignatureRequests bulkSendJobGetResponseSignatureRequests =
                (BulkSendJobGetResponseSignatureRequests) o;
        return Objects.equals(this.testMode, bulkSendJobGetResponseSignatureRequests.testMode)
                && Objects.equals(
                        this.signatureRequestId,
                        bulkSendJobGetResponseSignatureRequests.signatureRequestId)
                && Objects.equals(
                        this.requesterEmailAddress,
                        bulkSendJobGetResponseSignatureRequests.requesterEmailAddress)
                && Objects.equals(this.title, bulkSendJobGetResponseSignatureRequests.title)
                && Objects.equals(
                        this.originalTitle, bulkSendJobGetResponseSignatureRequests.originalTitle)
                ...
                && Objects.equals(
                        this.isComplete, bulkSendJobGetResponseSignatureRequests.isComplete)
                && Objects.equals(
                        this.isDeclined, bulkSendJobGetResponseSignatureRequests.isDeclined)
                ...
                && Objects.equals(
                        this.signingUrl, bulkSendJobGetResponseSignatureRequests.signingUrl)
                && Objects.equals(
                        this.detailsUrl, bulkSendJobGetResponseSignatureRequests.detailsUrl)
                && Objects.equals(
                        this.ccEmailAddresses,
                        bulkSendJobGetResponseSignatureRequests.ccEmailAddresses)
                && Objects.equals(
                        this.signingRedirectUrl,
                        bulkSendJobGetResponseSignatureRequests.signingRedirectUrl)
                && Objects.equals(
                        this.finalCopyUri, bulkSendJobGetResponseSignatureRequests.finalCopyUri)
                && Objects.equals(
                        this.templateIds, bulkSendJobGetResponseSignatureRequests.templateIds)
                && Objects.equals(
                        this.customFields, bulkSendJobGetResponseSignatureRequests.customFields)
                && Objects.equals(
                        this.attachments, bulkSendJobGetResponseSignatureRequests.attachments)
                && Objects.equals(
                        this.responseData, bulkSendJobGetResponseSignatureRequests.responseData)
                && Objects.equals(
    ...
    public String toString() {
        ...
        sb.append("    signatureRequestId: ")
                .append(toIndentedString(signatureRequestId))
                .append("\n");
        ...
        try {
            ...
            if (signatureRequestId != null) {
                ...
                if (signatureRequestId.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(signatureRequestId); i++) {
                        map.put(
                                "signature_request_id[" + i + "]",
                                getFromList(signatureRequestId, i));
                    }
                } else {
                    map.put(
                            "signature_request_id",
                            JSON.getDefault().getMapper().writeValueAsString(signatureRequestId));
                }
            }
            ...
            if (isComplete != null) {
                ...
                if (isComplete.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "is_complete",
                            JSON.getDefault().getMapper().writeValueAsString(isComplete));
                }
            }
            if (isDeclined != null) {
                ...
                if (isDeclined.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "is_declined",
                            JSON.getDefault().getMapper().writeValueAsString(isDeclined));
                }
            }
            if (hasError != null) {
                ...
                if (hasError.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "has_error",
                            JSON.getDefault().getMapper().writeValueAsString(hasError));
                }
            }
            if (filesUrl != null) {
            ...
            if (signingUrl != null) {
                ...
                if (signingUrl.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signing_url",
                            JSON.getDefault().getMapper().writeValueAsString(signingUrl));
                }
            }
            if (detailsUrl != null) {
                ...
                if (detailsUrl.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "details_url",
                            JSON.getDefault().getMapper().writeValueAsString(detailsUrl));
                }
            }
            ...
            if (finalCopyUri != null) {
                ...
                if (finalCopyUri.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "final_copy_uri",
                            JSON.getDefault().getMapper().writeValueAsString(finalCopyUri));
                }
            }
            if (templateIds != null) {
            ...
            if (responseData != null) {
                ...
                if (responseData.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "response_data",
                            JSON.getDefault().getMapper().writeValueAsString(responseData));
                }
            }
            if (signatures != null) {
                ...
                if (signatures.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signatures",
                            JSON.getDefault().getMapper().writeValueAsString(signatures));
                }
            }
