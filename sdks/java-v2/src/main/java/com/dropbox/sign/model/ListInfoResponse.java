...
public class ListInfoResponse {
     ...
     * @return numPages
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_PAGES)
     ...
     * @return numResults
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_RESULTS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            if (numPages != null) {
                ...
                if (numPages.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_pages",
                            JSON.getDefault().getMapper().writeValueAsString(numPages));
                }
            }
            if (numResults != null) {
                ...
                if (numResults.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_results",
                            JSON.getDefault().getMapper().writeValueAsString(numResults));
                }
            }
            if (page != null) {
            ...
            if (pageSize != null) {
                ...
                if (pageSize.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "page_size",
                            JSON.getDefault().getMapper().writeValueAsString(pageSize));
                }
            }
        } catch (Exception e) {
