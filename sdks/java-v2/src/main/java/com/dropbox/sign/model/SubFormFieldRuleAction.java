...
public class SubFormFieldRuleAction {
     ...
     * of an existing field defined within &#x60;form_fields_per_document&#x60;. Cannot use with
     * &#x60;group_id&#x60;. Trigger and action fields must belong to the same signer.
     *
     * @return fieldId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_FIELD_ID)
    ...
    /**
     * **group_id** or **field_id** is required, but not both. Must reference the ID of an existing
     * group defined within &#x60;form_field_groups&#x60;. Cannot use with &#x60;field_id&#x60;.
