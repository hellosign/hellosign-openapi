 ...
 * Document](/docs/openapi/form-fields-per-document).) **NOTE:** Fields like **text**, **dropdown**,
 * **checkbox**, **radio**, and **hyperlink** have additional required and optional parameters.
 * Check out the list of [additional parameters](/api/reference/constants/#form-fields-per-document)
 * for these field types. * Text Field use &#x60;SubFormFieldsPerDocumentText&#x60; * Dropdown Field
 * use &#x60;SubFormFieldsPerDocumentDropdown&#x60; * Hyperlink Field use
...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(
            value = SubFormFieldsPerDocumentCheckboxMerge.class,
            name = "checkbox-merge"),
...
public class SubFormFieldsPerDocumentBase {
     ...
     */
    public static SubFormFieldsPerDocumentBase init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubFormFieldsPerDocumentBase.class);
    }

    public static SubFormFieldsPerDocumentBase init(HashMap data) throws Exception {
    ...
    /**
     * Represents the integer index of the &#x60;file&#x60; or &#x60;file_url&#x60; document the
     * field should be attached to.
     *
    ...
    /**
     * Signer index identified by the offset in the signers parameter (0-based indexing), indicating
     * which signer should fill out the field. **NOTE:** To set the value of the field as the
     * preparer you must set this to &#x60;me_now&#x60; **NOTE:** If type is &#x60;text-merge&#x60;
     * or &#x60;checkbox-merge&#x60;, you must set this to sender in order to use pre-filled data.
     *
     * @return signer
     */
    @jakarta.annotation.Nonnull
     ...
     * systems](https://faq.hellosign.com/hc/en-us/articles/217115577) and how to use them.
     *
     * @return page
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_PAGE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        SubFormFieldsPerDocumentBase subFormFieldsPerDocumentBase =
                (SubFormFieldsPerDocumentBase) o;
    ...
    public int hashCode() {
        return Objects.hash(
                documentIndex, apiId, height, required, signer, type, width, x, y, name, page);
    }
        ...
        try {
            if (documentIndex != null) {
                ...
                if (documentIndex.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "document_index",
                            JSON.getDefault().getMapper().writeValueAsString(documentIndex));
                }
            }
            if (apiId != null) {
