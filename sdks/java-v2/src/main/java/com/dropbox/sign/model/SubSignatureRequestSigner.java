...
public class SubSignatureRequestSigner {
     ...
     */
    public static SubSignatureRequestSigner init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubSignatureRequestSigner.class);
    }

    public static SubSignatureRequestSigner init(HashMap data) throws Exception {
     ...
     * @return pin
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_PIN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SMS_PHONE_NUMBER_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.name, subSignatureRequestSigner.name)
                ...
                && Objects.equals(
                        this.smsPhoneNumberType, subSignatureRequestSigner.smsPhoneNumberType);
    }
