...
public class SignatureRequestSendWithTemplateRequest {
    ...
    @Deprecated private Boolean isQualifiedSignature = false;
     ...
     */
    @Deprecated
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_QUALIFIED_SIGNATURE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return isEid
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_EID)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
