...
public class TemplateResponseFieldAvgTextLength {
     ...
     */
    public static TemplateResponseFieldAvgTextLength init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponseFieldAvgTextLength.class);
    }

    public static TemplateResponseFieldAvgTextLength init(HashMap data) throws Exception {
     ...
     * @return numLines
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_LINES)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NUM_CHARS_PER_LINE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        TemplateResponseFieldAvgTextLength templateResponseFieldAvgTextLength =
                (TemplateResponseFieldAvgTextLength) o;
        return Objects.equals(this.numLines, templateResponseFieldAvgTextLength.numLines)
                && Objects.equals(
                        this.numCharsPerLine, templateResponseFieldAvgTextLength.numCharsPerLine);
    }
        ...
        try {
            if (numLines != null) {
                ...
                if (numLines.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_lines",
                            JSON.getDefault().getMapper().writeValueAsString(numLines));
                }
            }
            if (numCharsPerLine != null) {
                ...
                if (numCharsPerLine.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "num_chars_per_line",
                            JSON.getDefault().getMapper().writeValueAsString(numCharsPerLine));
                }
            }
        } catch (Exception e) {
