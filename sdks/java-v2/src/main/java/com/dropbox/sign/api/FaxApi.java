...
public class FaxApi {
   ...
   */
  public FaxDraftCreateResponse faxDraftCreate(FaxDraftCreateRequest faxDraftCreateRequest) throws ApiException {
  ...
  public ApiResponse<FaxDraftCreateResponse> faxDraftCreateWithHttpInfo(FaxDraftCreateRequest faxDraftCreateRequest) throws ApiException {
    ...
    String[] localVarAuthNames = new String[] {"api_key"};
    GenericType<FaxDraftCreateResponse> localVarReturnType = new GenericType<FaxDraftCreateResponse>() {};
    return apiClient.invokeAPI(
