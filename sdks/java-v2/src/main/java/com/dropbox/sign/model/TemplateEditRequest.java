...
public class TemplateEditRequest {
  ...
  public TemplateEditRequest title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public TemplateEditRequest subject(@jakarta.annotation.Nullable String subject) {
  ...
  public TemplateEditRequest message(@jakarta.annotation.Nullable String message) {
