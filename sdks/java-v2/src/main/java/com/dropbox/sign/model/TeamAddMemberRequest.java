...
public class TeamAddMemberRequest {
     ...
     */
    public static TeamAddMemberRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TeamAddMemberRequest.class);
    }

    public static TeamAddMemberRequest init(HashMap data) throws Exception {
    ...
    /**
     * &#x60;account_id&#x60; or &#x60;email_address&#x60; is required. If both are provided, the
     * account id prevails. Account id of the user to invite to your Team.
     *
     * @return accountId
     */
    ...
    /**
     * &#x60;account_id&#x60; or &#x60;email_address&#x60; is required, If both are provided, the
     * account id prevails. Email address of the user to invite to your Team.
     *
     * @return emailAddress
     */
