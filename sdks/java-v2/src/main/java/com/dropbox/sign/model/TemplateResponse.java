...
public class TemplateResponse {
     ...
     */
    public static TemplateResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponse.class);
    }

    public static TemplateResponse init(HashMap data) throws Exception {
     ...
     * @return templateId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_TEMPLATE_ID)
     ...
     * @return isEmbedded
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_EMBEDDED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return isCreator
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_CREATOR)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return canEdit
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_CAN_EDIT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return isLocked
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_LOCKED)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return documents
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_DOCUMENTS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public TemplateResponse addCustomFieldsItem(
            TemplateResponseDocumentCustomFieldBase customFieldsItem) {
    ...
    public TemplateResponse addNamedFormFieldsItem(
            TemplateResponseDocumentFormFieldBase namedFormFieldsItem) {
     ...
     */
    @Deprecated
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_NAMED_FORM_FIELDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return accounts
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ACCOUNTS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            ...
            if (isCreator != null) {
                ...
                if (isCreator.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "is_creator",
                            JSON.getDefault().getMapper().writeValueAsString(isCreator));
                }
            }
            if (canEdit != null) {
