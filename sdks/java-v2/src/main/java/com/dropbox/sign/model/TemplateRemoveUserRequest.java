...
public class TemplateRemoveUserRequest {
     ...
     */
    public static TemplateRemoveUserRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateRemoveUserRequest.class);
    }

    public static TemplateRemoveUserRequest init(HashMap data) throws Exception {
    ...
    /**
     * The id or email address of the Account to remove access to the Template. The account id
     * prevails if both are provided.
     *
     * @return accountId
     */
