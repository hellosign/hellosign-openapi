...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(
            value = SignatureRequestResponseDataValueCheckboxMerge.class,
            name = "checkbox-merge"),
    @JsonSubTypes.Type(
            value = SignatureRequestResponseDataValueDateSigned.class,
            name = "date_signed"),
    ...
    @JsonSubTypes.Type(
            value = SignatureRequestResponseDataValueSignature.class,
            name = "signature"),
    @JsonSubTypes.Type(value = SignatureRequestResponseDataValueText.class, name = "text"),
    @JsonSubTypes.Type(
            value = SignatureRequestResponseDataValueTextMerge.class,
            name = "text-merge"),
})
public class SignatureRequestResponseDataBase {
     ...
     */
    public static SignatureRequestResponseDataBase init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SignatureRequestResponseDataBase.class);
    }

    public static SignatureRequestResponseDataBase init(HashMap data) throws Exception {
     ...
     * @return apiId
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_API_ID)
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestResponseDataBase signatureRequestResponseDataBase =
                (SignatureRequestResponseDataBase) o;
