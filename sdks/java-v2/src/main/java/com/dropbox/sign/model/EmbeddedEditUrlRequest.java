...
public class EmbeddedEditUrlRequest {
     ...
     */
    public static EmbeddedEditUrlRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, EmbeddedEditUrlRequest.class);
    }

    public static EmbeddedEditUrlRequest init(HashMap data) throws Exception {
    ...
    /**
     * This allows the requester to enable/disable to add or change CC roles when editing the
     * template.
     *
     * @return allowEditCcs
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ALLOW_EDIT_CCS)
    ...
    /**
     * The CC roles that must be assigned when using the template to send a signature request. To
     * remove all CC roles, pass in a single role with no name. For use in a POST request.
     *
     * @return ccRoles
     */
    ...
    /**
     * Add additional merge fields to the template, which can be used used to pre-fill data by
     * passing values into signature requests made with that template. Remove all merge fields on
     * the template by passing an empty array &#x60;[]&#x60;.
     *
     * @return mergeFields
     */
     ...
     * requester&#39;s end user to add any additional fields via the editor). **NOTE:** This
     * parameter overwrites &#x60;show_preview&#x3D;true&#x60; (if set).
     *
     * @return previewOnly
     */
    ...
    /**
     * Whether this is a test, locked templates will only be available for editing if this is set to
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.allowEditCcs, embeddedEditUrlRequest.allowEditCcs)
                ...
                && Objects.equals(
                        this.forceSubjectMessage, embeddedEditUrlRequest.forceSubjectMessage)
        ...
        try {
            if (allowEditCcs != null) {
                ...
                if (allowEditCcs.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "allow_edit_ccs",
                            JSON.getDefault().getMapper().writeValueAsString(allowEditCcs));
                }
            }
            if (ccRoles != null) {
