...
public class TemplateResponseDocument {
    ...
    public TemplateResponseDocument addFieldGroupsItem(
            TemplateResponseDocumentFieldGroup fieldGroupsItem) {
     ...
     * @return fieldGroups
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_FIELD_GROUPS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public TemplateResponseDocument addFormFieldsItem(
            TemplateResponseDocumentFormFieldBase formFieldsItem) {
     ...
     * @return formFields
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_FORM_FIELDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public TemplateResponseDocument addCustomFieldsItem(
    ...
    public TemplateResponseDocument addStaticFieldsItem(
            TemplateResponseDocumentStaticFieldBase staticFieldsItem) {
     ...
     * @return staticFields
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_STATIC_FIELDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            ...
            if (fieldGroups != null) {
                ...
                if (fieldGroups.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "field_groups",
                            JSON.getDefault().getMapper().writeValueAsString(fieldGroups));
                }
            }
            if (formFields != null) {
