 ...
 */
@JsonPropertyOrder({
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_TEMPLATE_IDS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_CLIENT_ID,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_SIGNERS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_ALLOW_DECLINE,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_CCS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_CUSTOM_FIELDS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_FILES,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_FILE_URLS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_MESSAGE,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_METADATA,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_SIGNING_OPTIONS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_SUBJECT,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_TEST_MODE,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_TITLE,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_POPULATE_AUTO_FILL_FIELDS,
  SignatureRequestEditEmbeddedWithTemplateRequest.JSON_PROPERTY_SIGNER_EXPERIENCE
})
@jakarta.annotation.Generated(value = "org.openapitools.codegen.languages.JavaClientCodegen", comments = "Generator version: 7.12.0")
@JsonIgnoreProperties(ignoreUnknown=true)
public class SignatureRequestEditEmbeddedWithTemplateRequest {
   ...
   */
  static public SignatureRequestEditEmbeddedWithTemplateRequest init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, SignatureRequestEditEmbeddedWithTemplateRequest.class);
  }

  static public SignatureRequestEditEmbeddedWithTemplateRequest init(HashMap data) throws Exception {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest templateIds(@jakarta.annotation.Nonnull List<String> templateIds) {
    this.templateIds = templateIds;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addTemplateIdsItem(String templateIdsItem) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest clientId(@jakarta.annotation.Nonnull String clientId) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest signers(@jakarta.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
    this.signers = signers;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addSignersItem(SubSignatureRequestTemplateSigner signersItem) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest allowDecline(@jakarta.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest ccs(@jakarta.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addCcsItem(SubCC ccsItem) {
    if (this.ccs == null) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest customFields(@jakarta.annotation.Nullable List<SubCustomField> customFields) {
    this.customFields = customFields;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addCustomFieldsItem(SubCustomField customFieldsItem) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest files(@jakarta.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addFilesItem(File filesItem) {
    if (this.files == null) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest fileUrls(@jakarta.annotation.Nullable List<String> fileUrls) {
    this.fileUrls = fileUrls;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest addFileUrlsItem(String fileUrlsItem) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest message(@jakarta.annotation.Nullable String message) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
    this.metadata = metadata;
    return this;
  }

  public SignatureRequestEditEmbeddedWithTemplateRequest putMetadataItem(String key, Object metadataItem) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest signingOptions(@jakarta.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest subject(@jakarta.annotation.Nullable String subject) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest testMode(@jakarta.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest populateAutoFillFields(@jakarta.annotation.Nullable Boolean populateAutoFillFields) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest signerExperience(@jakarta.annotation.Nullable SubSignerExperience signerExperience) {
  ...
  /**
   * Return true if this SignatureRequestEditEmbeddedWithTemplateRequest object is equal to o.
   */
  @Override
  public boolean equals(Object o) {
    ...
    SignatureRequestEditEmbeddedWithTemplateRequest signatureRequestEditEmbeddedWithTemplateRequest = (SignatureRequestEditEmbeddedWithTemplateRequest) o;
    return Objects.equals(this.templateIds, signatureRequestEditEmbeddedWithTemplateRequest.templateIds) &&
        Objects.equals(this.clientId, signatureRequestEditEmbeddedWithTemplateRequest.clientId) &&
        Objects.equals(this.signers, signatureRequestEditEmbeddedWithTemplateRequest.signers) &&
        Objects.equals(this.allowDecline, signatureRequestEditEmbeddedWithTemplateRequest.allowDecline) &&
        Objects.equals(this.ccs, signatureRequestEditEmbeddedWithTemplateRequest.ccs) &&
        Objects.equals(this.customFields, signatureRequestEditEmbeddedWithTemplateRequest.customFields) &&
        Objects.equals(this.files, signatureRequestEditEmbeddedWithTemplateRequest.files) &&
        Objects.equals(this.fileUrls, signatureRequestEditEmbeddedWithTemplateRequest.fileUrls) &&
        Objects.equals(this.message, signatureRequestEditEmbeddedWithTemplateRequest.message) &&
        Objects.equals(this.metadata, signatureRequestEditEmbeddedWithTemplateRequest.metadata) &&
        Objects.equals(this.signingOptions, signatureRequestEditEmbeddedWithTemplateRequest.signingOptions) &&
        Objects.equals(this.subject, signatureRequestEditEmbeddedWithTemplateRequest.subject) &&
        Objects.equals(this.testMode, signatureRequestEditEmbeddedWithTemplateRequest.testMode) &&
        Objects.equals(this.title, signatureRequestEditEmbeddedWithTemplateRequest.title) &&
        Objects.equals(this.populateAutoFillFields, signatureRequestEditEmbeddedWithTemplateRequest.populateAutoFillFields) &&
        Objects.equals(this.signerExperience, signatureRequestEditEmbeddedWithTemplateRequest.signerExperience);
  }
