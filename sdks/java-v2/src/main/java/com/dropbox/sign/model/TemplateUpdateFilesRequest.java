...
public class TemplateUpdateFilesRequest {
    ...
    /**
     * Use &#x60;files[]&#x60; to indicate the uploaded file(s) to use for the template. This
     * endpoint requires either **files** or **file_urls[]**, but not both.
     *
     * @return files
     */
    ...
    /**
     * Use &#x60;file_urls[]&#x60; to have Dropbox Sign download the file(s) to use for the
     * template. This endpoint requires either **files** or **file_urls[]**, but not both.
     *
     * @return fileUrls
     */
