...
public class ApiAppResponseOAuth {
     ...
     * @return secret
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SECRET)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return scopes
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SCOPES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return chargesUsers
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_CHARGES_USERS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
