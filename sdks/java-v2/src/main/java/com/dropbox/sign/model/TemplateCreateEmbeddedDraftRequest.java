...
public class TemplateCreateEmbeddedDraftRequest {
     ...
     */
    public static TemplateCreateEmbeddedDraftRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateCreateEmbeddedDraftRequest.class);
    }

    public static TemplateCreateEmbeddedDraftRequest init(HashMap data) throws Exception {
    ...
    /**
     * Client id of the app you&#39;re using to create this draft. Used to apply the branding and
     ...
     * to CC when creating a template.
     *
     * @return allowCcs
     */
     ...
     * @return ccRoles
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_CC_ROLES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public TemplateCreateEmbeddedDraftRequest addFormFieldGroupsItem(
    ...
    public TemplateCreateEmbeddedDraftRequest addFormFieldRulesItem(
    ...
    public TemplateCreateEmbeddedDraftRequest addFormFieldsPerDocumentItem(
     ...
     * and used to pre-fill data by passing values into signature requests with the
     * &#x60;custom_fields&#x60; parameter. If the signature request using that template *does not*
     * pass a value into a merge field, then an empty field remains in the document.
     *
     * @return mergeFields
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_MERGE_FIELDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return signerRoles
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_ROLES)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        TemplateCreateEmbeddedDraftRequest templateCreateEmbeddedDraftRequest =
                (TemplateCreateEmbeddedDraftRequest) o;
        return Objects.equals(this.clientId, templateCreateEmbeddedDraftRequest.clientId)
                ...
                && Objects.equals(
                        this.editorOptions, templateCreateEmbeddedDraftRequest.editorOptions)
                && Objects.equals(
                        this.fieldOptions, templateCreateEmbeddedDraftRequest.fieldOptions)
                && Objects.equals(
                        this.forceSignerRoles, templateCreateEmbeddedDraftRequest.forceSignerRoles)
                && Objects.equals(
                        this.forceSubjectMessage,
                        templateCreateEmbeddedDraftRequest.forceSubjectMessage)
                && Objects.equals(
                        this.formFieldGroups, templateCreateEmbeddedDraftRequest.formFieldGroups)
                && Objects.equals(
                        this.formFieldRules, templateCreateEmbeddedDraftRequest.formFieldRules)
                && Objects.equals(
                        this.formFieldsPerDocument,
                        templateCreateEmbeddedDraftRequest.formFieldsPerDocument)
                ...
                && Objects.equals(
                        ...
                        templateCreateEmbeddedDraftRequest.showProgressStepper)
        ...
        try {
            ...
            if (mergeFields != null) {
                ...
                if (mergeFields.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "merge_fields",
                            JSON.getDefault().getMapper().writeValueAsString(mergeFields));
                }
            }
            if (message != null) {
