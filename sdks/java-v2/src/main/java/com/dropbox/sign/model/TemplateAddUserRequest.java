...
public class TemplateAddUserRequest {
     ...
     */
    public static TemplateAddUserRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateAddUserRequest.class);
    }

    public static TemplateAddUserRequest init(HashMap data) throws Exception {
    ...
    /**
     * The id of the Account to give access to the Template. **NOTE:** The account id prevails if
     * email address is also provided.
     *
     * @return accountId
     */
    ...
    /**
     * The email address of the Account to give access to the Template. **NOTE:** The account id
     * prevails if it is also provided.
     *
     * @return emailAddress
     */
    ...
    /**
     * If set to &#x60;true&#x60;, the user does not receive an email notification when a template
     * has been shared with them. Defaults to &#x60;false&#x60;.
     *
     * @return skipNotification
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_SKIP_NOTIFICATION)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            ...
            if (skipNotification != null) {
                ...
                if (skipNotification.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "skip_notification",
                            JSON.getDefault().getMapper().writeValueAsString(skipNotification));
                }
            }
        } catch (Exception e) {
