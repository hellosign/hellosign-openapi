...
public class TemplateResponseDocumentFieldGroupRule {
     ...
     */
    public static TemplateResponseDocumentFieldGroupRule init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFieldGroupRule.class);
    }

    public static TemplateResponseDocumentFieldGroupRule init(HashMap data) throws Exception {
     ...
     * @return requirement
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REQUIREMENT)
     ...
     * @return groupLabel
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_GROUP_LABEL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        TemplateResponseDocumentFieldGroupRule templateResponseDocumentFieldGroupRule =
                (TemplateResponseDocumentFieldGroupRule) o;
        return Objects.equals(this.requirement, templateResponseDocumentFieldGroupRule.requirement)
                && Objects.equals(
                        this.groupLabel, templateResponseDocumentFieldGroupRule.groupLabel);
    }
        ...
        try {
            if (requirement != null) {
                ...
                if (requirement.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "requirement",
                            JSON.getDefault().getMapper().writeValueAsString(requirement));
                }
            }
            if (groupLabel != null) {
                ...
                if (groupLabel.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "groupLabel",
                            JSON.getDefault().getMapper().writeValueAsString(groupLabel));
                }
            }
        } catch (Exception e) {
