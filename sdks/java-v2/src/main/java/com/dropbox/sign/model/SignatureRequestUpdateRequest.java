...
public class SignatureRequestUpdateRequest {
     ...
     */
    public static SignatureRequestUpdateRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SignatureRequestUpdateRequest.class);
    }

    public static SignatureRequestUpdateRequest init(HashMap data) throws Exception {
    ...
    /**
     * The new email address for the recipient. This will generate a new &#x60;signature_id&#x60;
     * value. **NOTE:** Optional if &#x60;name&#x60; is provided.
     *
     * @return emailAddress
     */
    ...
    /**
     * The new time when the signature request will expire. Unsigned signatures will be moved to the
     * expired status, and no longer signable. See [Signature Request Expiration
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestUpdateRequest signatureRequestUpdateRequest =
                (SignatureRequestUpdateRequest) o;
