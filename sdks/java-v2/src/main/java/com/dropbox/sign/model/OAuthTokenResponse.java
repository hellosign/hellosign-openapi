...
public class OAuthTokenResponse {
     ...
     * @return accessToken
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_ACCESS_TOKEN)
     ...
     * @return tokenType
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_TOKEN_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return refreshToken
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_REFRESH_TOKEN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     * @return expiresIn
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_EXPIRES_IN)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            if (accessToken != null) {
                ...
                if (accessToken.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "access_token",
                            JSON.getDefault().getMapper().writeValueAsString(accessToken));
                }
            }
            if (tokenType != null) {
                ...
                if (tokenType.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "token_type",
                            JSON.getDefault().getMapper().writeValueAsString(tokenType));
                }
            }
            ...
            if (expiresIn != null) {
                ...
                if (expiresIn.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "expires_in",
                            JSON.getDefault().getMapper().writeValueAsString(expiresIn));
                }
            }
            if (state != null) {
