...
public class FaxResponseFaxTransmission {
   ...
   */
  static public FaxResponseFaxTransmission init(String jsonData) throws Exception {
    return new ObjectMapper().readValue(jsonData, FaxResponseFaxTransmission.class);
  }

  static public FaxResponseFaxTransmission init(HashMap data) throws Exception {
