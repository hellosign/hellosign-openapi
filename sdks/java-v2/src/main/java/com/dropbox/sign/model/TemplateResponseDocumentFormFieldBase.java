...
@JsonSubTypes({
    ...
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentFormFieldDateSigned.class,
            name = "date_signed"),
    @JsonSubTypes.Type(value = TemplateResponseDocumentFormFieldDropdown.class, name = "dropdown"),
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentFormFieldHyperlink.class,
            name = "hyperlink"),
    ...
    @JsonSubTypes.Type(
            value = TemplateResponseDocumentFormFieldSignature.class,
            name = "signature"),
...
public class TemplateResponseDocumentFormFieldBase {
     ...
     */
    public static TemplateResponseDocumentFormFieldBase init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFormFieldBase.class);
    }

    public static TemplateResponseDocumentFormFieldBase init(HashMap data) throws Exception {
