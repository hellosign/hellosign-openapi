...
public class SubWhiteLabelingOptions {
     ...
     */
    public static SubWhiteLabelingOptions init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubWhiteLabelingOptions.class);
    }

    public static SubWhiteLabelingOptions init(HashMap data) throws Exception {
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_RESET_TO_DEFAULT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(
                        this.headerBackgroundColor, subWhiteLabelingOptions.headerBackgroundColor)
                ...
                && Objects.equals(
                        this.pageBackgroundColor, subWhiteLabelingOptions.pageBackgroundColor)
                && Objects.equals(
                        this.primaryButtonColor, subWhiteLabelingOptions.primaryButtonColor)
                && Objects.equals(
                        this.primaryButtonColorHover,
                        subWhiteLabelingOptions.primaryButtonColorHover)
                && Objects.equals(
                        this.primaryButtonTextColor, subWhiteLabelingOptions.primaryButtonTextColor)
                && Objects.equals(
                        this.primaryButtonTextColorHover,
                        subWhiteLabelingOptions.primaryButtonTextColorHover)
                && Objects.equals(
                        this.secondaryButtonColor, subWhiteLabelingOptions.secondaryButtonColor)
                && Objects.equals(
                        this.secondaryButtonColorHover,
                        subWhiteLabelingOptions.secondaryButtonColorHover)
                && Objects.equals(
                        this.secondaryButtonTextColor,
                        subWhiteLabelingOptions.secondaryButtonTextColor)
                && Objects.equals(
                        this.secondaryButtonTextColorHover,
                        subWhiteLabelingOptions.secondaryButtonTextColorHover)
        ...
        try {
            ...
            if (resetToDefault != null) {
                ...
                if (resetToDefault.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "reset_to_default",
                            JSON.getDefault().getMapper().writeValueAsString(resetToDefault));
                }
            }
        } catch (Exception e) {
