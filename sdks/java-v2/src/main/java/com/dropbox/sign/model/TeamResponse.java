...
public class TeamResponse {
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_INVITED_ACCOUNTS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
     ...
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_INVITED_EMAILS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
        ...
        try {
            ...
            if (invitedAccounts != null) {
                ...
                if (invitedAccounts.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "invited_accounts",
                            JSON.getDefault().getMapper().writeValueAsString(invitedAccounts));
                }
            }
            if (invitedEmails != null) {
                ...
                if (invitedEmails.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "invited_emails",
                            JSON.getDefault().getMapper().writeValueAsString(invitedEmails));
                }
            }
        } catch (Exception e) {
