...
public class SignatureRequestBulkSendWithTemplateRequest {
  ...
  public SignatureRequestBulkSendWithTemplateRequest templateIds(@jakarta.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest signerFile(@jakarta.annotation.Nullable File signerFile) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest signerList(@jakarta.annotation.Nullable List<SubBulkSignerList> signerList) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest allowDecline(@jakarta.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest ccs(@jakarta.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestBulkSendWithTemplateRequest clientId(@jakarta.annotation.Nullable String clientId) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest customFields(@jakarta.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest message(@jakarta.annotation.Nullable String message) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest metadata(@jakarta.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest subject(@jakarta.annotation.Nullable String subject) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest testMode(@jakarta.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest title(@jakarta.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
