...
public class AccountCreateResponse {
     ...
     */
    public static AccountCreateResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, AccountCreateResponse.class);
    }

    public static AccountCreateResponse init(HashMap data) throws Exception {
     ...
     * @return oauthData
     */
    @jakarta.annotation.Nullable @JsonProperty(JSON_PROPERTY_OAUTH_DATA)
        ...
        try {
            ...
            if (oauthData != null) {
                ...
                if (oauthData.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "oauth_data",
                            JSON.getDefault().getMapper().writeValueAsString(oauthData));
                }
            }
            if (warnings != null) {
