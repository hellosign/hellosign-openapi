...
| *TemplateApi* | [**templateEdit**](./docs/api/TemplateApi.md#templateedit) | **POST** /template/edit/{template_id} | _t__TemplateEdit::SUMMARY |
...
- [TemplateEditResponseTemplate](./docs/model/TemplateEditResponseTemplate.md)
