...
class BulkSendJobListResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    protected static $openAPITypes = [
        'bulk_send_jobs' => '\Dropbox\Sign\Model\BulkSendJobResponse[]',
    ...
    {
        $this->setIfExists('bulk_send_jobs', $data ?? [], null);
    ...
    public static function init(array $data): BulkSendJobListResponse
    {
        /** @var BulkSendJobListResponse */
...
* @param string|int|object|array|mixed  $defaultValue
    */
     ...
     * Sets bulk_send_jobs
     *
     * @param \Dropbox\Sign\Model\BulkSendJobResponse[] $bulk_send_jobs Contains a list of BulkSendJobs that the API caller has access to.
     *
     * @return self
     */
    public function setBulkSendJobs($bulk_send_jobs)
    {
