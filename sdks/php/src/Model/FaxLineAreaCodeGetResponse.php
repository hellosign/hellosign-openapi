...
/**
 * FaxLineAreaCodeGetResponse Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
...
class FaxLineAreaCodeGetResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FaxLineAreaCodeGetResponse';
    ...
    {
        $this->container['area_codes'] = $data['area_codes'] ?? null;
    }

    /** @deprecated use ::init() */
    public static function fromArray(array $data): FaxLineAreaCodeGetResponse
    {
        return self::init($data);
    }

    /** Attempt to instantiate and hydrate a new instance of this class */
    public static function init(array $data): FaxLineAreaCodeGetResponse
    {
        /** @var FaxLineAreaCodeGetResponse $obj */
