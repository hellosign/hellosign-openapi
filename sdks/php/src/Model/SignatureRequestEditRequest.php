...
/**
 * SignatureRequestEditRequest Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
...
class SignatureRequestEditRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'SignatureRequestEditRequest';
    ...
    /** @deprecated use ::init() */
    public static function fromArray(array $data): SignatureRequestEditRequest
    {
        return self::init($data);
    }

    /** Attempt to instantiate and hydrate a new instance of this class */
    public static function init(array $data): SignatureRequestEditRequest
    {
        /** @var SignatureRequestEditRequest $obj */
    ...
    public function setMessage(?string $message)
    {
        if (!is_null($message) && (mb_strlen($message) > 5000)) {
            throw new InvalidArgumentException('invalid length for $message when calling SignatureRequestEditRequest., must be smaller than or equal to 5000.');
        }
    ...
    public function setSubject(?string $subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 255)) {
            throw new InvalidArgumentException('invalid length for $subject when calling SignatureRequestEditRequest., must be smaller than or equal to 255.');
        }
    ...
    public function setTitle(?string $title)
    {
        if (!is_null($title) && (mb_strlen($title) > 255)) {
            throw new InvalidArgumentException('invalid length for $title when calling SignatureRequestEditRequest., must be smaller than or equal to 255.');
        }
