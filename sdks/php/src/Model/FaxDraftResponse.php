 ...
 */
class FaxDraftResponse implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FaxDraftResponse';
     ...
     * @deprecated use ::init()
     */
    public static function fromArray(array $data): FaxDraftResponse
    {
     ...
     */
    public static function init(array $data): FaxDraftResponse
    {
        /** @var FaxDraftResponse */
     ...
     * Sets fax_id
     *
     * @param string $fax_id ID of the Fax draft
     *
     * @return self
     */
