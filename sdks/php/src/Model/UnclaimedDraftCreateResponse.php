...
class UnclaimedDraftCreateResponse implements ModelInterface, ArrayAccess, \JsonSerializable
{
    ...
    {
        $this->setIfExists('unclaimed_draft', $data ?? [], null);
...
* @param string|int|object|array|mixed  $defaultValue
    */
     ...
     *
     * @return \Dropbox\Sign\Model\UnclaimedDraftResponse
     */
     ...
     *
     * @param \Dropbox\Sign\Model\UnclaimedDraftResponse $unclaimed_draft unclaimed_draft
     *
     * @return self
     */
