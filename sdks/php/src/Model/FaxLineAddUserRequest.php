...
/**
 * FaxLineAddUserRequest Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
...
class FaxLineAddUserRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FaxLineAddUserRequest';
    ...
    /** @deprecated use ::init() */
    public static function fromArray(array $data): FaxLineAddUserRequest
    {
        return self::init($data);
    }

    /** Attempt to instantiate and hydrate a new instance of this class */
    public static function init(array $data): FaxLineAddUserRequest
    {
        /** @var FaxLineAddUserRequest $obj */
