...
/**
 * FaxLineRemoveUserRequest Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
...
class FaxLineRemoveUserRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'FaxLineRemoveUserRequest';
    ...
    /** @deprecated use ::init() */
    public static function fromArray(array $data): FaxLineRemoveUserRequest
    {
        return self::init($data);
    }

    /** Attempt to instantiate and hydrate a new instance of this class */
    public static function init(array $data): FaxLineRemoveUserRequest
    {
        /** @var FaxLineRemoveUserRequest $obj */
