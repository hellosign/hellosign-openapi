...
/**
 * TemplateCreateEmbeddedRequest Class Doc Comment
 *
 * @category Class
 * @author   OpenAPI Generator team
 * @see     https://openapi-generator.tech
 ...
 */
class TemplateCreateEmbeddedRequest implements ModelInterface, ArrayAccess, JsonSerializable
{
     ...
     * @var string
     */
    protected static $openAPIModelName = 'TemplateCreateEmbeddedRequest';
    ...
    /** @deprecated use ::init() */
    public static function fromArray(array $data): TemplateCreateEmbeddedRequest
    {
        return self::init($data);
    }

    /** Attempt to instantiate and hydrate a new instance of this class */
    public static function init(array $data): TemplateCreateEmbeddedRequest
    {
        /** @var TemplateCreateEmbeddedRequest $obj */
    ...
    public function setMessage(?string $message)
    {
        if (!is_null($message) && (mb_strlen($message) > 5000)) {
            throw new InvalidArgumentException('invalid length for $message when calling TemplateCreateEmbeddedRequest., must be smaller than or equal to 5000.');
        }
    ...
    public function setSubject(?string $subject)
    {
        if (!is_null($subject) && (mb_strlen($subject) > 200)) {
            throw new InvalidArgumentException('invalid length for $subject when calling TemplateCreateEmbeddedRequest., must be smaller than or equal to 200.');
        }
