    ...
    */
    ...
    public function setCallbackUrl($callback_url)
    {
        if (is_null($callback_url)) {
            ...
            $index = array_search('callback_url', $nullablesSetToNull, true);
            if ($index !== false) {
    ...
    public function setOauth($oauth)
    {
        if (is_null($oauth)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('oauth', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
    ...
    public function setWhiteLabelingOptions($white_labeling_options)
    {
        if (is_null($white_labeling_options)) {
            ...
            $nullablesSetToNull = $this->getOpenAPINullablesSetToNull();
            $index = array_search('white_labeling_options', $nullablesSetToNull, true);
            if ($index !== false) {
                unset($nullablesSetToNull[$index]);
                $this->setOpenAPINullablesSetToNull($nullablesSetToNull);
            }
