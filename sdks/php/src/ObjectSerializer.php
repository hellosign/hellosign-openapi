...
use Dropbox\Sign\Model\ModelInterface;
use GuzzleHttp;
...
class ObjectSerializer
{
    ...
    public static function sanitizeForSerialization($data, $type = null, $format = null)
    {
        ...
        if (is_object($data)) {
            ...
            } else if ($data instanceof \SplFileObject) {
                return (string) $data;
            } else {
                foreach($data as $property => $value) {
    ...
    public static function deserialize($data, $class, $httpHeaders = null)
    {
        ...
        if (method_exists($class, 'getAllowableEnumValues')) {
            ...
            if (!empty($discriminator) && isset($data->{$discriminator}) && is_string($data->{$discriminator})) {
                $subclass = '\Dropbox\Sign\Model\\' . $data->{$discriminator};
    ...
    */
     ...
     */
    public static function getFormParams(ModelInterface $model): array
    {
            ...
            if (strpos($apiTypes[$key], 'SplFileObject') !== false) {
                ...
                if (strpos($apiTypes[$key], 'SplFileObject[]') !== false) {
                    ...
                    foreach ($value as $file) {
                        ...
                        $formParams[$true_key] = Utils::tryFopen(
