...
class SignatureRequestApi
{
     ...
     * @return array of Model\SignatureRequestGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function signatureRequestEditWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditRequest $signature_request_edit_request)
    {
        $request = $this->signatureRequestEditRequest($signature_request_id, $signature_request_edit_request);
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditAsync(string $signature_request_id, Model\SignatureRequestEditRequest $signature_request_edit_request)
    {
        return $this->signatureRequestEditAsyncWithHttpInfo($signature_request_id, $signature_request_edit_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditAsyncWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditRequest $signature_request_edit_request)
    {
        $returnType = '\Dropbox\Sign\Model\SignatureRequestGetResponse';
        $request = $this->signatureRequestEditRequest($signature_request_id, $signature_request_edit_request);
     ...
     * @return Psr7\Request
     */
    public function signatureRequestEditRequest(string $signature_request_id, Model\SignatureRequestEditRequest $signature_request_edit_request)
    {
        // verify the required parameter 'signature_request_id' is set
        if ($signature_request_id === null || (is_array($signature_request_id) && count($signature_request_id) === 0)) {
            throw new InvalidArgumentException(
        ...
        if (count($formParams) === 0) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($signature_request_edit_request));
            } else {
     ...
     * @return array of Model\SignatureRequestGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function signatureRequestEditEmbeddedWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditEmbeddedRequest $signature_request_edit_embedded_request)
    {
        $request = $this->signatureRequestEditEmbeddedRequest($signature_request_id, $signature_request_edit_embedded_request);
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditEmbeddedAsync(string $signature_request_id, Model\SignatureRequestEditEmbeddedRequest $signature_request_edit_embedded_request)
    {
        return $this->signatureRequestEditEmbeddedAsyncWithHttpInfo($signature_request_id, $signature_request_edit_embedded_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditEmbeddedAsyncWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditEmbeddedRequest $signature_request_edit_embedded_request)
    {
        $returnType = '\Dropbox\Sign\Model\SignatureRequestGetResponse';
        $request = $this->signatureRequestEditEmbeddedRequest($signature_request_id, $signature_request_edit_embedded_request);
     ...
     * @return Psr7\Request
     */
    public function signatureRequestEditEmbeddedRequest(string $signature_request_id, Model\SignatureRequestEditEmbeddedRequest $signature_request_edit_embedded_request)
    {
        // verify the required parameter 'signature_request_id' is set
        if ($signature_request_id === null || (is_array($signature_request_id) && count($signature_request_id) === 0)) {
            throw new InvalidArgumentException(
        ...
        if (count($formParams) === 0) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($signature_request_edit_embedded_request));
            } else {
     ...
     * @return array of Model\SignatureRequestGetResponse, HTTP status code, HTTP response headers (array of strings)
     */
    public function signatureRequestEditEmbeddedWithTemplateWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditEmbeddedWithTemplateRequest $signature_request_edit_embedded_with_template_request)
    {
        $request = $this->signatureRequestEditEmbeddedWithTemplateRequest($signature_request_id, $signature_request_edit_embedded_with_template_request);
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditEmbeddedWithTemplateAsync(string $signature_request_id, Model\SignatureRequestEditEmbeddedWithTemplateRequest $signature_request_edit_embedded_with_template_request)
    {
        return $this->signatureRequestEditEmbeddedWithTemplateAsyncWithHttpInfo($signature_request_id, $signature_request_edit_embedded_with_template_request)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return Promise\PromiseInterface
     */
    public function signatureRequestEditEmbeddedWithTemplateAsyncWithHttpInfo(string $signature_request_id, Model\SignatureRequestEditEmbeddedWithTemplateRequest $signature_request_edit_embedded_with_template_request)
    {
        $returnType = '\Dropbox\Sign\Model\SignatureRequestGetResponse';
        $request = $this->signatureRequestEditEmbeddedWithTemplateRequest($signature_request_id, $signature_request_edit_embedded_with_template_request);
     ...
     * @return Psr7\Request
     */
    public function signatureRequestEditEmbeddedWithTemplateRequest(string $signature_request_id, Model\SignatureRequestEditEmbeddedWithTemplateRequest $signature_request_edit_embedded_with_template_request)
    {
        // verify the required parameter 'signature_request_id' is set
        if ($signature_request_id === null || (is_array($signature_request_id) && count($signature_request_id) === 0)) {
            throw new InvalidArgumentException(
        ...
        if (count($formParams) === 0) {
            if ($headers['Content-Type'] === 'application/json') {
                $httpBody = Utils::jsonEncode(ObjectSerializer::sanitizeForSerialization($signature_request_edit_embedded_with_template_request));
            } else {
