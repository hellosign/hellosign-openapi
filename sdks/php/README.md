...
| *TemplateApi* | [**templateCreateEmbedded**](docs/Api/TemplateApi.md#templatecreateembedded) | **POST** /template/create_embedded | Create Embedded Template |
