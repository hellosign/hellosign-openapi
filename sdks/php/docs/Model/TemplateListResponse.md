...
------------ | ------------- | ------------- | -------------
| `templates`<sup>*_required_</sup> | [```\Dropbox\Sign\Model\TemplateResponse[]```](TemplateResponse.md) | REPLACE_ME_WITH_DESCRIPTION_BEGIN List of templates that the API caller has access to. REPLACE_ME_WITH_DESCRIPTION_END |  |
