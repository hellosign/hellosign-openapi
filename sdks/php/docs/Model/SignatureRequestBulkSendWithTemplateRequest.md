...
| `signer_list` | [```\Dropbox\Sign\Model\SubBulkSignerList[]```](SubBulkSignerList.md) |  `signer_list` is an array defining values and options for signer fields. Required unless a `signer_file` is used, you may not use both.  |  |
