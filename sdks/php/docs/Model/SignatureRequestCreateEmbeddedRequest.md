...
| `signers` | [```\Dropbox\Sign\Model\SubSignatureRequestSigner[]```](SubSignatureRequestSigner.md) |  _t__Sub::SignatureRequestSigner::DESCRIPTION  |  |
| `grouped_signers` | [```\Dropbox\Sign\Model\SubSignatureRequestGroupedSigners[]```](SubSignatureRequestGroupedSigners.md) |  _t__Sub::SignatureRequestGroupedSigners::DESCRIPTION  |  |
...
| `attachments` | [```\Dropbox\Sign\Model\SubAttachment[]```](SubAttachment.md) |  _t__SubAttachment::LIST_DESCRIPTION  |  |
