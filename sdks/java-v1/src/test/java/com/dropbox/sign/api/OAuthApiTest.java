...
public class OAuthApiTest {
    ...
    public void oauthTokenGenerateTest() throws Exception {
        JsonNode expectedResponseData =
                TestHelper.getJsonContents(OAuthTokenResponse.class.getSimpleName());
        OAuthTokenResponse expectedResponse =
                OAuthTokenResponse.init(expectedResponseData.toString());
        ApiClient apiClient = TestHelper.setUpMock(200, expectedResponse);

        JsonNode requestData =
                TestHelper.getJsonContents(OAuthTokenGenerateRequest.class.getSimpleName());
    ...
    public void oauthTokenRefreshTest() throws Exception {
        ...
        JsonNode requestData =
                TestHelper.getJsonContents(OAuthTokenRefreshRequest.class.getSimpleName());
