...
public class BulkSendJobSendResponse {
  ...
  public BulkSendJobSendResponse bulkSendJob(@javax.annotation.Nonnull BulkSendJobResponse bulkSendJob) {
  ...
  public BulkSendJobSendResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
