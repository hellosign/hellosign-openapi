...
public class ApiAppApi {
    ...
    public ApiResponse<Void> apiAppDeleteWithHttpInfo(String clientId) throws ApiException {
        ...
        if (clientId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'clientId' when calling apiAppDelete");
        }
     ...
     * </table>
     */
    public ApiResponse<ApiAppGetResponse> apiAppGetWithHttpInfo(String clientId)
            throws ApiException {

        // Check required parameters
        if (clientId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'clientId' when calling apiAppGet");
        }
     ...
     * @see ApiAppApi#apiAppListWithHttpInfo(Integer, Integer)
     */
    public ApiResponse<ApiAppListResponse> apiAppListWithHttpInfo(Integer page)
            throws ApiException {
        Integer pageSize = 20;
     ...
     * </table>
     */
    public ApiResponse<ApiAppListResponse> apiAppListWithHttpInfo(Integer page, Integer pageSize)
            throws ApiException {
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<ApiAppListResponse> localVarReturnType =
                new GenericType<ApiAppListResponse>() {};
        return apiClient.invokeAPI(
    ...
    public ApiResponse<ApiAppGetResponse> apiAppUpdateWithHttpInfo(
        ...
        if (clientId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'clientId' when calling apiAppUpdate");
        }
        if (apiAppUpdateRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'apiAppUpdateRequest' when calling"
                            + " apiAppUpdate");
        }
