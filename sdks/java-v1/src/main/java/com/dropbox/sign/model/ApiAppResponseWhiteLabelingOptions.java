...
public class ApiAppResponseWhiteLabelingOptions {
    ...
    @javax.annotation.Nullable private String headerBackgroundColor;

    public static final String JSON_PROPERTY_LEGAL_VERSION = "legal_version";
    @javax.annotation.Nullable private String legalVersion;

    public static final String JSON_PROPERTY_LINK_COLOR = "link_color";
    @javax.annotation.Nullable private String linkColor;
    ...
    @javax.annotation.Nullable private String primaryButtonColor;
     ...
     */
    public static ApiAppResponseWhiteLabelingOptions init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, ApiAppResponseWhiteLabelingOptions.class);
    }

    public static ApiAppResponseWhiteLabelingOptions init(HashMap data) throws Exception {
    ...
    public ApiAppResponseWhiteLabelingOptions headerBackgroundColor(
    ...
    public ApiAppResponseWhiteLabelingOptions legalVersion(
            @javax.annotation.Nullable String legalVersion) {
    ...
    public ApiAppResponseWhiteLabelingOptions linkColor(
            @javax.annotation.Nullable String linkColor) {
    ...
    public ApiAppResponseWhiteLabelingOptions pageBackgroundColor(
    ...
    public ApiAppResponseWhiteLabelingOptions primaryButtonColor(
    ...
    public ApiAppResponseWhiteLabelingOptions primaryButtonColorHover(
    ...
    public ApiAppResponseWhiteLabelingOptions primaryButtonTextColor(
    ...
    public ApiAppResponseWhiteLabelingOptions secondaryButtonColor(
    ...
    public ApiAppResponseWhiteLabelingOptions secondaryButtonColorHover(
    ...
    public ApiAppResponseWhiteLabelingOptions secondaryButtonTextColor(
    ...
    public ApiAppResponseWhiteLabelingOptions secondaryButtonTextColorHover(
    ...
    public ApiAppResponseWhiteLabelingOptions textColor1(
            @javax.annotation.Nullable String textColor1) {
    ...
    public ApiAppResponseWhiteLabelingOptions textColor2(
            @javax.annotation.Nullable String textColor2) {
    ...
    public boolean equals(Object o) {
        ...
        ApiAppResponseWhiteLabelingOptions apiAppResponseWhiteLabelingOptions =
                (ApiAppResponseWhiteLabelingOptions) o;
        return Objects.equals(
                        this.headerBackgroundColor,
                        apiAppResponseWhiteLabelingOptions.headerBackgroundColor)
                && Objects.equals(
                        this.legalVersion, apiAppResponseWhiteLabelingOptions.legalVersion)
                && Objects.equals(this.linkColor, apiAppResponseWhiteLabelingOptions.linkColor)
                && Objects.equals(
                        this.pageBackgroundColor,
                        apiAppResponseWhiteLabelingOptions.pageBackgroundColor)
                && Objects.equals(
                        this.primaryButtonColor,
                        apiAppResponseWhiteLabelingOptions.primaryButtonColor)
                && Objects.equals(
                        this.primaryButtonColorHover,
                        apiAppResponseWhiteLabelingOptions.primaryButtonColorHover)
                && Objects.equals(
                        this.primaryButtonTextColor,
                        apiAppResponseWhiteLabelingOptions.primaryButtonTextColor)
                && Objects.equals(
                        this.primaryButtonTextColorHover,
                        apiAppResponseWhiteLabelingOptions.primaryButtonTextColorHover)
                && Objects.equals(
                        this.secondaryButtonColor,
                        apiAppResponseWhiteLabelingOptions.secondaryButtonColor)
                && Objects.equals(
                        this.secondaryButtonColorHover,
                        apiAppResponseWhiteLabelingOptions.secondaryButtonColorHover)
                && Objects.equals(
                        this.secondaryButtonTextColor,
                        apiAppResponseWhiteLabelingOptions.secondaryButtonTextColor)
                && Objects.equals(
                        this.secondaryButtonTextColorHover,
                        apiAppResponseWhiteLabelingOptions.secondaryButtonTextColorHover)
    ...
    public String toString() {
        ...
        sb.append("    headerBackgroundColor: ")
                .append(toIndentedString(headerBackgroundColor))
                .append("\n");
        ...
        sb.append("    pageBackgroundColor: ")
                .append(toIndentedString(pageBackgroundColor))
                .append("\n");
        sb.append("    primaryButtonColor: ")
                .append(toIndentedString(primaryButtonColor))
                .append("\n");
        sb.append("    primaryButtonColorHover: ")
                .append(toIndentedString(primaryButtonColorHover))
                .append("\n");
        sb.append("    primaryButtonTextColor: ")
                .append(toIndentedString(primaryButtonTextColor))
                .append("\n");
        sb.append("    primaryButtonTextColorHover: ")
                .append(toIndentedString(primaryButtonTextColorHover))
                .append("\n");
        sb.append("    secondaryButtonColor: ")
                .append(toIndentedString(secondaryButtonColor))
                .append("\n");
        sb.append("    secondaryButtonColorHover: ")
                .append(toIndentedString(secondaryButtonColorHover))
                .append("\n");
        sb.append("    secondaryButtonTextColor: ")
                .append(toIndentedString(secondaryButtonTextColor))
                .append("\n");
        sb.append("    secondaryButtonTextColorHover: ")
                .append(toIndentedString(secondaryButtonTextColorHover))
                .append("\n");
        ...
        try {
            if (headerBackgroundColor != null) {
                ...
                if (headerBackgroundColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(headerBackgroundColor); i++) {
                        map.put(
                                "header_background_color[" + i + "]",
                                getFromList(headerBackgroundColor, i));
                    }
                } else {
                    map.put(
                            ...
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(headerBackgroundColor));
                }
            }
            if (legalVersion != null) {
                ...
                if (legalVersion.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "legal_version",
                            JSON.getDefault().getMapper().writeValueAsString(legalVersion));
                }
            }
            if (linkColor != null) {
                ...
                if (linkColor.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "link_color",
                            JSON.getDefault().getMapper().writeValueAsString(linkColor));
                }
            }
            if (pageBackgroundColor != null) {
                ...
                if (pageBackgroundColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(pageBackgroundColor); i++) {
                        map.put(
                                "page_background_color[" + i + "]",
                                getFromList(pageBackgroundColor, i));
                    }
                } else {
                    map.put(
                            "page_background_color",
                            JSON.getDefault().getMapper().writeValueAsString(pageBackgroundColor));
                }
            }
            if (primaryButtonColor != null) {
                ...
                if (primaryButtonColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(primaryButtonColor); i++) {
                        map.put(
                                "primary_button_color[" + i + "]",
                                getFromList(primaryButtonColor, i));
                    }
                } else {
                    map.put(
                            "primary_button_color",
                            JSON.getDefault().getMapper().writeValueAsString(primaryButtonColor));
                }
            }
            if (primaryButtonColorHover != null) {
                ...
                if (primaryButtonColorHover.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(primaryButtonColorHover); i++) {
                        map.put(
                                "primary_button_color_hover[" + i + "]",
                                getFromList(primaryButtonColorHover, i));
                    }
                } else {
                    map.put(
                            "primary_button_color_hover",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(primaryButtonColorHover));
                }
            }
            if (primaryButtonTextColor != null) {
                ...
                if (primaryButtonTextColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(primaryButtonTextColor); i++) {
                        map.put(
                                "primary_button_text_color[" + i + "]",
                                getFromList(primaryButtonTextColor, i));
                    }
                } else {
                    map.put(
                            "primary_button_text_color",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(primaryButtonTextColor));
                }
            }
            if (primaryButtonTextColorHover != null) {
                ...
                if (primaryButtonTextColorHover.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(primaryButtonTextColorHover); i++) {
                        map.put(
                                "primary_button_text_color_hover[" + i + "]",
                                getFromList(primaryButtonTextColorHover, i));
                    }
                } else {
                    map.put(
                            "primary_button_text_color_hover",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(primaryButtonTextColorHover));
                }
            }
            if (secondaryButtonColor != null) {
                ...
                if (secondaryButtonColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(secondaryButtonColor); i++) {
                        map.put(
                                "secondary_button_color[" + i + "]",
                                getFromList(secondaryButtonColor, i));
                    }
                } else {
                    map.put(
                            "secondary_button_color",
                            JSON.getDefault().getMapper().writeValueAsString(secondaryButtonColor));
                }
            }
            if (secondaryButtonColorHover != null) {
                ...
                if (secondaryButtonColorHover.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(secondaryButtonColorHover); i++) {
                        map.put(
                                "secondary_button_color_hover[" + i + "]",
                                getFromList(secondaryButtonColorHover, i));
                    }
                } else {
                    map.put(
                            "secondary_button_color_hover",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(secondaryButtonColorHover));
                }
            }
            if (secondaryButtonTextColor != null) {
                ...
                if (secondaryButtonTextColor.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(secondaryButtonTextColor); i++) {
                        map.put(
                                "secondary_button_text_color[" + i + "]",
                                getFromList(secondaryButtonTextColor, i));
                    }
                } else {
                    map.put(
                            "secondary_button_text_color",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(secondaryButtonTextColor));
                }
            }
            if (secondaryButtonTextColorHover != null) {
                ...
                if (secondaryButtonTextColorHover.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(secondaryButtonTextColorHover); i++) {
                        map.put(
                                "secondary_button_text_color_hover[" + i + "]",
                                getFromList(secondaryButtonTextColorHover, i));
                    }
                } else {
                    map.put(
                            "secondary_button_text_color_hover",
                            JSON.getDefault()
                                    .getMapper()
                                    .writeValueAsString(secondaryButtonTextColorHover));
                }
            }
            if (textColor1 != null) {
                ...
                if (textColor1.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "text_color1",
                            JSON.getDefault().getMapper().writeValueAsString(textColor1));
                }
            }
            if (textColor2 != null) {
