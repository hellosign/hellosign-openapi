...
public class TemplateCreateEmbeddedDraftResponse {
  ...
  public TemplateCreateEmbeddedDraftResponse template(@javax.annotation.Nonnull TemplateCreateEmbeddedDraftResponseTemplate template) {
  ...
  @JsonProperty(JSON_PROPERTY_TEMPLATE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTemplate(@javax.annotation.Nonnull TemplateCreateEmbeddedDraftResponseTemplate template) {
    this.template = template;
  }


  public TemplateCreateEmbeddedDraftResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
