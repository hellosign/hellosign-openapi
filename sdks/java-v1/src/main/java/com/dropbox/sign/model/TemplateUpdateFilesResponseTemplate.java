...
public class TemplateUpdateFilesResponseTemplate {
  ...
  public TemplateUpdateFilesResponseTemplate templateId(@javax.annotation.Nullable String templateId) {
  ...
  @Deprecated
  public TemplateUpdateFilesResponseTemplate warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
