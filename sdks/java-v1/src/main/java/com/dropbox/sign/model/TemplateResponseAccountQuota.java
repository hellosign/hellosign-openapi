...
public class TemplateResponseAccountQuota {
  ...
  public TemplateResponseAccountQuota templatesLeft(@javax.annotation.Nullable Integer templatesLeft) {
  ...
  public TemplateResponseAccountQuota apiSignatureRequestsLeft(@javax.annotation.Nullable Integer apiSignatureRequestsLeft) {
  ...
  @JsonProperty(JSON_PROPERTY_API_SIGNATURE_REQUESTS_LEFT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setApiSignatureRequestsLeft(@javax.annotation.Nullable Integer apiSignatureRequestsLeft) {
    this.apiSignatureRequestsLeft = apiSignatureRequestsLeft;
  }


  public TemplateResponseAccountQuota documentsLeft(@javax.annotation.Nullable Integer documentsLeft) {
  ...
  public TemplateResponseAccountQuota smsVerificationsLeft(@javax.annotation.Nullable Integer smsVerificationsLeft) {
