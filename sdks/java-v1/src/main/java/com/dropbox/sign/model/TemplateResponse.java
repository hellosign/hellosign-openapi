...
public class TemplateResponse {
  ...
  public TemplateResponse signerRoles(@javax.annotation.Nullable List<TemplateResponseSignerRole> signerRoles) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNER_ROLES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSignerRoles(@javax.annotation.Nullable List<TemplateResponseSignerRole> signerRoles) {
    this.signerRoles = signerRoles;
  }


  public TemplateResponse ccRoles(@javax.annotation.Nullable List<TemplateResponseCCRole> ccRoles) {
  ...
  public TemplateResponse documents(@javax.annotation.Nullable List<TemplateResponseDocument> documents) {
  ...
  @Deprecated
  public TemplateResponse customFields(@javax.annotation.Nullable List<TemplateResponseDocumentCustomFieldBase> customFields) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomFields(@javax.annotation.Nullable List<TemplateResponseDocumentCustomFieldBase> customFields) {
    this.customFields = customFields;
  }


  @Deprecated
  public TemplateResponse namedFormFields(@javax.annotation.Nullable List<TemplateResponseDocumentFormFieldBase> namedFormFields) {
  ...
  @JsonProperty(JSON_PROPERTY_NAMED_FORM_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setNamedFormFields(@javax.annotation.Nullable List<TemplateResponseDocumentFormFieldBase> namedFormFields) {
    this.namedFormFields = namedFormFields;
  }


  public TemplateResponse accounts(@javax.annotation.Nullable List<TemplateResponseAccount> accounts) {
  ...
  public TemplateResponse attachments(@javax.annotation.Nullable List<SignatureRequestResponseAttachment> attachments) {
