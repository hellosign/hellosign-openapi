...
public class BulkSendJobApi {
    ...
    public BulkSendJobGetResponse bulkSendJobGet(
            String bulkSendJobId, Integer page, Integer pageSize) throws ApiException {
     ...
     */
    public ApiResponse<BulkSendJobGetResponse> bulkSendJobGetWithHttpInfo(String bulkSendJobId)
            throws ApiException {
        Integer page = 1;
        Integer pageSize = 20;
     ...
     * @see BulkSendJobApi#bulkSendJobGet(String, Integer, Integer)
     */
    public BulkSendJobGetResponse bulkSendJobGet(String bulkSendJobId, Integer page)
            throws ApiException {
        Integer pageSize = 20;
     ...
     * @see BulkSendJobApi#bulkSendJobGetWithHttpInfo(String, Integer, Integer)
     */
    public ApiResponse<BulkSendJobGetResponse> bulkSendJobGetWithHttpInfo(
            String bulkSendJobId, Integer page) throws ApiException {
        Integer pageSize = 20;
    ...
    public ApiResponse<BulkSendJobGetResponse> bulkSendJobGetWithHttpInfo(
        ...
        if (bulkSendJobId == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'bulkSendJobId' when calling bulkSendJobGet");
        }
        ...
        String localVarPath =
                "/bulk_send_job/{bulk_send_job_id}"
                        .replaceAll(
                                "\\{bulk_send_job_id}",
                                apiClient.escapeString(bulkSendJobId.toString()));
        ...
        GenericType<BulkSendJobGetResponse> localVarReturnType =
                new GenericType<BulkSendJobGetResponse>() {};
     ...
     * </table>
     */
    public BulkSendJobListResponse bulkSendJobList(Integer page, Integer pageSize)
            throws ApiException {
     ...
     * @see BulkSendJobApi#bulkSendJobListWithHttpInfo(Integer, Integer)
     */
    public ApiResponse<BulkSendJobListResponse> bulkSendJobListWithHttpInfo(Integer page)
            throws ApiException {
        Integer pageSize = 20;
     ...
     * </table>
     */
    public ApiResponse<BulkSendJobListResponse> bulkSendJobListWithHttpInfo(
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<BulkSendJobListResponse> localVarReturnType =
                new GenericType<BulkSendJobListResponse>() {};
        return apiClient.invokeAPI(
