...
public class SubBulkSignerList {
  ...
  public SubBulkSignerList customFields(@javax.annotation.Nullable List<SubBulkSignerListCustomField> customFields) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomFields(@javax.annotation.Nullable List<SubBulkSignerListCustomField> customFields) {
    this.customFields = customFields;
  }


  public SubBulkSignerList signers(@javax.annotation.Nullable List<SubSignatureRequestTemplateSigner> signers) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSigners(@javax.annotation.Nullable List<SubSignatureRequestTemplateSigner> signers) {
    this.signers = signers;
  }
