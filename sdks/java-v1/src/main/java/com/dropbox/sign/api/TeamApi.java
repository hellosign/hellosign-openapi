...
public class TeamApi {
     ...
     * </table>
     */
    public TeamGetResponse teamAddMember(TeamAddMemberRequest teamAddMemberRequest, String teamId)
            throws ApiException {
     ...
     */
    public ApiResponse<TeamGetResponse> teamAddMemberWithHttpInfo(
            TeamAddMemberRequest teamAddMemberRequest) throws ApiException {
        String teamId = null;
     ...
     */
    public ApiResponse<TeamGetResponse> teamAddMemberWithHttpInfo(
            TeamAddMemberRequest teamAddMemberRequest, String teamId) throws ApiException {

        // Check required parameters
        if (teamAddMemberRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'teamAddMemberRequest' when calling"
                            + " teamAddMember");
        }
    ...
    public ApiResponse<TeamGetResponse> teamCreateWithHttpInfo(TeamCreateRequest teamCreateRequest)
        ...
        if (teamCreateRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'teamCreateRequest' when calling teamCreate");
        }
     ...
     * </table>
     */
    public ApiResponse<TeamGetInfoResponse> teamInfoWithHttpInfo(String teamId)
            throws ApiException {
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<TeamGetInfoResponse> localVarReturnType =
                new GenericType<TeamGetInfoResponse>() {};
        return apiClient.invokeAPI(
                "TeamApi.teamInfo",
                "/team/info",
                "GET",
     ...
     * </table>
     */
    public ApiResponse<TeamInvitesResponse> teamInvitesWithHttpInfo(String emailAddress)
            throws ApiException {

        // Query parameters
        List<Pair> localVarQueryParams =
                new ArrayList<>(apiClient.parameterToPairs("", "email_address", emailAddress));
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<TeamInvitesResponse> localVarReturnType =
                new GenericType<TeamInvitesResponse>() {};
        return apiClient.invokeAPI(
                "TeamApi.teamInvites",
                "/team/invites",
                "GET",
     ...
     * </table>
     */
    public TeamMembersResponse teamMembers(String teamId, Integer page, Integer pageSize)
            throws ApiException {
     ...
     */
    public ApiResponse<TeamMembersResponse> teamMembersWithHttpInfo(String teamId)
            throws ApiException {
        Integer page = 1;
        Integer pageSize = 20;
     ...
     * @see TeamApi#teamMembersWithHttpInfo(String, Integer, Integer)
     */
    public ApiResponse<TeamMembersResponse> teamMembersWithHttpInfo(String teamId, Integer page)
            throws ApiException {
        Integer pageSize = 20;
     ...
     * </table>
     */
    public ApiResponse<TeamMembersResponse> teamMembersWithHttpInfo(
            String teamId, Integer page, Integer pageSize) throws ApiException {
        ...
        if (teamId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'teamId' when calling teamMembers");
        }
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<TeamMembersResponse> localVarReturnType =
                new GenericType<TeamMembersResponse>() {};
        return apiClient.invokeAPI(
                "TeamApi.teamMembers",
                localVarPath,
                "GET",
     ...
     * </table>
     */
    public ApiResponse<TeamGetResponse> teamRemoveMemberWithHttpInfo(
            TeamRemoveMemberRequest teamRemoveMemberRequest) throws ApiException {

        // Check required parameters
        if (teamRemoveMemberRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'teamRemoveMemberRequest' when calling"
                            + " teamRemoveMember");
        }
     ...
     * </table>
     */
    public TeamSubTeamsResponse teamSubTeams(String teamId, Integer page, Integer pageSize)
            throws ApiException {
     ...
     */
    public ApiResponse<TeamSubTeamsResponse> teamSubTeamsWithHttpInfo(String teamId)
            throws ApiException {
        Integer page = 1;
        Integer pageSize = 20;
     ...
     * @see TeamApi#teamSubTeamsWithHttpInfo(String, Integer, Integer)
     */
    public ApiResponse<TeamSubTeamsResponse> teamSubTeamsWithHttpInfo(String teamId, Integer page)
            throws ApiException {
        Integer pageSize = 20;
     ...
     * </table>
     */
    public ApiResponse<TeamSubTeamsResponse> teamSubTeamsWithHttpInfo(
            String teamId, Integer page, Integer pageSize) throws ApiException {
        ...
        if (teamId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'teamId' when calling teamSubTeams");
        }
        ...
        String localVarContentType =
                isFileTypeFound ? "multipart/form-data" : apiClient.selectHeaderContentType();
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<TeamSubTeamsResponse> localVarReturnType =
                new GenericType<TeamSubTeamsResponse>() {};
        return apiClient.invokeAPI(
    ...
    public ApiResponse<TeamGetResponse> teamUpdateWithHttpInfo(TeamUpdateRequest teamUpdateRequest)
        ...
        if (teamUpdateRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'teamUpdateRequest' when calling teamUpdate");
        }
