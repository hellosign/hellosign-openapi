...
public class SignatureRequestResponse {
  ...
  public SignatureRequestResponse signatureRequestId(@javax.annotation.Nullable String signatureRequestId) {
  ...
  public SignatureRequestResponse requesterEmailAddress(@javax.annotation.Nullable String requesterEmailAddress) {
  ...
  public SignatureRequestResponse metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestResponse ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public SignatureRequestResponse templateIds(@javax.annotation.Nullable List<String> templateIds) {
  ...
  public SignatureRequestResponse customFields(@javax.annotation.Nullable List<SignatureRequestResponseCustomFieldBase> customFields) {
  ...
  public SignatureRequestResponse attachments(@javax.annotation.Nullable List<SignatureRequestResponseAttachment> attachments) {
  ...
  public SignatureRequestResponse responseData(@javax.annotation.Nullable List<SignatureRequestResponseDataBase> responseData) {
  ...
  public SignatureRequestResponse signatures(@javax.annotation.Nullable List<SignatureRequestResponseSignatures> signatures) {
