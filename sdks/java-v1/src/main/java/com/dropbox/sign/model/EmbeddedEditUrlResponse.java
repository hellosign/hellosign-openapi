...
public class EmbeddedEditUrlResponse {
  ...
  public EmbeddedEditUrlResponse embedded(@javax.annotation.Nonnull EmbeddedEditUrlResponseEmbedded embedded) {
  ...
  public EmbeddedEditUrlResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
