...
public class TeamMembersResponse {
    ...
    @javax.annotation.Nonnull private List<TeamMemberResponse> teamMembers = new ArrayList<>();
     ...
     */
    public static TeamMembersResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TeamMembersResponse.class);
    }

    public static TeamMembersResponse init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(new ObjectMapper().writeValueAsString(data), TeamMembersResponse.class);
    }

    public TeamMembersResponse teamMembers(
            @javax.annotation.Nonnull List<TeamMemberResponse> teamMembers) {
    ...
    @JsonProperty(JSON_PROPERTY_TEAM_MEMBERS)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setTeamMembers(@javax.annotation.Nonnull List<TeamMemberResponse> teamMembers) {
        this.teamMembers = teamMembers;
    }

    public TeamMembersResponse listInfo(@javax.annotation.Nonnull ListInfoResponse listInfo) {
    ...
    public TeamMembersResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
        ...
        try {
            if (teamMembers != null) {
                ...
                if (teamMembers.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "team_members",
                            JSON.getDefault().getMapper().writeValueAsString(teamMembers));
                }
            }
            if (listInfo != null) {
