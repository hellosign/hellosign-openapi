...
public class SignatureRequestSendWithTemplateRequest {
    ...
    @Deprecated @javax.annotation.Nullable private Boolean isQualifiedSignature = false;
     ...
     */
    public static SignatureRequestSendWithTemplateRequest init(String jsonData) throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, SignatureRequestSendWithTemplateRequest.class);
    }

    public static SignatureRequestSendWithTemplateRequest init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
    ...
    public SignatureRequestSendWithTemplateRequest templateIds(
    ...
    public SignatureRequestSendWithTemplateRequest signers(
            @javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
        this.signers = signers;
        return this;
    }

    public SignatureRequestSendWithTemplateRequest addSignersItem(
    ...
    public SignatureRequestSendWithTemplateRequest allowDecline(
    ...
    public SignatureRequestSendWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
        this.ccs = ccs;
        return this;
    }
    ...
    public SignatureRequestSendWithTemplateRequest clientId(
    ...
    public SignatureRequestSendWithTemplateRequest customFields(
            @javax.annotation.Nullable List<SubCustomField> customFields) {
        this.customFields = customFields;
        return this;
    }

    public SignatureRequestSendWithTemplateRequest addCustomFieldsItem(
    ...
    public SignatureRequestSendWithTemplateRequest files(
    ...
    public SignatureRequestSendWithTemplateRequest fileUrls(
    ...
    @Deprecated
    public SignatureRequestSendWithTemplateRequest isQualifiedSignature(
            @javax.annotation.Nullable Boolean isQualifiedSignature) {
        this.isQualifiedSignature = isQualifiedSignature;
        return this;
    }

    /**
     * Send with a value of &#x60;true&#x60; if you wish to enable [Qualified Electronic
     * Signatures](https://www.hellosign.com/features/qualified-electronic-signatures) (QES), which
     * requires a face-to-face call to verify the signer&#39;s identity.&lt;br&gt; **NOTE:** QES is
     * only available on the Premium API plan as an add-on purchase. Cannot be used in
     ...
     */
    @Deprecated
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_IS_QUALIFIED_SIGNATURE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    public void setIsQualifiedSignature(@javax.annotation.Nullable Boolean isQualifiedSignature) {
        this.isQualifiedSignature = isQualifiedSignature;
    }

    public SignatureRequestSendWithTemplateRequest isEid(@javax.annotation.Nullable Boolean isEid) {
        this.isEid = isEid;
        return this;
    }
    ...
    public SignatureRequestSendWithTemplateRequest message(
    ...
    public SignatureRequestSendWithTemplateRequest metadata(
            @javax.annotation.Nullable Map<String, Object> metadata) {
        this.metadata = metadata;
        return this;
    }

    public SignatureRequestSendWithTemplateRequest putMetadataItem(
    ...
    public SignatureRequestSendWithTemplateRequest signingOptions(
    ...
    public SignatureRequestSendWithTemplateRequest signingRedirectUrl(
    ...
    public SignatureRequestSendWithTemplateRequest subject(
    ...
    public SignatureRequestSendWithTemplateRequest testMode(
    ...
    public SignatureRequestSendWithTemplateRequest title(@javax.annotation.Nullable String title) {
        this.title = title;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestSendWithTemplateRequest signatureRequestSendWithTemplateRequest =
                (SignatureRequestSendWithTemplateRequest) o;
        return Objects.equals(this.templateIds, signatureRequestSendWithTemplateRequest.templateIds)
                ...
                && Objects.equals(
                        this.allowDecline, signatureRequestSendWithTemplateRequest.allowDecline)
                ...
                && Objects.equals(
                        this.customFields, signatureRequestSendWithTemplateRequest.customFields)
                ...
                && Objects.equals(
                        this.isQualifiedSignature,
                        signatureRequestSendWithTemplateRequest.isQualifiedSignature)
                ...
                && Objects.equals(
                        this.signingOptions, signatureRequestSendWithTemplateRequest.signingOptions)
                && Objects.equals(
    ...
    public String toString() {
        ...
        sb.append("    isQualifiedSignature: ")
                .append(toIndentedString(isQualifiedSignature))
                .append("\n");
            ...
            if (isQualifiedSignature != null) {
                ...
                if (isQualifiedSignature.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(isQualifiedSignature); i++) {
                        map.put(
                                "is_qualified_signature[" + i + "]",
                                getFromList(isQualifiedSignature, i));
                    }
                } else {
                    map.put(
                            "is_qualified_signature",
                            JSON.getDefault().getMapper().writeValueAsString(isQualifiedSignature));
                }
            }
            if (isEid != null) {
