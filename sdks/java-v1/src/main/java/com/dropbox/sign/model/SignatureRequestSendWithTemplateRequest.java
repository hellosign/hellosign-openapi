...
public class SignatureRequestSendWithTemplateRequest {
  ...
  public SignatureRequestSendWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestSendWithTemplateRequest signers(@javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
  ...
  public SignatureRequestSendWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestSendWithTemplateRequest clientId(@javax.annotation.Nullable String clientId) {
  ...
  public SignatureRequestSendWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestSendWithTemplateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestSendWithTemplateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  @Deprecated
  public SignatureRequestSendWithTemplateRequest isQualifiedSignature(@javax.annotation.Nullable Boolean isQualifiedSignature) {
  ...
  public SignatureRequestSendWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestSendWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestSendWithTemplateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestSendWithTemplateRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public SignatureRequestSendWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestSendWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
