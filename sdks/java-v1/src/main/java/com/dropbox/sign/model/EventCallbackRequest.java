...
public class EventCallbackRequest {
  ...
  public EventCallbackRequest signatureRequest(@javax.annotation.Nullable SignatureRequestResponse signatureRequest) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURE_REQUEST)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSignatureRequest(@javax.annotation.Nullable SignatureRequestResponse signatureRequest) {
    this.signatureRequest = signatureRequest;
  }
