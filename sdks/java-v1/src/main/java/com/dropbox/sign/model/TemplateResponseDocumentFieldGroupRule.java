...
public class TemplateResponseDocumentFieldGroupRule {
  ...
  public TemplateResponseDocumentFieldGroupRule requirement(@javax.annotation.Nullable String requirement) {
  ...
  public TemplateResponseDocumentFieldGroupRule groupLabel(@javax.annotation.Nullable String groupLabel) {
