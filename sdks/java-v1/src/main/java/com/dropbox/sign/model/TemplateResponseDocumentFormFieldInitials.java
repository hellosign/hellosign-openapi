...
public class TemplateResponseDocumentFormFieldInitials
     ...
     */
    public static TemplateResponseDocumentFormFieldInitials init(String jsonData) throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, TemplateResponseDocumentFormFieldInitials.class);
    }

    public static TemplateResponseDocumentFormFieldInitials init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
    ...
    static {
        ...
        JSON.registerDiscriminator(
                TemplateResponseDocumentFormFieldInitials.class, "type", mappings);
    }
}
