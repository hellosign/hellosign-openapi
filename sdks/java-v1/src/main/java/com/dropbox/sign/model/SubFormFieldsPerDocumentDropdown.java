...
public class SubFormFieldsPerDocumentDropdown extends SubFormFieldsPerDocumentBase {
  ...
  public SubFormFieldsPerDocumentDropdown options(@javax.annotation.Nonnull List<String> options) {
  ...
  public SubFormFieldsPerDocumentDropdown fontFamily(@javax.annotation.Nullable FontFamilyEnum fontFamily) {
