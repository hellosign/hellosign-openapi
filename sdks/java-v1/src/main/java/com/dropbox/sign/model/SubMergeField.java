...
/** SubMergeField */
@JsonPropertyOrder({SubMergeField.JSON_PROPERTY_NAME, SubMergeField.JSON_PROPERTY_TYPE})
...
public class SubMergeField {
     ...
     */
    public static SubMergeField init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubMergeField.class);
    }

    public static SubMergeField init(HashMap data) throws Exception {
