...
public class TemplateCreateEmbeddedDraftResponseTemplate {
  ...
  public TemplateCreateEmbeddedDraftResponseTemplate templateId(@javax.annotation.Nullable String templateId) {
  ...
  public TemplateCreateEmbeddedDraftResponseTemplate editUrl(@javax.annotation.Nullable String editUrl) {
  ...
  public TemplateCreateEmbeddedDraftResponseTemplate expiresAt(@javax.annotation.Nullable Integer expiresAt) {
  ...
  @Deprecated
  public TemplateCreateEmbeddedDraftResponseTemplate warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
