...
public class UnclaimedDraftCreateRequest {
  ...
  public UnclaimedDraftCreateRequest type(@javax.annotation.Nonnull TypeEnum type) {
    this.type = type;
    return this;
  }
  ...
  public UnclaimedDraftCreateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public UnclaimedDraftCreateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public UnclaimedDraftCreateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public UnclaimedDraftCreateRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
  ...
  public UnclaimedDraftCreateRequest attachments(@javax.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public UnclaimedDraftCreateRequest ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public UnclaimedDraftCreateRequest clientId(@javax.annotation.Nullable String clientId) {
  ...
  public UnclaimedDraftCreateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public UnclaimedDraftCreateRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public UnclaimedDraftCreateRequest formFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
  ...
  public UnclaimedDraftCreateRequest formFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  public UnclaimedDraftCreateRequest formFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
  ...
  public UnclaimedDraftCreateRequest hideTextTags(@javax.annotation.Nullable Boolean hideTextTags) {
  ...
  public UnclaimedDraftCreateRequest message(@javax.annotation.Nullable String message) {
  ...
  public UnclaimedDraftCreateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public UnclaimedDraftCreateRequest showProgressStepper(@javax.annotation.Nullable Boolean showProgressStepper) {
  ...
  public UnclaimedDraftCreateRequest signers(@javax.annotation.Nullable List<SubUnclaimedDraftSigner> signers) {
  ...
  public UnclaimedDraftCreateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public UnclaimedDraftCreateRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public UnclaimedDraftCreateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public UnclaimedDraftCreateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public UnclaimedDraftCreateRequest usePreexistingFields(@javax.annotation.Nullable Boolean usePreexistingFields) {
  ...
  public UnclaimedDraftCreateRequest useTextTags(@javax.annotation.Nullable Boolean useTextTags) {
  ...
  @Override
  public int hashCode() {
    return Objects.hash(type, files, fileUrls, allowDecline, allowFormView, attachments, ccEmailAddresses, clientId, customFields, fieldOptions, formFieldGroups, formFieldRules, formFieldsPerDocument, hideTextTags, message, metadata, showProgressStepper, signers, signingOptions, signingRedirectUrl, subject, testMode, usePreexistingFields, useTextTags, expiresAt);
  }
