...
public class BulkSendJobGetResponseSignatureRequests {
  ...
  public BulkSendJobGetResponseSignatureRequests testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public BulkSendJobGetResponseSignatureRequests signatureRequestId(@javax.annotation.Nullable String signatureRequestId) {
  ...
  public BulkSendJobGetResponseSignatureRequests requesterEmailAddress(@javax.annotation.Nullable String requesterEmailAddress) {
  ...
  public BulkSendJobGetResponseSignatureRequests originalTitle(@javax.annotation.Nullable String originalTitle) {
  ...
  public BulkSendJobGetResponseSignatureRequests subject(@javax.annotation.Nullable String subject) {
  ...
  public BulkSendJobGetResponseSignatureRequests message(@javax.annotation.Nullable String message) {
  ...
  public BulkSendJobGetResponseSignatureRequests metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public BulkSendJobGetResponseSignatureRequests createdAt(@javax.annotation.Nullable Integer createdAt) {
  ...
  public BulkSendJobGetResponseSignatureRequests expiresAt(@javax.annotation.Nullable Integer expiresAt) {
  ...
  public BulkSendJobGetResponseSignatureRequests isComplete(@javax.annotation.Nullable Boolean isComplete) {
  ...
  public BulkSendJobGetResponseSignatureRequests hasError(@javax.annotation.Nullable Boolean hasError) {
  ...
  public BulkSendJobGetResponseSignatureRequests filesUrl(@javax.annotation.Nullable String filesUrl) {
  ...
  public BulkSendJobGetResponseSignatureRequests signingUrl(@javax.annotation.Nullable String signingUrl) {
  ...
  public BulkSendJobGetResponseSignatureRequests detailsUrl(@javax.annotation.Nullable String detailsUrl) {
  ...
  public BulkSendJobGetResponseSignatureRequests ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public BulkSendJobGetResponseSignatureRequests finalCopyUri(@javax.annotation.Nullable String finalCopyUri) {
  ...
  public BulkSendJobGetResponseSignatureRequests templateIds(@javax.annotation.Nullable List<String> templateIds) {
  ...
  public BulkSendJobGetResponseSignatureRequests customFields(@javax.annotation.Nullable List<SignatureRequestResponseCustomFieldBase> customFields) {
  ...
  @JsonProperty(JSON_PROPERTY_CUSTOM_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setCustomFields(@javax.annotation.Nullable List<SignatureRequestResponseCustomFieldBase> customFields) {
    this.customFields = customFields;
  }


  public BulkSendJobGetResponseSignatureRequests attachments(@javax.annotation.Nullable List<SignatureRequestResponseAttachment> attachments) {
  ...
  @JsonProperty(JSON_PROPERTY_ATTACHMENTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setAttachments(@javax.annotation.Nullable List<SignatureRequestResponseAttachment> attachments) {
    this.attachments = attachments;
  }


  public BulkSendJobGetResponseSignatureRequests responseData(@javax.annotation.Nullable List<SignatureRequestResponseDataBase> responseData) {
  ...
  @JsonProperty(JSON_PROPERTY_RESPONSE_DATA)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setResponseData(@javax.annotation.Nullable List<SignatureRequestResponseDataBase> responseData) {
    this.responseData = responseData;
  }


  public BulkSendJobGetResponseSignatureRequests signatures(@javax.annotation.Nullable List<SignatureRequestResponseSignatures> signatures) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSignatures(@javax.annotation.Nullable List<SignatureRequestResponseSignatures> signatures) {
    this.signatures = signatures;
  }


  public BulkSendJobGetResponseSignatureRequests bulkSendJobId(@javax.annotation.Nullable String bulkSendJobId) {
