...
public class SignatureRequestResponseAttachment {
     ...
     */
    public static SignatureRequestResponseAttachment init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SignatureRequestResponseAttachment.class);
    }

    public static SignatureRequestResponseAttachment init(HashMap data) throws Exception {
     ...
     * @return instructions
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_INSTRUCTIONS)
     ...
     * @return uploadedAt
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_UPLOADED_AT)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestResponseAttachment signatureRequestResponseAttachment =
                (SignatureRequestResponseAttachment) o;
        return Objects.equals(this.id, signatureRequestResponseAttachment.id)
                ...
                && Objects.equals(
                        this.instructions, signatureRequestResponseAttachment.instructions)
        ...
        try {
            ...
            if (instructions != null) {
                ...
                if (instructions.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "instructions",
                            JSON.getDefault().getMapper().writeValueAsString(instructions));
                }
            }
            if (uploadedAt != null) {
                ...
                if (uploadedAt.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "uploaded_at",
                            JSON.getDefault().getMapper().writeValueAsString(uploadedAt));
                }
            }
        } catch (Exception e) {
