...
public class EmbeddedSignUrlResponseEmbedded {
    ...
    @javax.annotation.Nullable private String signUrl;
     ...
     */
    public static EmbeddedSignUrlResponseEmbedded init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, EmbeddedSignUrlResponseEmbedded.class);
    }

    public static EmbeddedSignUrlResponseEmbedded init(HashMap data) throws Exception {
    ...
    public EmbeddedSignUrlResponseEmbedded signUrl(@javax.annotation.Nullable String signUrl) {
     ...
     * @return signUrl
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGN_URL)
    ...
    public EmbeddedSignUrlResponseEmbedded expiresAt(@javax.annotation.Nullable Integer expiresAt) {
    ...
    public boolean equals(Object o) {
        ...
        EmbeddedSignUrlResponseEmbedded embeddedSignUrlResponseEmbedded =
                (EmbeddedSignUrlResponseEmbedded) o;
