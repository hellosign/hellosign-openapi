...
public class SubFieldOptions {
     ...
     * [formats](/api/reference/constants/#date-formats)) **NOTE:** Only available for Premium and
     * higher.
     */
    ...
    @javax.annotation.Nonnull private DateFormatEnum dateFormat;
     ...
     */
    public static SubFieldOptions init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubFieldOptions.class);
    }

    public static SubFieldOptions init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(new ObjectMapper().writeValueAsString(data), SubFieldOptions.class);
    }

    public SubFieldOptions dateFormat(@javax.annotation.Nonnull DateFormatEnum dateFormat) {
    ...
    @JsonProperty(JSON_PROPERTY_DATE_FORMAT)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setDateFormat(@javax.annotation.Nonnull DateFormatEnum dateFormat) {
        this.dateFormat = dateFormat;
    }
        ...
        try {
            if (dateFormat != null) {
                ...
                if (dateFormat.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "date_format",
                            JSON.getDefault().getMapper().writeValueAsString(dateFormat));
                }
            }
        } catch (Exception e) {
