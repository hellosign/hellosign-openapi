...
public class OAuthErrorResponseError {
     ...
     */
    public static OAuthErrorResponseError init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, OAuthErrorResponseError.class);
    }

    public static OAuthErrorResponseError init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
                        new ObjectMapper().writeValueAsString(data), OAuthErrorResponseError.class);
    }

    public OAuthErrorResponseError errorMsg(@javax.annotation.Nonnull String errorMsg) {
    ...
    public OAuthErrorResponseError errorName(@javax.annotation.Nonnull ErrorNameEnum errorName) {
        ...
        try {
            if (errorMsg != null) {
                ...
                if (errorMsg.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "error_msg",
                            JSON.getDefault().getMapper().writeValueAsString(errorMsg));
                }
            }
            if (errorName != null) {
                ...
                if (errorName.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "error_name",
                            JSON.getDefault().getMapper().writeValueAsString(errorName));
                }
            }
        } catch (Exception e) {
