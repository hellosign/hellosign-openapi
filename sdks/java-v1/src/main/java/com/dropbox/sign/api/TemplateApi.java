...
public class TemplateApi {
    ...
    /**
     * Edit Template Edits an existing template.
     *
     ...
     * </table>
     */
    public TemplateGetResponse templateEdit(
            String templateId, TemplateEditRequest templateEditRequest) throws ApiException {
     ...
     * </table>
     */
    public ApiResponse<TemplateGetResponse> templateEditWithHttpInfo(
            String templateId, TemplateEditRequest templateEditRequest) throws ApiException {

        // Check required parameters
        if (templateId == null) {
            throw new ApiException(
                    400, "Missing the required parameter 'templateId' when calling templateEdit");
        }
        if (templateEditRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'templateEditRequest' when calling"
                            + " templateEdit");
        }
     ...
     * Also note that this will decrement your template quota. Overlaying new files is asynchronous
     * and a successful call to this endpoint will return 200 OK response if the request passes
     * initial validation checks. It is recommended that a callback be implemented to listen for the
     * callback event. A &#x60;template_created&#x60; event will be sent when the files are updated
     * or a &#x60;template_error&#x60; event will be sent if there was a problem while updating the
     * files. If a callback handler has been configured and the event has not been received within
     * 60 minutes of making the call, check the status of the request in the API dashboard and retry
     * the request if necessary. If the page orientation or page count is different from the
     * original template document, we will notify you with a &#x60;template_error&#x60; [callback
     * event](https://app.hellosign.com/api/eventsAndCallbacksWalkthrough).
     *
    ...
    public ApiResponse<TemplateUpdateFilesResponse> templateUpdateFilesWithHttpInfo(
        ...
        if (templateId == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'templateId' when calling templateUpdateFiles");
        }
        if (templateUpdateFilesRequest == null) {
            throw new ApiException(
                    400,
                    "Missing the required parameter 'templateUpdateFilesRequest' when calling"
                            + " templateUpdateFiles");
        }
        ...
        String localVarContentType =
                isFileTypeFound
                        ...
                        : apiClient.selectHeaderContentType(
                                "application/json", "multipart/form-data");
        String[] localVarAuthNames = new String[] {"api_key", "oauth2"};
        GenericType<TemplateUpdateFilesResponse> localVarReturnType =
                new GenericType<TemplateUpdateFilesResponse>() {};
        return apiClient.invokeAPI(
