...
public class TemplateCreateResponse {
  ...
  public TemplateCreateResponse template(@javax.annotation.Nonnull TemplateCreateResponseTemplate template) {
  ...
  public TemplateCreateResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
