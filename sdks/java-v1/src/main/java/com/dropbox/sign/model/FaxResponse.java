...
public class FaxResponse {
  ...
  public FaxResponse transmissions(@javax.annotation.Nonnull List<FaxResponseTransmission> transmissions) {
  ...
  @JsonProperty(JSON_PROPERTY_TRANSMISSIONS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTransmissions(@javax.annotation.Nonnull List<FaxResponseTransmission> transmissions) {
    this.transmissions = transmissions;
  }
