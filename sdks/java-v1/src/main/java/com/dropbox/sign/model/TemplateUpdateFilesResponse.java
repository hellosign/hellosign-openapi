...
public class TemplateUpdateFilesResponse {
  ...
  public TemplateUpdateFilesResponse template(@javax.annotation.Nonnull TemplateUpdateFilesResponseTemplate template) {
  ...
  @JsonProperty(JSON_PROPERTY_TEMPLATE)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setTemplate(@javax.annotation.Nonnull TemplateUpdateFilesResponseTemplate template) {
    this.template = template;
  }
