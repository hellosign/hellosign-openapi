...
public class SubSignatureRequestSigner {
  ...
  public SubSignatureRequestSigner smsPhoneNumber(@javax.annotation.Nullable String smsPhoneNumber) {
  ...
  public SubSignatureRequestSigner smsPhoneNumberType(@javax.annotation.Nullable SmsPhoneNumberTypeEnum smsPhoneNumberType) {
