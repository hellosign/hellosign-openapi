...
public class SignatureRequestEditEmbeddedWithTemplateRequest {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest signers(@javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNERS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSigners(@javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
    this.signers = signers;
  }


  public SignatureRequestEditEmbeddedWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public SignatureRequestEditEmbeddedWithTemplateRequest populateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
  ...
  @JsonProperty(JSON_PROPERTY_POPULATE_AUTO_FILL_FIELDS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setPopulateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
    this.populateAutoFillFields = populateAutoFillFields;
  }
