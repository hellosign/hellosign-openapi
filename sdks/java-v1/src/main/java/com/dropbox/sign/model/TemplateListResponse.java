...
public class TemplateListResponse {
  ...
  public TemplateListResponse templates(@javax.annotation.Nonnull List<TemplateResponse> templates) {
  ...
  public TemplateListResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
