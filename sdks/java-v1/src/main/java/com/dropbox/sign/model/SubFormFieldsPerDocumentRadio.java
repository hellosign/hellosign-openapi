...
public class SubFormFieldsPerDocumentRadio extends SubFormFieldsPerDocumentBase {
     ...
     */
    public static SubFormFieldsPerDocumentRadio init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubFormFieldsPerDocumentRadio.class);
    }

    public static SubFormFieldsPerDocumentRadio init(HashMap data) throws Exception {
    ...
    public SubFormFieldsPerDocumentRadio type(@javax.annotation.Nonnull String type) {
        this.type = type;
        return this;
    }
    ...
    public SubFormFieldsPerDocumentRadio group(@javax.annotation.Nonnull String group) {
        this.group = group;
        return this;
    }
    ...
    public SubFormFieldsPerDocumentRadio isChecked(@javax.annotation.Nonnull Boolean isChecked) {
        this.isChecked = isChecked;
        return this;
    }

    /**
     * &#x60;true&#x60; for checking the radio field by default, otherwise &#x60;false&#x60;. Only
     * one radio field per group can be &#x60;true&#x60;.
     *
     * @return isChecked
     */
    @javax.annotation.Nonnull
    ...
    @JsonProperty(JSON_PROPERTY_IS_CHECKED)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setIsChecked(@javax.annotation.Nonnull Boolean isChecked) {
        this.isChecked = isChecked;
    }
    ...
    public boolean equals(Object o) {
        ...
        SubFormFieldsPerDocumentRadio subFormFieldsPerDocumentRadio =
                (SubFormFieldsPerDocumentRadio) o;
