...
public class BulkSendJobListResponse {
  ...
  public BulkSendJobListResponse bulkSendJobs(@javax.annotation.Nonnull List<BulkSendJobResponse> bulkSendJobs) {
  ...
  public BulkSendJobListResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
