...
public class BulkSendJobListResponse {
    ...
    @javax.annotation.Nonnull private List<BulkSendJobResponse> bulkSendJobs = new ArrayList<>();
     ...
     */
    public static BulkSendJobListResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, BulkSendJobListResponse.class);
    }

    public static BulkSendJobListResponse init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
                        new ObjectMapper().writeValueAsString(data), BulkSendJobListResponse.class);
    }

    public BulkSendJobListResponse bulkSendJobs(
            @javax.annotation.Nonnull List<BulkSendJobResponse> bulkSendJobs) {
    ...
    @JsonProperty(JSON_PROPERTY_BULK_SEND_JOBS)
    @JsonInclude(value = JsonInclude.Include.ALWAYS)
    public void setBulkSendJobs(@javax.annotation.Nonnull List<BulkSendJobResponse> bulkSendJobs) {
        this.bulkSendJobs = bulkSendJobs;
    }

    public BulkSendJobListResponse listInfo(@javax.annotation.Nonnull ListInfoResponse listInfo) {
    ...
    public BulkSendJobListResponse warnings(
        ...
        try {
            if (bulkSendJobs != null) {
                ...
                if (bulkSendJobs.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "bulk_send_jobs",
                            JSON.getDefault().getMapper().writeValueAsString(bulkSendJobs));
                }
            }
            if (listInfo != null) {
