...
public class UnclaimedDraftResponse {
    ...
    @javax.annotation.Nullable private String claimUrl;
    ...
    @javax.annotation.Nullable private Boolean testMode;
     ...
     */
    public static UnclaimedDraftResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, UnclaimedDraftResponse.class);
    }

    public static UnclaimedDraftResponse init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
                        new ObjectMapper().writeValueAsString(data), UnclaimedDraftResponse.class);
    }

    public UnclaimedDraftResponse signatureRequestId(
    ...
    public UnclaimedDraftResponse claimUrl(@javax.annotation.Nullable String claimUrl) {
     ...
     * @return claimUrl
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_CLAIM_URL)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public UnclaimedDraftResponse signingRedirectUrl(
    ...
    public UnclaimedDraftResponse requestingRedirectUrl(
    ...
    public UnclaimedDraftResponse expiresAt(@javax.annotation.Nullable Integer expiresAt) {
    ...
    public UnclaimedDraftResponse testMode(@javax.annotation.Nullable Boolean testMode) {
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.signatureRequestId, unclaimedDraftResponse.signatureRequestId)
                ...
                && Objects.equals(
                        this.signingRedirectUrl, unclaimedDraftResponse.signingRedirectUrl)
                && Objects.equals(
                        this.requestingRedirectUrl, unclaimedDraftResponse.requestingRedirectUrl)
        ...
        try {
            ...
            if (claimUrl != null) {
                ...
                if (claimUrl.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "claim_url",
                            JSON.getDefault().getMapper().writeValueAsString(claimUrl));
                }
            }
