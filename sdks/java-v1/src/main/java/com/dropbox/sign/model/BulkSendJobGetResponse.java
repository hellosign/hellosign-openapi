...
public class BulkSendJobGetResponse {
  ...
  public BulkSendJobGetResponse bulkSendJob(@javax.annotation.Nonnull BulkSendJobResponse bulkSendJob) {
  ...
  public BulkSendJobGetResponse signatureRequests(@javax.annotation.Nonnull List<BulkSendJobGetResponseSignatureRequests> signatureRequests) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURE_REQUESTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSignatureRequests(@javax.annotation.Nonnull List<BulkSendJobGetResponseSignatureRequests> signatureRequests) {
    this.signatureRequests = signatureRequests;
  }


  public BulkSendJobGetResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
