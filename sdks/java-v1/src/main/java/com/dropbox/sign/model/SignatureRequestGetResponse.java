...
public class SignatureRequestGetResponse {
     ...
     */
    public static SignatureRequestGetResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SignatureRequestGetResponse.class);
    }

    public static SignatureRequestGetResponse init(HashMap data) throws Exception {
