...
public class SignatureRequestGetResponse {
  ...
  public SignatureRequestGetResponse signatureRequest(@javax.annotation.Nonnull SignatureRequestResponse signatureRequest) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURE_REQUEST)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSignatureRequest(@javax.annotation.Nonnull SignatureRequestResponse signatureRequest) {
    this.signatureRequest = signatureRequest;
  }


  public SignatureRequestGetResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
