...
public class EventCallbackRequestEventMetadata {
  ...
  public EventCallbackRequestEventMetadata relatedSignatureId(@javax.annotation.Nullable String relatedSignatureId) {
  ...
  public EventCallbackRequestEventMetadata reportedForAccountId(@javax.annotation.Nullable String reportedForAccountId) {
  ...
  public EventCallbackRequestEventMetadata reportedForAppId(@javax.annotation.Nullable String reportedForAppId) {
  ...
  public EventCallbackRequestEventMetadata eventMessage(@javax.annotation.Nullable String eventMessage) {
