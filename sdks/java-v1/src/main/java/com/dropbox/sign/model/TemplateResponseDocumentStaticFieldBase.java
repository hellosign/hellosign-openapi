...
public class TemplateResponseDocumentStaticFieldBase {
  ...
  public TemplateResponseDocumentStaticFieldBase signer(@javax.annotation.Nullable String signer) {
    this.signer = signer;
    return this;
  }
  ...
  public TemplateResponseDocumentStaticFieldBase height(@javax.annotation.Nullable Integer height) {
    this.height = height;
    return this;
  }
  ...
  public TemplateResponseDocumentStaticFieldBase required(@javax.annotation.Nullable Boolean required) {
