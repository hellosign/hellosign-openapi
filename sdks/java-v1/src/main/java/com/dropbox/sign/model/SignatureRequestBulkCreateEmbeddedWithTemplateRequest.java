...
public class SignatureRequestBulkCreateEmbeddedWithTemplateRequest {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signerFile(@javax.annotation.Nullable File signerFile) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signerList(@javax.annotation.Nullable List<SubBulkSignerList> signerList) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestBulkCreateEmbeddedWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
