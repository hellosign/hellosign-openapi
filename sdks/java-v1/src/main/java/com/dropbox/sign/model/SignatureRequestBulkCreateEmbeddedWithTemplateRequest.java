...
public class SignatureRequestBulkCreateEmbeddedWithTemplateRequest {
     ...
     */
    public static SignatureRequestBulkCreateEmbeddedWithTemplateRequest init(String jsonData)
            throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, SignatureRequestBulkCreateEmbeddedWithTemplateRequest.class);
    }

    public static SignatureRequestBulkCreateEmbeddedWithTemplateRequest init(HashMap data)
            throws Exception {
        return new ObjectMapper()
                .readValue(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest templateIds(
            @javax.annotation.Nonnull List<String> templateIds) {
        this.templateIds = templateIds;
        return this;
    }

    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest addTemplateIdsItem(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest clientId(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signerFile(
    ...
    /**
     * &#x60;signer_file&#x60; is a CSV file defining values and options for signer fields. Required
     * unless a &#x60;signer_list&#x60; is used, you may not use both. The CSV can have the
     * following columns: - &#x60;name&#x60;: the name of the signer filling the role of RoleName -
     * &#x60;email_address&#x60;: email address of the signer filling the role of RoleName -
     * &#x60;pin&#x60;: the 4- to 12-character access code that will secure this signer&#39;s
     * signature page (optional) - &#x60;sms_phone_number&#x60;: An E.164 formatted phone number
     * that will receive a code via SMS to access this signer&#39;s signature page. (optional) By
     * using the feature, you agree you are responsible for obtaining a signer&#39;s consent to
     * receive text messages from Dropbox Sign related to this signature request and confirm you
     * have obtained such consent from all signers prior to enabling SMS delivery for this signature
     * request. [Learn
     ...
     * &#x60;*_field&#x60;: any column with a _field\&quot; suffix will be treated as a custom field
     * (optional) You may only specify field values here, any other options should be set in the
     * custom_fields request parameter. Example CSV: &#x60;&#x60;&#x60; name, email_address, pin,
     * company_field George, george@example.com, d79a3td, ABC Corp Mary, mary@example.com, gd9as5b,
     * 123 LLC &#x60;&#x60;&#x60;
     *
     * @return signerFile
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_FILE)
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signerList(
            @javax.annotation.Nullable List<SubBulkSignerList> signerList) {
        this.signerList = signerList;
        return this;
    }

    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest addSignerListItem(
            SubBulkSignerList signerListItem) {
    ...
    /**
     * &#x60;signer_list&#x60; is an array defining values and options for signer fields. Required
     * unless a &#x60;signer_file&#x60; is used, you may not use both.
     *
     * @return signerList
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_SIGNER_LIST)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest allowDecline(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest ccs(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest customFields(
            @javax.annotation.Nullable List<SubCustomField> customFields) {
        this.customFields = customFields;
        return this;
    }

    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest addCustomFieldsItem(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest message(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest metadata(
            @javax.annotation.Nullable Map<String, Object> metadata) {
        this.metadata = metadata;
        return this;
    }

    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest putMetadataItem(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest signingRedirectUrl(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest subject(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest testMode(
    ...
    public SignatureRequestBulkCreateEmbeddedWithTemplateRequest title(
    ...
    public boolean equals(Object o) {
        ...
        SignatureRequestBulkCreateEmbeddedWithTemplateRequest
                signatureRequestBulkCreateEmbeddedWithTemplateRequest =
                        (SignatureRequestBulkCreateEmbeddedWithTemplateRequest) o;
        return Objects.equals(
                        this.templateIds,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.templateIds)
                && Objects.equals(
                        this.clientId,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.clientId)
                && Objects.equals(
                        this.signerFile,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.signerFile)
                && Objects.equals(
                        this.signerList,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.signerList)
                && Objects.equals(
                        this.allowDecline,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.allowDecline)
                && Objects.equals(
                        this.ccs, signatureRequestBulkCreateEmbeddedWithTemplateRequest.ccs)
                && Objects.equals(
                        this.customFields,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.customFields)
                && Objects.equals(
                        this.message, signatureRequestBulkCreateEmbeddedWithTemplateRequest.message)
                && Objects.equals(
                        this.metadata,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.metadata)
                && Objects.equals(
                        this.signingRedirectUrl,
                        signatureRequestBulkCreateEmbeddedWithTemplateRequest.signingRedirectUrl)
                && Objects.equals(
                        this.subject, signatureRequestBulkCreateEmbeddedWithTemplateRequest.subject)
                && Objects.equals(
                        this.testMode,
        ...
        try {
            ...
            if (signerFile != null) {
                ...
                if (signerFile.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signer_file",
                            JSON.getDefault().getMapper().writeValueAsString(signerFile));
                }
            }
            if (signerList != null) {
                ...
                if (signerList.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "signer_list",
                            JSON.getDefault().getMapper().writeValueAsString(signerList));
                }
            }
