...
public class ApiAppUpdateRequest {
  ...
  public ApiAppUpdateRequest whiteLabelingOptions(@javax.annotation.Nullable SubWhiteLabelingOptions whiteLabelingOptions) {
  ...
  @JsonProperty(JSON_PROPERTY_WHITE_LABELING_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWhiteLabelingOptions(@javax.annotation.Nullable SubWhiteLabelingOptions whiteLabelingOptions) {
    this.whiteLabelingOptions = whiteLabelingOptions;
  }
