...
public class ApiAppUpdateRequest {
     ...
     */
    public static ApiAppUpdateRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, ApiAppUpdateRequest.class);
    }

    public static ApiAppUpdateRequest init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(new ObjectMapper().writeValueAsString(data), ApiAppUpdateRequest.class);
    }

    public ApiAppUpdateRequest callbackUrl(@javax.annotation.Nullable String callbackUrl) {
    ...
    public ApiAppUpdateRequest customLogoFile(@javax.annotation.Nullable File customLogoFile) {
     ...
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_CUSTOM_LOGO_FILE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public ApiAppUpdateRequest domains(@javax.annotation.Nullable List<String> domains) {
    ...
    public ApiAppUpdateRequest name(@javax.annotation.Nullable String name) {
        this.name = name;
        return this;
    }
    ...
    public ApiAppUpdateRequest oauth(@javax.annotation.Nullable SubOAuth oauth) {
        this.oauth = oauth;
        return this;
    }
    ...
    public ApiAppUpdateRequest options(@javax.annotation.Nullable SubOptions options) {
    ...
    public ApiAppUpdateRequest whiteLabelingOptions(
     ...
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_WHITE_LABELING_OPTIONS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        return Objects.equals(this.callbackUrl, apiAppUpdateRequest.callbackUrl)
                ...
                && Objects.equals(
                        this.whiteLabelingOptions, apiAppUpdateRequest.whiteLabelingOptions);
    }

    @Override
    public int hashCode() {
        return Objects.hash(
                callbackUrl, customLogoFile, domains, name, oauth, options, whiteLabelingOptions);
    }
        ...
        try {
            ...
            if (customLogoFile != null) {
                ...
                if (customLogoFile.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "custom_logo_file",
                            JSON.getDefault().getMapper().writeValueAsString(customLogoFile));
                }
            }
            if (domains != null) {
            ...
            if (whiteLabelingOptions != null) {
                ...
                if (whiteLabelingOptions.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(whiteLabelingOptions); i++) {
                        map.put(
                                "white_labeling_options[" + i + "]",
                                getFromList(whiteLabelingOptions, i));
                    }
                } else {
                    map.put(
                            "white_labeling_options",
                            JSON.getDefault().getMapper().writeValueAsString(whiteLabelingOptions));
                }
            }
        } catch (Exception e) {
