...
public class TemplateResponseDocumentFormFieldCheckbox
     ...
     */
    public static TemplateResponseDocumentFormFieldCheckbox init(String jsonData) throws Exception {
        return new ObjectMapper()
                .readValue(jsonData, TemplateResponseDocumentFormFieldCheckbox.class);
    }

    public static TemplateResponseDocumentFormFieldCheckbox init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(
    ...
    static {
        ...
        JSON.registerDiscriminator(
                TemplateResponseDocumentFormFieldCheckbox.class, "type", mappings);
    }
}
