...
public class UnclaimedDraftCreateEmbeddedWithTemplateRequest {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest requesterEmailAddress(@javax.annotation.Nonnull String requesterEmailAddress) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest allowReassign(@javax.annotation.Nullable Boolean allowReassign) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest editorOptions(@javax.annotation.Nullable SubEditorOptions editorOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest forceSignerRoles(@javax.annotation.Nullable Boolean forceSignerRoles) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest forceSubjectMessage(@javax.annotation.Nullable Boolean forceSubjectMessage) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest holdRequest(@javax.annotation.Nullable Boolean holdRequest) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest isForEmbeddedSigning(@javax.annotation.Nullable Boolean isForEmbeddedSigning) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest previewOnly(@javax.annotation.Nullable Boolean previewOnly) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest requestingRedirectUrl(@javax.annotation.Nullable String requestingRedirectUrl) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest showPreview(@javax.annotation.Nullable Boolean showPreview) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest showProgressStepper(@javax.annotation.Nullable Boolean showProgressStepper) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest signers(@javax.annotation.Nullable List<SubUnclaimedDraftTemplateSigner> signers) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNERS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSigners(@javax.annotation.Nullable List<SubUnclaimedDraftTemplateSigner> signers) {
    this.signers = signers;
  }


  public UnclaimedDraftCreateEmbeddedWithTemplateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest skipMeNow(@javax.annotation.Nullable Boolean skipMeNow) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest populateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
  ...
  public UnclaimedDraftCreateEmbeddedWithTemplateRequest allowCcs(@javax.annotation.Nullable Boolean allowCcs) {
