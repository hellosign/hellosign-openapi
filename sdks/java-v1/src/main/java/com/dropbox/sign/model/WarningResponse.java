...
public class WarningResponse {
     ...
     */
    public static WarningResponse init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, WarningResponse.class);
    }

    public static WarningResponse init(HashMap data) throws Exception {
        ...
        try {
            if (warningMsg != null) {
                ...
                if (warningMsg.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "warning_msg",
                            JSON.getDefault().getMapper().writeValueAsString(warningMsg));
                }
            }
            if (warningName != null) {
                ...
                if (warningName.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "warning_name",
                            JSON.getDefault().getMapper().writeValueAsString(warningName));
                }
            }
        } catch (Exception e) {
