...
public class SignatureRequestResponseCustomFieldBase {
  ...
  public SignatureRequestResponseCustomFieldBase required(@javax.annotation.Nullable Boolean required) {
  ...
  public SignatureRequestResponseCustomFieldBase editor(@javax.annotation.Nullable String editor) {
    this.editor = editor;
    return this;
  }
