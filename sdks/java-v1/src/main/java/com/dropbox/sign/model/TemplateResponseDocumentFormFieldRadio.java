...
public class TemplateResponseDocumentFormFieldRadio extends TemplateResponseDocumentFormFieldBase {
     ...
     */
    public static TemplateResponseDocumentFormFieldRadio init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateResponseDocumentFormFieldRadio.class);
    }

    public static TemplateResponseDocumentFormFieldRadio init(HashMap data) throws Exception {
