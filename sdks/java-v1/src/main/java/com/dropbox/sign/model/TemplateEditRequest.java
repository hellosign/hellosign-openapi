...
public class TemplateEditRequest {
     ...
     */
    public static TemplateEditRequest init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, TemplateEditRequest.class);
    }

    public static TemplateEditRequest init(HashMap data) throws Exception {
        return new ObjectMapper()
                .readValue(new ObjectMapper().writeValueAsString(data), TemplateEditRequest.class);
    }
