...
@JsonPropertyOrder({
    ...
    TemplateCreateEmbeddedDraftRequest.JSON_PROPERTY_IGNORE_TEXT_TAGS_EXTRACTION_ERRORS
})
...
public class TemplateCreateEmbeddedDraftRequest {
     ...
     * @return mergeFields
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_MERGE_FIELDS)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public TemplateCreateEmbeddedDraftRequest ignoreTextTagsExtractionErrors(
