...
public class TemplateCreateEmbeddedDraftRequest {
  ...
  public TemplateCreateEmbeddedDraftRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public TemplateCreateEmbeddedDraftRequest allowCcs(@javax.annotation.Nullable Boolean allowCcs) {
  ...
  public TemplateCreateEmbeddedDraftRequest allowReassign(@javax.annotation.Nullable Boolean allowReassign) {
  ...
  public TemplateCreateEmbeddedDraftRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
  ...
  public TemplateCreateEmbeddedDraftRequest attachments(@javax.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public TemplateCreateEmbeddedDraftRequest ccRoles(@javax.annotation.Nullable List<String> ccRoles) {
  ...
  public TemplateCreateEmbeddedDraftRequest editorOptions(@javax.annotation.Nullable SubEditorOptions editorOptions) {
  ...
  public TemplateCreateEmbeddedDraftRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public TemplateCreateEmbeddedDraftRequest forceSignerRoles(@javax.annotation.Nullable Boolean forceSignerRoles) {
  ...
  public TemplateCreateEmbeddedDraftRequest forceSubjectMessage(@javax.annotation.Nullable Boolean forceSubjectMessage) {
  ...
  public TemplateCreateEmbeddedDraftRequest formFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
  ...
  public TemplateCreateEmbeddedDraftRequest formFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  public TemplateCreateEmbeddedDraftRequest formFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
  ...
  public TemplateCreateEmbeddedDraftRequest mergeFields(@javax.annotation.Nullable List<SubMergeField> mergeFields) {
  ...
  public TemplateCreateEmbeddedDraftRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public TemplateCreateEmbeddedDraftRequest showPreview(@javax.annotation.Nullable Boolean showPreview) {
  ...
  public TemplateCreateEmbeddedDraftRequest showProgressStepper(@javax.annotation.Nullable Boolean showProgressStepper) {
  ...
  public TemplateCreateEmbeddedDraftRequest signerRoles(@javax.annotation.Nullable List<SubTemplateRole> signerRoles) {
  ...
  public TemplateCreateEmbeddedDraftRequest skipMeNow(@javax.annotation.Nullable Boolean skipMeNow) {
  ...
  public TemplateCreateEmbeddedDraftRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public TemplateCreateEmbeddedDraftRequest usePreexistingFields(@javax.annotation.Nullable Boolean usePreexistingFields) {
