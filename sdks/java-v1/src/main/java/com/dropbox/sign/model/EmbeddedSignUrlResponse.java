...
public class EmbeddedSignUrlResponse {
  ...
  public EmbeddedSignUrlResponse embedded(@javax.annotation.Nonnull EmbeddedSignUrlResponseEmbedded embedded) {
  ...
  public EmbeddedSignUrlResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
