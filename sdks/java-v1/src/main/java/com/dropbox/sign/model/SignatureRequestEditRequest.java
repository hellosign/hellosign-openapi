...
public class SignatureRequestEditRequest {
  ...
  public SignatureRequestEditRequest signers(@javax.annotation.Nullable List<SubSignatureRequestSigner> signers) {
  ...
  public SignatureRequestEditRequest groupedSigners(@javax.annotation.Nullable List<SubSignatureRequestGroupedSigners> groupedSigners) {
  ...
  public SignatureRequestEditRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestEditRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
  ...
  public SignatureRequestEditRequest allowReassign(@javax.annotation.Nullable Boolean allowReassign) {
  ...
  public SignatureRequestEditRequest attachments(@javax.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public SignatureRequestEditRequest ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public SignatureRequestEditRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestEditRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public SignatureRequestEditRequest formFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
  ...
  public SignatureRequestEditRequest formFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  public SignatureRequestEditRequest formFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
  ...
  public SignatureRequestEditRequest hideTextTags(@javax.annotation.Nullable Boolean hideTextTags) {
  ...
  public SignatureRequestEditRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestEditRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
