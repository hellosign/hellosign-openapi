...
public class ApiAppResponse {
  ...
  public ApiAppResponse ownerAccount(@javax.annotation.Nullable ApiAppResponseOwnerAccount ownerAccount) {
  ...
  @JsonProperty(JSON_PROPERTY_OWNER_ACCOUNT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setOwnerAccount(@javax.annotation.Nullable ApiAppResponseOwnerAccount ownerAccount) {
    this.ownerAccount = ownerAccount;
  }


  public ApiAppResponse whiteLabelingOptions(@javax.annotation.Nullable ApiAppResponseWhiteLabelingOptions whiteLabelingOptions) {
  ...
  @JsonProperty(JSON_PROPERTY_WHITE_LABELING_OPTIONS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setWhiteLabelingOptions(@javax.annotation.Nullable ApiAppResponseWhiteLabelingOptions whiteLabelingOptions) {
    this.whiteLabelingOptions = whiteLabelingOptions;
  }
