...
public class SignatureRequestListResponse {
  ...
  public SignatureRequestListResponse signatureRequests(@javax.annotation.Nonnull List<SignatureRequestResponse> signatureRequests) {
  ...
  @JsonProperty(JSON_PROPERTY_SIGNATURE_REQUESTS)
  @JsonInclude(value = JsonInclude.Include.ALWAYS)
  public void setSignatureRequests(@javax.annotation.Nonnull List<SignatureRequestResponse> signatureRequests) {
    this.signatureRequests = signatureRequests;
  }


  public SignatureRequestListResponse listInfo(@javax.annotation.Nonnull ListInfoResponse listInfo) {
  ...
  public SignatureRequestListResponse warnings(@javax.annotation.Nullable List<WarningResponse> warnings) {
