...
public class SubFormFieldRule {
  ...
  public SubFormFieldRule triggers(@javax.annotation.Nonnull List<SubFormFieldRuleTrigger> triggers) {
  ...
  public SubFormFieldRule actions(@javax.annotation.Nonnull List<SubFormFieldRuleAction> actions) {
