...
public class SubFormFieldRule {
    ...
    /**
     * An array of trigger definitions, the \&quot;if this\&quot; part of \&quot;**if this**, then
     * that\&quot;. Currently only a single trigger per rule is allowed.
     *
     * @return triggers
     */
    @javax.annotation.Nonnull
    ...
    /**
     * An array of action definitions, the \&quot;then that\&quot; part of \&quot;if this, **then
     * that**\&quot;. Any number of actions may be attached to a single rule.
     *
     * @return actions
     */
    @javax.annotation.Nonnull
        ...
        try {
            ...
            if (triggerOperator != null) {
                ...
                if (triggerOperator.getClass().equals(java.io.File.class)
                    ...
                    map.put(
                            "trigger_operator",
                            JSON.getDefault().getMapper().writeValueAsString(triggerOperator));
                }
            }
            if (triggers != null) {
