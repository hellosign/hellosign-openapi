...
public class SignatureRequestBulkSendWithTemplateRequest {
  ...
  public SignatureRequestBulkSendWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest signerFile(@javax.annotation.Nullable File signerFile) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest signerList(@javax.annotation.Nullable List<SubBulkSignerList> signerList) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestBulkSendWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestBulkSendWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
