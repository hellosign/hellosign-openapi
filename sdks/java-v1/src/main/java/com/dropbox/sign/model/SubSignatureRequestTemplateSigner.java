...
public class SubSignatureRequestTemplateSigner {
  ...
  public SubSignatureRequestTemplateSigner emailAddress(@javax.annotation.Nonnull String emailAddress) {
  ...
  public SubSignatureRequestTemplateSigner smsPhoneNumber(@javax.annotation.Nullable String smsPhoneNumber) {
  ...
  public SubSignatureRequestTemplateSigner smsPhoneNumberType(@javax.annotation.Nullable SmsPhoneNumberTypeEnum smsPhoneNumberType) {
  ...
  @JsonProperty(JSON_PROPERTY_SMS_PHONE_NUMBER_TYPE)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setSmsPhoneNumberType(@javax.annotation.Nullable SmsPhoneNumberTypeEnum smsPhoneNumberType) {
    this.smsPhoneNumberType = smsPhoneNumberType;
  }
