...
public class SubSignatureRequestTemplateSigner {
     ...
     * &#x60;authentication&#x60;. If &#x60;authentication&#x60;, signer is sent a verification code
     * via SMS that is required to access the document. If &#x60;delivery&#x60;, a link to complete
    ...
    public SubSignatureRequestTemplateSigner role(@javax.annotation.Nonnull String role) {
        this.role = role;
        return this;
    }
    ...
    public SubSignatureRequestTemplateSigner name(@javax.annotation.Nonnull String name) {
        this.name = name;
        return this;
    }
    ...
    public SubSignatureRequestTemplateSigner emailAddress(
    ...
    public SubSignatureRequestTemplateSigner pin(@javax.annotation.Nullable String pin) {
        this.pin = pin;
        return this;
    }
    ...
    public SubSignatureRequestTemplateSigner smsPhoneNumber(
    ...
    /**
     * An E.164 formatted phone number. By using the feature, you agree you are responsible for
     * obtaining a signer&#39;s consent to receive text messages from Dropbox Sign related to this
     * signature request and confirm you have obtained such consent from all signers prior to
     * enabling SMS delivery for this signature request. [Learn
    ...
    public SubSignatureRequestTemplateSigner smsPhoneNumberType(
     ...
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_SMS_PHONE_NUMBER_TYPE)
    @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
    ...
    public boolean equals(Object o) {
        ...
        SubSignatureRequestTemplateSigner subSignatureRequestTemplateSigner =
                (SubSignatureRequestTemplateSigner) o;
        return Objects.equals(this.role, subSignatureRequestTemplateSigner.role)
                ...
                && Objects.equals(
                        this.smsPhoneNumber, subSignatureRequestTemplateSigner.smsPhoneNumber)
                && Objects.equals(
                        this.smsPhoneNumberType,
                        subSignatureRequestTemplateSigner.smsPhoneNumberType);
    }
    ...
    public String toString() {
        ...
        sb.append("    smsPhoneNumberType: ")
                .append(toIndentedString(smsPhoneNumberType))
                .append("\n");
        sb.append("}");
        return sb.toString();
    }
            ...
            if (smsPhoneNumberType != null) {
                ...
                if (smsPhoneNumberType.getClass().equals(java.io.File.class)
                    ...
                    for (int i = 0; i < getListSize(smsPhoneNumberType); i++) {
                        map.put(
                                "sms_phone_number_type[" + i + "]",
                                getFromList(smsPhoneNumberType, i));
                    }
                } else {
                    map.put(
                            "sms_phone_number_type",
                            JSON.getDefault().getMapper().writeValueAsString(smsPhoneNumberType));
                }
            }
        } catch (Exception e) {
