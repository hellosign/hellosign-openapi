...
public class UnclaimedDraftCreateEmbeddedRequest {
  ...
  public UnclaimedDraftCreateEmbeddedRequest requesterEmailAddress(@javax.annotation.Nonnull String requesterEmailAddress) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest allowCcs(@javax.annotation.Nullable Boolean allowCcs) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest allowReassign(@javax.annotation.Nullable Boolean allowReassign) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest attachments(@javax.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest editorOptions(@javax.annotation.Nullable SubEditorOptions editorOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest forceSignerPage(@javax.annotation.Nullable Boolean forceSignerPage) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest forceSubjectMessage(@javax.annotation.Nullable Boolean forceSubjectMessage) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest formFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
  ...
  @JsonProperty(JSON_PROPERTY_FORM_FIELD_GROUPS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
    this.formFieldGroups = formFieldGroups;
  }


  public UnclaimedDraftCreateEmbeddedRequest formFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  @JsonProperty(JSON_PROPERTY_FORM_FIELD_RULES)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
    this.formFieldRules = formFieldRules;
  }


  public UnclaimedDraftCreateEmbeddedRequest formFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
  ...
  @JsonProperty(JSON_PROPERTY_FORM_FIELDS_PER_DOCUMENT)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setFormFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
    this.formFieldsPerDocument = formFieldsPerDocument;
  }


  public UnclaimedDraftCreateEmbeddedRequest hideTextTags(@javax.annotation.Nullable Boolean hideTextTags) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest holdRequest(@javax.annotation.Nullable Boolean holdRequest) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest isForEmbeddedSigning(@javax.annotation.Nullable Boolean isForEmbeddedSigning) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest requestingRedirectUrl(@javax.annotation.Nullable String requestingRedirectUrl) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest showPreview(@javax.annotation.Nullable Boolean showPreview) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest showProgressStepper(@javax.annotation.Nullable Boolean showProgressStepper) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest signers(@javax.annotation.Nullable List<SubUnclaimedDraftSigner> signers) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest signingRedirectUrl(@javax.annotation.Nullable String signingRedirectUrl) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest skipMeNow(@javax.annotation.Nullable Boolean skipMeNow) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest usePreexistingFields(@javax.annotation.Nullable Boolean usePreexistingFields) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest useTextTags(@javax.annotation.Nullable Boolean useTextTags) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest populateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
  ...
  public UnclaimedDraftCreateEmbeddedRequest expiresAt(@javax.annotation.Nullable Integer expiresAt) {
