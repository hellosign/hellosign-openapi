...
public class SubCC {
     ...
     */
    public static SubCC init(String jsonData) throws Exception {
        return new ObjectMapper().readValue(jsonData, SubCC.class);
    }

    public static SubCC init(HashMap data) throws Exception {
    ...
    /**
     * Must match an existing CC role in chosen Template(s). Multiple CC recipients cannot share the
     * same CC role.
     *
     * @return role
     */
