...
public class FaxApi {
    ...
    /**
     * Create Fax Draft Creates a Fax draft and returns a URL for preparing and sending the Fax.
     * When &#x60;client_id&#x60; is provided, the draft is embedded and the returned URL must be
     * opened in an approved iframe. When &#x60;client_id&#x60; is omitted, the draft is a normal
     * Fax draft that opens in Dropbox Fax.
     *
