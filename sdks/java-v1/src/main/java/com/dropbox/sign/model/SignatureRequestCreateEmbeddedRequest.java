...
public class SignatureRequestCreateEmbeddedRequest {
  ...
  public SignatureRequestCreateEmbeddedRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public SignatureRequestCreateEmbeddedRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestCreateEmbeddedRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public SignatureRequestCreateEmbeddedRequest signers(@javax.annotation.Nullable List<SubSignatureRequestSigner> signers) {
  ...
  public SignatureRequestCreateEmbeddedRequest groupedSigners(@javax.annotation.Nullable List<SubSignatureRequestGroupedSigners> groupedSigners) {
  ...
  public SignatureRequestCreateEmbeddedRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestCreateEmbeddedRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
  ...
  public SignatureRequestCreateEmbeddedRequest allowReassign(@javax.annotation.Nullable Boolean allowReassign) {
  ...
  public SignatureRequestCreateEmbeddedRequest attachments(@javax.annotation.Nullable List<SubAttachment> attachments) {
  ...
  public SignatureRequestCreateEmbeddedRequest ccEmailAddresses(@javax.annotation.Nullable List<String> ccEmailAddresses) {
  ...
  public SignatureRequestCreateEmbeddedRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestCreateEmbeddedRequest fieldOptions(@javax.annotation.Nullable SubFieldOptions fieldOptions) {
  ...
  public SignatureRequestCreateEmbeddedRequest formFieldGroups(@javax.annotation.Nullable List<SubFormFieldGroup> formFieldGroups) {
  ...
  public SignatureRequestCreateEmbeddedRequest formFieldRules(@javax.annotation.Nullable List<SubFormFieldRule> formFieldRules) {
  ...
  public SignatureRequestCreateEmbeddedRequest formFieldsPerDocument(@javax.annotation.Nullable List<SubFormFieldsPerDocumentBase> formFieldsPerDocument) {
  ...
  public SignatureRequestCreateEmbeddedRequest hideTextTags(@javax.annotation.Nullable Boolean hideTextTags) {
  ...
  public SignatureRequestCreateEmbeddedRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestCreateEmbeddedRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestCreateEmbeddedRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestCreateEmbeddedRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestCreateEmbeddedRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestCreateEmbeddedRequest useTextTags(@javax.annotation.Nullable Boolean useTextTags) {
  ...
  public SignatureRequestCreateEmbeddedRequest populateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
  ...
  public SignatureRequestCreateEmbeddedRequest expiresAt(@javax.annotation.Nullable Integer expiresAt) {
