...
public class SignatureRequestCreateEmbeddedWithTemplateRequest {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest clientId(@javax.annotation.Nonnull String clientId) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest signers(@javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
  ...
  public SignatureRequestCreateEmbeddedWithTemplateRequest populateAutoFillFields(@javax.annotation.Nullable Boolean populateAutoFillFields) {
