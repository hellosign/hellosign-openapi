...
public class EmbeddedEditUrlRequest {
  ...
  public EmbeddedEditUrlRequest editorOptions(@javax.annotation.Nullable SubEditorOptions editorOptions) {
  ...
  public EmbeddedEditUrlRequest forceSignerRoles(@javax.annotation.Nullable Boolean forceSignerRoles) {
  ...
  public EmbeddedEditUrlRequest forceSubjectMessage(@javax.annotation.Nullable Boolean forceSubjectMessage) {
  ...
  public EmbeddedEditUrlRequest mergeFields(@javax.annotation.Nullable List<SubMergeField> mergeFields) {
  ...
  public EmbeddedEditUrlRequest showProgressStepper(@javax.annotation.Nullable Boolean showProgressStepper) {
