...
public class EmbeddedEditUrlRequest {
     ...
     * @return allowEditCcs
     */
    @javax.annotation.Nullable @JsonProperty(JSON_PROPERTY_ALLOW_EDIT_CCS)
    ...
    public EmbeddedEditUrlRequest allowFormView(@javax.annotation.Nullable Boolean allowFormView) {
