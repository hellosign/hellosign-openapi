...
public class SignatureRequestEditWithTemplateRequest {
  ...
  public SignatureRequestEditWithTemplateRequest templateIds(@javax.annotation.Nonnull List<String> templateIds) {
  ...
  public SignatureRequestEditWithTemplateRequest signers(@javax.annotation.Nonnull List<SubSignatureRequestTemplateSigner> signers) {
  ...
  public SignatureRequestEditWithTemplateRequest allowDecline(@javax.annotation.Nullable Boolean allowDecline) {
  ...
  public SignatureRequestEditWithTemplateRequest ccs(@javax.annotation.Nullable List<SubCC> ccs) {
    this.ccs = ccs;
    return this;
  }
  ...
  public SignatureRequestEditWithTemplateRequest customFields(@javax.annotation.Nullable List<SubCustomField> customFields) {
  ...
  public SignatureRequestEditWithTemplateRequest files(@javax.annotation.Nullable List<File> files) {
    this.files = files;
    return this;
  }
  ...
  public SignatureRequestEditWithTemplateRequest fileUrls(@javax.annotation.Nullable List<String> fileUrls) {
  ...
  public SignatureRequestEditWithTemplateRequest isEid(@javax.annotation.Nullable Boolean isEid) {
    this.isEid = isEid;
    return this;
  }
  ...
  public SignatureRequestEditWithTemplateRequest message(@javax.annotation.Nullable String message) {
  ...
  public SignatureRequestEditWithTemplateRequest metadata(@javax.annotation.Nullable Map<String, Object> metadata) {
  ...
  public SignatureRequestEditWithTemplateRequest signingOptions(@javax.annotation.Nullable SubSigningOptions signingOptions) {
  ...
  public SignatureRequestEditWithTemplateRequest subject(@javax.annotation.Nullable String subject) {
  ...
  public SignatureRequestEditWithTemplateRequest testMode(@javax.annotation.Nullable Boolean testMode) {
  ...
  public SignatureRequestEditWithTemplateRequest title(@javax.annotation.Nullable String title) {
    this.title = title;
    return this;
  }
