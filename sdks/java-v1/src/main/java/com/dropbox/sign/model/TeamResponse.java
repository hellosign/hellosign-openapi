...
public class TeamResponse {
  ...
  public TeamResponse invitedAccounts(@javax.annotation.Nullable List<AccountResponse> invitedAccounts) {
  ...
  @JsonProperty(JSON_PROPERTY_INVITED_ACCOUNTS)
  @JsonInclude(value = JsonInclude.Include.USE_DEFAULTS)
  public void setInvitedAccounts(@javax.annotation.Nullable List<AccountResponse> invitedAccounts) {
    this.invitedAccounts = invitedAccounts;
  }
