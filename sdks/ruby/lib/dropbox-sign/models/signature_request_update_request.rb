...
module Dropbox::Sign
  class SignatureRequestUpdateRequest
    ...
    def self.init(data)
      ...
      ) || SignatureRequestUpdateRequest.new
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Dropbox::Sign::SignatureRequestUpdateRequest` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.merged_attributes.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Dropbox::Sign::SignatureRequestUpdateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] signature_id Value to be assigned
    def signature_id=(signature_id)
      if signature_id.nil?
        fail ArgumentError, 'signature_id cannot be nil'
      end
