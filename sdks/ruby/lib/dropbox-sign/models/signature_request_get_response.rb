...
module Dropbox::Sign
  class SignatureRequestGetResponse
    ...
    def self.init(data)
      ...
      ) || SignatureRequestGetResponse.new
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Dropbox::Sign::SignatureRequestGetResponse` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.merged_attributes.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Dropbox::Sign::SignatureRequestGetResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] signature_request Value to be assigned
    def signature_request=(signature_request)
      if signature_request.nil?
        fail ArgumentError, 'signature_request cannot be nil'
      end
