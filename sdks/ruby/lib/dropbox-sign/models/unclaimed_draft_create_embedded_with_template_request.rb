...
module Dropbox::Sign
  class UnclaimedDraftCreateEmbeddedWithTemplateRequest
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.merged_attributes.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Dropbox::Sign::UnclaimedDraftCreateEmbeddedWithTemplateRequest`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # Custom attribute writer method with validation
    # @param [Object] requester_email_address Value to be assigned
    def requester_email_address=(requester_email_address)
      if requester_email_address.nil?
        fail ArgumentError, 'requester_email_address cannot be nil'
      end
