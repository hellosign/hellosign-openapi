...
module Dropbox::Sign
  ...
  class WarningResponse
    ...
    def initialize(attributes = {})
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.merged_attributes.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Dropbox::Sign::WarningResponse`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    # @param [Object] warning_msg Value to be assigned
    def warning_msg=(warning_msg)
      if warning_msg.nil?
        fail ArgumentError, 'warning_msg cannot be nil'
      end
    ...
    # Custom attribute writer method with validation
    # @param [Object] warning_name Value to be assigned
    def warning_name=(warning_name)
      if warning_name.nil?
        fail ArgumentError, 'warning_name cannot be nil'
      end
