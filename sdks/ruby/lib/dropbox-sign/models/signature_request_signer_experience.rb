...
module Dropbox::Sign
  ...
  class SignatureRequestSignerExperience
    ...
    def self.init(data)
      ...
      ) || SignatureRequestSignerExperience.new
    end
    ...
    def initialize(attributes = {})
      if (!attributes.is_a?(Hash))
        fail ArgumentError, "The input argument (attributes) must be a hash in `Dropbox::Sign::SignatureRequestSignerExperience` initialize method"
      end
      ...
      attributes = attributes.each_with_object({}) { |(k, v), h|
        if (!self.class.merged_attributes.key?(k.to_sym))
          fail ArgumentError, "`#{k}` is not a valid attribute in `Dropbox::Sign::SignatureRequestSignerExperience`. Please check the name to make sure it's valid. List of attributes: " + acceptable_attribute_map.keys.inspect
        end
        h[k.to_sym] = v
      }
    ...
    def list_invalid_properties
      ...
      if @form_view.nil?
        invalid_properties.push('invalid value for "form_view", form_view cannot be nil.')
      end
