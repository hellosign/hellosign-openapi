...
```shell
gem install ./dropbox-sign-1.2-dev.gem
```

(for development, run `gem install --dev ./dropbox-sign-1.2-dev.gem` to install the development dependencies)

Finally add this to the Gemfile:

    gem 'dropbox-sign', '~> 1.2-dev'
...
|*Dropbox::Sign::SignatureRequestApi* | [**signature_request_edit**](docs/SignatureRequestApi.md#signature_request_edit) | **POST** /signature_request/edit/{signature_request_id} | Edit Signature Request |
