...
type _SubFormFieldsPerDocumentCheckboxMerge SubFormFieldsPerDocumentCheckboxMerge
...
func (o *SubFormFieldsPerDocumentCheckboxMerge) UnmarshalJSON(data []byte) (err error) {
	...
	varSubFormFieldsPerDocumentCheckboxMerge := _SubFormFieldsPerDocumentCheckboxMerge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubFormFieldsPerDocumentCheckboxMerge)

	if err != nil {
		return err
	}

	*o = SubFormFieldsPerDocumentCheckboxMerge(varSubFormFieldsPerDocumentCheckboxMerge)
