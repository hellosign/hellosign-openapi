...
type _SubFormFieldsPerDocumentHyperlink SubFormFieldsPerDocumentHyperlink
...
func (o *SubFormFieldsPerDocumentHyperlink) UnmarshalJSON(data []byte) (err error) {
	...
	varSubFormFieldsPerDocumentHyperlink := _SubFormFieldsPerDocumentHyperlink{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubFormFieldsPerDocumentHyperlink)

	if err != nil {
		return err
	}

	*o = SubFormFieldsPerDocumentHyperlink(varSubFormFieldsPerDocumentHyperlink)
