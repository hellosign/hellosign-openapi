...
func Test_openapi_AccountAPIService(t *testing.T) {
	...
	t.Run("Test AccountAPIService AccountCreate", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountAPI.AccountCreate(context.Background()).Execute()
	...
	t.Run("Test AccountAPIService AccountVerify", func(t *testing.T) {

		t.Skip("skip test")  // remove to run test

		resp, httpRes, err := apiClient.AccountAPI.AccountVerify(context.Background()).Execute()
