...
type _SubFormFieldsPerDocumentTextMerge SubFormFieldsPerDocumentTextMerge
...
func (o *SubFormFieldsPerDocumentTextMerge) UnmarshalJSON(data []byte) (err error) {
	...
	varSubFormFieldsPerDocumentTextMerge := _SubFormFieldsPerDocumentTextMerge{}

	decoder := json.NewDecoder(bytes.NewReader(data))
	decoder.DisallowUnknownFields()
	err = decoder.Decode(&varSubFormFieldsPerDocumentTextMerge)

	if err != nil {
		return err
	}

	*o = SubFormFieldsPerDocumentTextMerge(varSubFormFieldsPerDocumentTextMerge)
