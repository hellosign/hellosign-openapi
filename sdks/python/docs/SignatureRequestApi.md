...
with ApiClient(configuration) as api_client:
    ...
    try:
        response = signature_request_api.signature_request_edit_embedded(signature_request_id, data)
        pprint(response)
    except ApiException as e:
        print("Exception when calling Dropbox Sign API: %s\n" % e)
...
with ApiClient(configuration) as api_client:
    ...
    try:
        response = signature_request_api.signature_request_edit_embedded_with_template(signature_request_id, data)
        pprint(response)
    except ApiException as e:
        print("Exception when calling Dropbox Sign API: %s\n" % e)
