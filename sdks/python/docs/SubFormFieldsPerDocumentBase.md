...
| `width`<sup>*_required_</sup> | ```int``` |  _t__Sub::FormFieldsPerDocument::WIDTH  |  |
| `x`<sup>*_required_</sup> | ```int``` |  _t__Sub::FormFieldsPerDocument::X  |  |
| `y`<sup>*_required_</sup> | ```int``` |  _t__Sub::FormFieldsPerDocument::Y  |  |
