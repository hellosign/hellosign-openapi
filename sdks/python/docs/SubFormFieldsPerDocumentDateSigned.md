...
------------ | ------------- | ------------- | -------------
| `type`<sup>*_required_</sup> | ```str``` | REPLACE_ME_WITH_DESCRIPTION_BEGIN A date. Use the &#x60;SubFormFieldsPerDocumentDateSigned&#x60; class. REPLACE_ME_WITH_DESCRIPTION_END |  [default to 'date_signed'] |
