...
# Defining the host is optional and defaults to https://api.hellosign.com/v3
# See configuration.py for a list of all supported configuration parameters.
configuration = dropbox_sign.Configuration(
    host = "https://api.hellosign.com/v3"
)
...
with dropbox_sign.ApiClient(configuration) as api_client:
    ...
    api_instance = dropbox_sign.AccountApi(api_client)
    account_create_request = dropbox_sign.AccountCreateRequest() # AccountCreateRequest | 

    try:
        # Create Account
        api_response = api_instance.account_create(account_create_request)
