...
```shell
python3 -m pip install dropbox-sign==1.6-dev
```
...
|```FaxApi``` | [```delete_fax```](docs/FaxApi.md#delete_fax) | ```DELETE /fax/{fax_id}``` | Delete Fax|
```FaxApi``` | [```get_fax_by_id```](docs/FaxApi.md#get_fax_by_id) | ```GET /fax/{fax_id}``` | Get Fax|
```FaxApi``` | [```get_fax_files```](docs/FaxApi.md#get_fax_files) | ```GET /fax/files/{fax_id}``` | List Fax Files|
```FaxApi``` | [```list_faxes```](docs/FaxApi.md#list_faxes) | ```GET /fax/list``` | Lists Faxes|
```FaxApi``` | [```send_fax```](docs/FaxApi.md#send_fax) | ```POST /fax/send``` | Send Fax|
...
## Documentation For Models
 ...
 - [FaxResponseFax](docs/FaxResponseFax.md)
 - [FaxResponseFaxTransmission](docs/FaxResponseFaxTransmission.md)
