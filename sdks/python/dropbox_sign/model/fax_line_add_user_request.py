...
class FaxLineAddUserRequest(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> FaxLineAddUserRequest:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[FaxLineAddUserRequest],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, number, *args, **kwargs):  # noqa: E501
        """FaxLineAddUserRequest - a model defined in OpenAPI
