...
class EmbeddedSignUrlResponse(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> EmbeddedSignUrlResponse:
        """
    ...
    @property
    def embedded(self) -> EmbeddedSignUrlResponseEmbedded:
        return self.get("embedded")

    @embedded.setter
    def embedded(self, value: EmbeddedSignUrlResponseEmbedded):
        setattr(self, "embedded", value)
