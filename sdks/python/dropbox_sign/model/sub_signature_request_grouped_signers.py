...
class SubSignatureRequestGroupedSigners(ModelNormal):
    ...
    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, group, signers, *args, **kwargs):  # noqa: E501
        """SubSignatureRequestGroupedSigners - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            order (int, none_type): The order the group is required to sign in. Use this instead of Signer-level `order`.. [optional]  # noqa: E501
        """
    ...
    @convert_js_args_to_python_args
    def __init__(self, group, signers, *args, **kwargs):  # noqa: E501
        """SubSignatureRequestGroupedSigners - a model defined in OpenAPI
