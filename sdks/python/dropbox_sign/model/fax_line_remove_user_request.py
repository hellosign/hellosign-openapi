...
class FaxLineRemoveUserRequest(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> FaxLineRemoveUserRequest:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[FaxLineRemoveUserRequest],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, number, *args, **kwargs):  # noqa: E501
        """FaxLineRemoveUserRequest - a model defined in OpenAPI
