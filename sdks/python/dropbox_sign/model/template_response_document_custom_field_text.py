...
class TemplateResponseDocumentCustomFieldText(ModelComposed):
    ...
    @staticmethod
    def init(data: any) -> TemplateResponseDocumentCustomFieldText:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[TemplateResponseDocumentCustomFieldText],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateResponseDocumentCustomFieldText - a model defined in OpenAPI

        Keyword Args:
            type (str): The type of this Custom Field. Only `text` and `checkbox` are currently supported.  * Text uses `TemplateResponseDocumentCustomFieldText` * Checkbox uses `TemplateResponseDocumentCustomFieldCheckbox`. defaults to "text"  # noqa: E501
