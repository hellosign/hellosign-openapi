...
class TemplateResponseDocumentFieldGroupRule(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> TemplateResponseDocumentFieldGroupRule:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[TemplateResponseDocumentFieldGroupRule],
            _check_type=True,
        )
    ...
    def group_label(self) -> str:
        return self.get("group_label")

    @group_label.setter
    def group_label(self, value: str):
        setattr(self, "group_label", value)

    @classmethod
    @convert_js_args_to_python_args
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateResponseDocumentFieldGroupRule - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            group_label (str): Name of the group. [optional]  # noqa: E501
        """
