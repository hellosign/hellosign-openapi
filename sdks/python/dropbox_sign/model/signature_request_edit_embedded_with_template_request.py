...
class SignatureRequestEditEmbeddedWithTemplateRequest(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> SignatureRequestEditEmbeddedWithTemplateRequest:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[SignatureRequestEditEmbeddedWithTemplateRequest],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, template_ids, client_id, signers, *args, **kwargs):  # noqa: E501
        """SignatureRequestEditEmbeddedWithTemplateRequest - a model defined in OpenAPI
