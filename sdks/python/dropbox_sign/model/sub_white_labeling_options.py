...
class SubWhiteLabelingOptions(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> SubWhiteLabelingOptions:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[SubWhiteLabelingOptions],
            _check_type=True,
        )
    ...
    def reset_to_default(self) -> bool:
        return self.get("reset_to_default")

    @reset_to_default.setter
    def reset_to_default(self, value: bool):
        setattr(self, "reset_to_default", value)
