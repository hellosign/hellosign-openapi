...
class TemplateAddUserRequest(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> TemplateAddUserRequest:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[TemplateAddUserRequest],
            _check_type=True,
        )
    ...
    @property
    def skip_notification(self) -> bool:
        return self.get("skip_notification")

    @skip_notification.setter
    def skip_notification(self, value: bool):
        setattr(self, "skip_notification", value)
