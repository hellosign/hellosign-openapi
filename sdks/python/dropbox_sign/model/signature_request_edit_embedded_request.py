...
class SignatureRequestEditEmbeddedRequest(ModelNormal):
    ...
    @staticmethod
    def init(data: any) -> SignatureRequestEditEmbeddedRequest:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[SignatureRequestEditEmbeddedRequest],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, client_id, *args, **kwargs):  # noqa: E501
        """SignatureRequestEditEmbeddedRequest - a model defined in OpenAPI
        ...
        Keyword Args:
            ...
            grouped_signers ([SubSignatureRequestGroupedSigners]): Add Grouped Signers to your Signature Request.  This endpoint requires either **signers** or **grouped_signers**, but not both.  **NOTE**: When using a single group of signers, the group must include at least two signers; when using multiple groups, at least one of those groups must have two or more signers.. [optional]  # noqa: E501
