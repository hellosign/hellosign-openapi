...
class TemplateResponseDocumentStaticFieldCheckbox(ModelComposed):
    ...
    @staticmethod
    def init(data: any) -> TemplateResponseDocumentStaticFieldCheckbox:
        """
        ...
        return ApiClient().deserialize(
            ...
            response_type=[TemplateResponseDocumentStaticFieldCheckbox],
            _check_type=True,
        )
    ...
    def _from_openapi_data(cls, *args, **kwargs):  # noqa: E501
        """TemplateResponseDocumentStaticFieldCheckbox - a model defined in OpenAPI

        Keyword Args:
            type (str): The type of this static field. See [field types](/api/reference/constants/#field-types).  * Text Field uses `TemplateResponseDocumentStaticFieldText` * Dropdown Field uses `TemplateResponseDocumentStaticFieldDropdown` * Hyperlink Field uses `TemplateResponseDocumentStaticFieldHyperlink` * Checkbox Field uses `TemplateResponseDocumentStaticFieldCheckbox` * Radio Field uses `TemplateResponseDocumentStaticFieldRadio` * Signature Field uses `TemplateResponseDocumentStaticFieldSignature` * Date Signed Field uses `TemplateResponseDocumentStaticFieldDateSigned` * Initials Field uses `TemplateResponseDocumentStaticFieldInitials`. defaults to "checkbox"  # noqa: E501
