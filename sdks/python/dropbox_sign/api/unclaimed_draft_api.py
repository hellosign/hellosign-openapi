...
class UnclaimedDraftApi:
    ...
    def _unclaimed_draft_create_serialize(
        ...
        has_files = False
        body_param = unclaimed_draft_create_request
    ...
    def _unclaimed_draft_create_embedded_serialize(
        ...
        has_files = False
        body_param = unclaimed_draft_create_embedded_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
    ...
    def _unclaimed_draft_create_embedded_with_template_serialize(
        ...
        has_files = False
        body_param = unclaimed_draft_create_embedded_with_template_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
    ...
    def _unclaimed_draft_edit_and_resend_serialize(
        ...
        has_files = False
        body_param = unclaimed_draft_edit_and_resend_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
