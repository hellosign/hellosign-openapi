...
class FaxApi:
    ...
    @validate_call
    def fax_draft_create(
        self,
        fax_draft_create_request: FaxDraftCreateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        _param = self._fax_draft_create_serialize(
    ...
    @validate_call
    def fax_draft_create_with_http_info(
        self,
        fax_draft_create_request: FaxDraftCreateRequest,
        _request_timeout: Union[
            None,
    ...
    @validate_call
    def fax_draft_create_without_preload_content(
        self,
        fax_draft_create_request: FaxDraftCreateRequest,
        _request_timeout: Union[
            None,
    ...
    def _fax_draft_create_serialize(
        self,
        ...
        has_files = False
        body_param = fax_draft_create_request
        ...
        # process the form parameters
        # process the body parameter
        if fax_draft_create_request is not None and has_files is False:
            _body_params = fax_draft_create_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/fax/draft/create",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
