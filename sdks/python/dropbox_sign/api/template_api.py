...
class TemplateApi:
    ...
    def template_update(
        self,
        template_id: Annotated[
            StrictStr, Field(description="The ID of the template to update.")
        ],
        template_update_request: TemplateUpdateRequest,
        _request_timeout: Union[
            None,
            Annotated[StrictFloat, Field(gt=0)],
            Tuple[
        ...
        :type template_id: str
        :param template_update_request: (required)
    ...
    def _template_update_serialize(
        ...
        has_files = False
        body_param = template_update_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
        ...
        # process the form parameters
        # process the body parameter
        if template_update_request is not None and has_files is False:
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/template/update/{template_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
