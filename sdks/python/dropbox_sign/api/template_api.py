...
class TemplateApi:
    ...
    def _template_add_user_serialize(
        ...
        has_files = False
        body_param = template_add_user_request
    ...
    def _template_create_serialize(
        ...
        has_files = False
        body_param = template_create_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
    ...
    def _template_create_embedded_draft_serialize(
        ...
        has_files = False
        body_param = template_create_embedded_draft_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
    ...
    def template_edit(
        self,
        template_id: Annotated[
            StrictStr, Field(description="_t__TemplateEdit::TEMPLATE_ID")
        ],
        ...
        :param template_id: _t__TemplateEdit::TEMPLATE_ID (required)
        :type template_id: str
        :param template_edit_request: (required)
        :type template_edit_request: TemplateEditRequest
        :param _request_timeout: timeout setting for this request. If one
                                 number provided, it will be total request
                                 timeout. It can also be a pair (tuple) of
                                 (connection, read) timeouts.
        ...
        _param = self._template_edit_serialize(
            template_id=template_id,
    ...
    @validate_call
    def template_edit_with_http_info(
        self,
        template_id: Annotated[
            StrictStr, Field(description="_t__TemplateEdit::TEMPLATE_ID")
        ],
        ...
        _headers: Optional[Dict[StrictStr, Any]] = None,
        _host_index: Annotated[StrictInt, Field(ge=0, le=0)] = 0,
    ) -> ApiResponse[TemplateEditResponse]:
        """_t__TemplateEdit::SUMMARY
    ...
    @validate_call
    def template_edit_without_preload_content(
        self,
        template_id: Annotated[
            StrictStr, Field(description="_t__TemplateEdit::TEMPLATE_ID")
        ],
    ...
    def _template_edit_serialize(
        ...
        has_files = False
        body_param = template_edit_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
        ...
        # process the form parameters
        # process the body parameter
        if template_edit_request is not None and has_files is False:
            _body_params = template_edit_request
        ...
        return self.api_client.param_serialize(
            method="POST",
            resource_path="/template/edit/{template_id}",
            path_params=_path_params,
            query_params=_query_params,
            header_params=_header_params,
            body=_body_params,
    ...
    def _template_remove_user_serialize(
        ...
        has_files = False
        body_param = template_remove_user_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
    ...
    def _template_update_files_serialize(
        ...
        has_files = False
        body_param = template_update_files_request
        excluded_json_fields = set([])
        for param_name, param_type in body_param.openapi_types().items():
            param_value = getattr(body_param, param_name)
            if param_value is None:
