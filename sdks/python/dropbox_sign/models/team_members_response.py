...
class TeamMembersResponse(BaseModel):
    ...
    TeamMembersResponse
    """ # noqa: E501
    team_members: Optional[List[TeamMemberResponse]] = Field(default=None, description="Contains a list of team members and their roles for a specific team.")
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        ...
        _obj = cls.model_validate({
            "team_members": [TeamMemberResponse.from_dict(_item) for _item in obj["team_members"]] if obj.get("team_members") is not None else None,
