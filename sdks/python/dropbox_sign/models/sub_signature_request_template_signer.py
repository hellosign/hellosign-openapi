...
class SubSignatureRequestTemplateSigner(BaseModel):
    ...
    """ # noqa: E501
    role: StrictStr = Field(description="Must match an existing role in chosen Template(s). It's case-sensitive.")
    ...
    __properties: ClassVar[List[str]] = ["role", "name", "email_address", "pin", "sms_phone_number", "sms_phone_number_type"]
