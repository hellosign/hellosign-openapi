...
class SubSignatureRequestTemplateSigner(BaseModel):
    ...
    role: StrictStr = Field(description="_t__Sub::SignatureRequestTemplateSigner::ROLE")
    name: StrictStr = Field(description="_t__Sub::SignatureRequestTemplateSigner::NAME")
    ...
    pin: Optional[Annotated[str, Field(min_length=4, strict=True, max_length=12)]] = (
        Field(default=None, description="_t__Sub::SignatureRequestTemplateSigner::PIN")
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubSignatureRequestTemplateSigner from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubSignatureRequestTemplateSigner from a dict"""
        if obj is None:
            return None
