...
class EmbeddedEditUrlResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of EmbeddedEditUrlResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of EmbeddedEditUrlResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "embedded": EmbeddedEditUrlResponseEmbedded.from_dict(obj["embedded"]) if obj.get("embedded") is not None else None,
