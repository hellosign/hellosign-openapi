...
class TemplateResponseDocumentFieldGroupRule(BaseModel):
    ...
    group_label: Optional[StrictStr] = Field(default=None, description="Name of the group", alias="groupLabel")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TemplateResponseDocumentFieldGroupRule from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TemplateResponseDocumentFieldGroupRule from a dict"""
        if obj is None:
            return None
