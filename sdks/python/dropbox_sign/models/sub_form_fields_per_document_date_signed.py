...
class SubFormFieldsPerDocumentDateSigned(SubFormFieldsPerDocumentBase):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="A date. Use the `SubFormFieldsPerDocumentDateSigned` class.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubFormFieldsPerDocumentDateSigned from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubFormFieldsPerDocumentDateSigned from a dict"""
        if obj is None:
            return None
