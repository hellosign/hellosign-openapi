...
class SignatureRequestResponseDataValueCheckbox(SignatureRequestResponseDataBase):
    ...
    """ # noqa: E501
    type: Optional[StrictStr] = Field(default='checkbox', description="A yes/no checkbox")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseDataValueCheckbox from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseDataValueCheckbox from a dict"""
        if obj is None:
            return None
