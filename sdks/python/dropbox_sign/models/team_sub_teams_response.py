...
class TeamSubTeamsResponse(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamSubTeamsResponse from a JSON string"""
    ...
    def to_dict(self, excluded_fields: Set[str] = None) -> Dict[str, Any]:
        ...
        * `None` is only added to the output dict for nullable fields that
        ...
        # override the default output from pydantic by calling `to_dict()` of each item in sub_teams (list)
        _items = []
        if self.sub_teams:
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamSubTeamsResponse from a dict"""
        if obj is None:
            return None
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            "sub_teams": "(List[SubTeamResponse],)",
            "list_info": "(ListInfoResponse,)",
