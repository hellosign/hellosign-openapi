...
class SignatureRequestResponseDataValueSignature(SignatureRequestResponseDataBase):
    ...
    type: Optional[StrictStr] = Field(
        default="signature", description="A signature input field"
    )
    ...
    signed_at: Optional[StrictInt] = Field(
        default=None,
        description="This field contains the signed at timestamp when the type is either signature or initial.",
    )
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseDataValueSignature from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseDataValueSignature from a dict"""
        if obj is None:
            return None
