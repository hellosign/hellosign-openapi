...
class AccountVerifyResponseAccount(BaseModel):
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of AccountVerifyResponseAccount from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of AccountVerifyResponseAccount from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({"email_address": obj.get("email_address")})
        return _obj
