...
class FaxResponseFax(BaseModel):
    """
    FaxResponseFax
    """  # noqa: E501
    ...
    transmissions: Optional[List[FaxResponseFaxTransmission]] = Field(
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of FaxResponseFax from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of FaxResponseFax from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate(
            {
                ...
                "transmissions": (
                    [
                        FaxResponseFaxTransmission.from_dict(_item)
    ...
    def openapi_types(cls) -> Dict[str, str]:
        return {
            ...
            "created_at": "(int,)",
            "var_from": "(str,)",
            "transmissions": "(List[FaxResponseFaxTransmission],)",
            "files_url": "(str,)",
        }
