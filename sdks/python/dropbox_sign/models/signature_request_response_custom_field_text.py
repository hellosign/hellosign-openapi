...
class SignatureRequestResponseCustomFieldText(SignatureRequestResponseCustomFieldBase):
    ...
    value: Optional[StrictStr] = Field(default=None, description="A text string for text fields")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseCustomFieldText from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SignatureRequestResponseCustomFieldText from a dict"""
        if obj is None:
            return None
