...
class TeamGetInfoResponse(BaseModel):
    ...
    TeamGetInfoResponse
    """ # noqa: E501
    team: Optional[TeamInfoResponse] = None
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of TeamGetInfoResponse from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of TeamGetInfoResponse from a dict"""
        if obj is None:
            return None
        ...
        _obj = cls.model_validate({
            "team": TeamInfoResponse.from_dict(obj["team"]) if obj.get("team") is not None else None,
