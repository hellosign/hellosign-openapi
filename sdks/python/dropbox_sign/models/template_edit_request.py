...
class TemplateEditRequest(BaseModel):
    ...
    cc_roles: Optional[List[StrictStr]] = Field(
        default=None, description="_t__TemplateEdit::CC_ROLES"
    )
    allow_form_view: Optional[StrictBool] = Field(
        default=None, description="_t__TemplateEdit::ALLOW_FORM_VIEW"
    )
    title: Optional[StrictStr] = Field(
        default=None, description="_t__TemplateEdit::TITLE"
    )
    subject: Optional[Annotated[str, Field(strict=True, max_length=200)]] = Field(
        default=None, description="_t__TemplateEdit::SUBJECT"
    )
    message: Optional[Annotated[str, Field(strict=True, max_length=5000)]] = Field(
        default=None, description="_t__TemplateEdit::MESSAGE"
    )
