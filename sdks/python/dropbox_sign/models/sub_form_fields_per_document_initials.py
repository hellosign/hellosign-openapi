...
class SubFormFieldsPerDocumentInitials(SubFormFieldsPerDocumentBase):
    ...
    """ # noqa: E501
    type: StrictStr = Field(description="An input field for initials. Use the `SubFormFieldsPerDocumentInitials` class.")
    ...
    def from_json(cls, json_str: str) -> Optional[Self]:
        """Create an instance of SubFormFieldsPerDocumentInitials from a JSON string"""
    ...
    def from_dict(cls, obj: Optional[Dict[str, Any]]) -> Optional[Self]:
        """Create an instance of SubFormFieldsPerDocumentInitials from a dict"""
        if obj is None:
            return None
