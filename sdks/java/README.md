...
<dependency>
  ...
  <version>6.0.0-beta23.1</version>
  <scope>compile</scope>
</dependency>
```
...
```groovy
  ...
  dependencies {
     implementation "com.hellosign:hellosign-java-sdk:6.0.0-beta23.1"
  }
```
...
- `target/hellosign-java-sdk-6.0.0-beta23.1.jar`
- `target/lib/*.jar`
...
- API version: `3.0.0`
    - Package version: `6.0.0-beta23.1`
